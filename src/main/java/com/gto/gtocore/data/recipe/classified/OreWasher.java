...
interface OreWasher {
    ...
    static void init() {
        GTORecipeTypes.ORE_WASHER_RECIPES.recipeBuilder(GTOCore.id("clean_inert_residues_dust"))
        ...
        GTORecipeTypes.ORE_WASHER_RECIPES.recipeBuilder(GTOCore.id("clean_raw_tengam_dust"))
