...
import static com.gto.gtocore.common.data.GTORecipeTypes.SUPER_PARTICLE_COLLIDER_RECIPES;

interface SuperParticleCollider {

    static void init() {
        SUPER_PARTICLE_COLLIDER_RECIPES.recipeBuilder(GTOCore.id("antimatter"))
        ...
        SUPER_PARTICLE_COLLIDER_RECIPES.recipeBuilder(GTOCore.id("antineutron"))
        ...
        SUPER_PARTICLE_COLLIDER_RECIPES.recipeBuilder(GTOCore.id("roentgeniuma"))
        ...
        SUPER_PARTICLE_COLLIDER_RECIPES.recipeBuilder(GTOCore.id("positive_electron"))
        ...
        SUPER_PARTICLE_COLLIDER_RECIPES.recipeBuilder(GTOCore.id("antiproton"))
        ...
        SUPER_PARTICLE_COLLIDER_RECIPES.recipeBuilder(GTOCore.id("nihoniuma"))
        ...
        SUPER_PARTICLE_COLLIDER_RECIPES.recipeBuilder(GTOCore.id("einsteiniuma"))
        ...
        SUPER_PARTICLE_COLLIDER_RECIPES.recipeBuilder(GTOCore.id("nobeliuma"))
        ...
        SUPER_PARTICLE_COLLIDER_RECIPES.recipeBuilder(GTOCore.id("californiuma"))
        ...
        SUPER_PARTICLE_COLLIDER_RECIPES.recipeBuilder(GTOCore.id("plutoniuma"))
        ...
        SUPER_PARTICLE_COLLIDER_RECIPES.recipeBuilder(GTOCore.id("berkeliuma"))
        ...
        SUPER_PARTICLE_COLLIDER_RECIPES.recipeBuilder(GTOCore.id("curiuma"))
        ...
        SUPER_PARTICLE_COLLIDER_RECIPES.recipeBuilder(GTOCore.id("neptuniuma"))
        ...
        SUPER_PARTICLE_COLLIDER_RECIPES.recipeBuilder(GTOCore.id("uraniuma"))
        ...
        SUPER_PARTICLE_COLLIDER_RECIPES.recipeBuilder(GTOCore.id("astatinea"))
        ...
        SUPER_PARTICLE_COLLIDER_RECIPES.recipeBuilder(GTOCore.id("lawrenciuma"))
        ...
        SUPER_PARTICLE_COLLIDER_RECIPES.recipeBuilder(GTOCore.id("mendeleviuma"))
        ...
        SUPER_PARTICLE_COLLIDER_RECIPES.recipeBuilder(GTOCore.id("coperniciuma"))
        ...
        SUPER_PARTICLE_COLLIDER_RECIPES.recipeBuilder(GTOCore.id("bohriuma"))
        ...
        SUPER_PARTICLE_COLLIDER_RECIPES.recipeBuilder(GTOCore.id("fermiuma"))
