...
interface Macerator {
    ...
    static void init() {
        GTORecipeTypes.MACERATOR_RECIPES.recipeBuilder(GTOCore.id("prescient_powder"))
        ...
        GTORecipeTypes.MACERATOR_RECIPES.recipeBuilder(GTOCore.id("spacetime_dust"))
        ...
        GTORecipeTypes.MACERATOR_RECIPES.recipeBuilder(GTOCore.id("essence"))
        ...
        GTORecipeTypes.MACERATOR_RECIPES.recipeBuilder(GTOCore.id("silicon_dust"))
        ...
        GTORecipeTypes.MACERATOR_RECIPES.recipeBuilder(GTOCore.id("vibrant_powder"))
        ...
        GTORecipeTypes.MACERATOR_RECIPES.recipeBuilder(GTOCore.id("draconium_dust"))
        ...
        GTORecipeTypes.MACERATOR_RECIPES.recipeBuilder(GTOCore.id("sculk_catalyst"))
        ...
        GTORecipeTypes.MACERATOR_RECIPES.recipeBuilder(GTOCore.id("sculk_shrieker"))
        ...
        GTORecipeTypes.MACERATOR_RECIPES.recipeBuilder(GTOCore.id("pulsating_powder"))
        ...
        GTORecipeTypes.MACERATOR_RECIPES.recipeBuilder(GTOCore.id("sculk_sensor"))
        ...
        GTORecipeTypes.MACERATOR_RECIPES.recipeBuilder(GTOCore.id("ender_crystal_powder"))
        ...
        GTORecipeTypes.MACERATOR_RECIPES.recipeBuilder(GTOCore.id("degenerate_rhenium_dust"))
        ...
        GTORecipeTypes.MACERATOR_RECIPES.recipeBuilder(GTOCore.id("prismarine_shard"))
        ...
        GTORecipeTypes.MACERATOR_RECIPES.recipeBuilder(GTOCore.id("wheat_seeds"))
        ...
        GTORecipeTypes.MACERATOR_RECIPES.recipeBuilder(GTOCore.id("sky_dust"))
