...
interface Electrolyzer {
    ...
    static void init(Consumer<FinishedRecipe> provider) {
        GTRecipeTypes.ELECTROLYZER_RECIPES.recipeBuilder(GTOCore.id("radium_nitrate_dust"))
        ...
        GTRecipeTypes.ELECTROLYZER_RECIPES.recipeBuilder(GTOCore.id("trinium_tetrafluoride_dust"))
        ...
        GTRecipeTypes.ELECTROLYZER_RECIPES.recipeBuilder(GTOCore.id("sodium_chlorate_dust"))
        ...
        GTRecipeTypes.ELECTROLYZER_RECIPES.recipeBuilder(GTOCore.id("actinium_nitrate_dust"))
        ...
        GTRecipeTypes.ELECTROLYZER_RECIPES.recipeBuilder(GTOCore.id("purified_xenoxene"))
        ...
        GTRecipeTypes.ELECTROLYZER_RECIPES.recipeBuilder(GTOCore.id("caesium_nitrate_dust"))
        ...
        GTRecipeTypes.ELECTROLYZER_RECIPES.recipeBuilder(GTOCore.id("lithium_aluminium_fluoride_dust"))
        ...
        GTRecipeTypes.ELECTROLYZER_RECIPES.recipeBuilder(GTOCore.id("trinium_compound_dust"))
        ...
        GTRecipeTypes.ELECTROLYZER_RECIPES.recipeBuilder(GTOCore.id("sodium_hexafluoroaluminate"))
        ...
        GTRecipeTypes.ELECTROLYZER_RECIPES.recipeBuilder(GTOCore.id("trimethylamine"))
