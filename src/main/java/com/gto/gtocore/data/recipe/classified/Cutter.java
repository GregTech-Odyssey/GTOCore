...
interface Cutter {
    ...
    static void init() {
        GTORecipeTypes.CUTTER_RECIPES.recipeBuilder(GTOCore.id("exotic_ram_chip"))
        ...
        GTORecipeTypes.CUTTER_RECIPES.recipeBuilder(GTOCore.id("bioware_chip"))
        ...
        GTORecipeTypes.CUTTER_RECIPES.recipeBuilder(GTOCore.id("fm_chip"))
        ...
        GTORecipeTypes.CUTTER_RECIPES.recipeBuilder(GTOCore.id("cosmic_soc"))
        ...
        GTORecipeTypes.CUTTER_RECIPES.recipeBuilder(GTOCore.id("pm_chip"))
        ...
        GTORecipeTypes.CUTTER_RECIPES.recipeBuilder(GTOCore.id("nm_chip"))
        ...
        GTORecipeTypes.CUTTER_RECIPES.recipeBuilder(GTOCore.id("photocoated_hassium_wafer"))
        ...
        GTORecipeTypes.CUTTER_RECIPES.recipeBuilder(GTOCore.id("cosmic_ram_chip"))
        ...
        GTORecipeTypes.CUTTER_RECIPES.recipeBuilder(GTOCore.id("rutherfordium_neutronium_wafer"))
        ...
        GTORecipeTypes.CUTTER_RECIPES.recipeBuilder(GTOCore.id("supracausal_ram_chip"))
        ...
        GTORecipeTypes.CUTTER_RECIPES.recipeBuilder(GTOCore.id("taranium_wafer"))
        ...
        GTORecipeTypes.CUTTER_RECIPES.recipeBuilder(GTOCore.id("optical_slice"))
        ...
        GTORecipeTypes.CUTTER_RECIPES.recipeBuilder(GTOCore.id("exotic_chip"))
        ...
        GTORecipeTypes.CUTTER_RECIPES.recipeBuilder(GTOCore.id("optical_ram_chip"))
