...
interface PolymerizationReactor {
    ...
    static void init() {
        ...
        POLYMERIZATION_REACTOR_RECIPES.recipeBuilder(GTOCore.id("make_p507_2"))
        ...
        POLYMERIZATION_REACTOR_RECIPES.recipeBuilder(GTOCore.id("pre_zylon_dust"))
        ...
        POLYMERIZATION_REACTOR_RECIPES.recipeBuilder(GTOCore.id("polyetheretherketone"))
        ...
        POLYMERIZATION_REACTOR_RECIPES.recipeBuilder(GTOCore.id("polyurethaneresin"))
        ...
        POLYMERIZATION_REACTOR_RECIPES.recipeBuilder(GTOCore.id("polyurethane"))
        ...
        POLYMERIZATION_REACTOR_RECIPES.recipeBuilder(GTOCore.id("paa"))
