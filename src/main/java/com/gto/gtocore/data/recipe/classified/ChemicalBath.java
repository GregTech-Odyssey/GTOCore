...
interface ChemicalBath {
    ...
    static void init() {
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("petri_dish"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("naquadria_sulfate_dust"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("caesium_hydroxide_dust"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("glucose"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("kevlar_plate"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("photon_carrying_wafer"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("high_strength_concrete"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("damascus_steel_dust"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("fullerene_polymer_matrix_soft_tubing"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("end_stone"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("resonating_gem"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("leached_turpentine"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("vibrant_alloy_ingot"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("sculk_vein"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("x_ray_waveguide"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("netherrack"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("x_ray_mirror_plate"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("black_candle"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("ash_leaching_solution"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("highly_insulating_foil"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("fullerene_polymer_matrix_pulp_dust"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("cosmic_soc_wafer"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("metal_residue_dust"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("ender_obsidian"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("flawless_budding_quartz"))
        ...
        GTORecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder(GTOCore.id("eternity_catalyst"))
