...
interface Compressor {
    ...
    static void init() {
        GTORecipeTypes.COMPRESSOR_RECIPES.recipeBuilder(GTOCore.id("compressed_crafting_table"))
        ...
        GTORecipeTypes.COMPRESSOR_RECIPES.recipeBuilder(GTOCore.id("spacetime_block"))
        ...
        GTORecipeTypes.COMPRESSOR_RECIPES.recipeBuilder(GTOCore.id("spongebob"))
        ...
        GTORecipeTypes.COMPRESSOR_RECIPES.recipeBuilder(GTOCore.id("graphite_ingot"))
        ...
        GTORecipeTypes.COMPRESSOR_RECIPES.recipeBuilder(GTOCore.id("bedrock"))
        ...
        GTORecipeTypes.COMPRESSOR_RECIPES.recipeBuilder(GTOCore.id("netherite_block"))
