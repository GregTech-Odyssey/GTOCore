...
import static com.gto.gtocore.common.data.GTORecipeTypes.NEUTRON_COMPRESSOR_RECIPES;

interface NeutronCompressor {

    static void init() {
        NEUTRON_COMPRESSOR_RECIPES.recipeBuilder(GTOCore.id("combined_singularity_5"))
        ...
        NEUTRON_COMPRESSOR_RECIPES.recipeBuilder(GTOCore.id("combined_singularity_6"))
        ...
        NEUTRON_COMPRESSOR_RECIPES.recipeBuilder(GTOCore.id("combined_singularity_7"))
        ...
        NEUTRON_COMPRESSOR_RECIPES.recipeBuilder(GTOCore.id("combined_singularity_8"))
        ...
        NEUTRON_COMPRESSOR_RECIPES.recipeBuilder(GTOCore.id("combined_singularity_9"))
        ...
        NEUTRON_COMPRESSOR_RECIPES.recipeBuilder(GTOCore.id("combined_singularity_0"))
        ...
        NEUTRON_COMPRESSOR_RECIPES.recipeBuilder(GTOCore.id("combined_singularity_1"))
        ...
        NEUTRON_COMPRESSOR_RECIPES.recipeBuilder(GTOCore.id("combined_singularity_2"))
        ...
        NEUTRON_COMPRESSOR_RECIPES.recipeBuilder(GTOCore.id("combined_singularity_3"))
        ...
        NEUTRON_COMPRESSOR_RECIPES.recipeBuilder(GTOCore.id("combined_singularity_4"))
        ...
        NEUTRON_COMPRESSOR_RECIPES.recipeBuilder(GTOCore.id("combined_singularity_12"))
        ...
        NEUTRON_COMPRESSOR_RECIPES.recipeBuilder(GTOCore.id("combined_singularity_13"))
        ...
        NEUTRON_COMPRESSOR_RECIPES.recipeBuilder(GTOCore.id("combined_singularity_14"))
        ...
        NEUTRON_COMPRESSOR_RECIPES.recipeBuilder(GTOCore.id("combined_singularity_15"))
        ...
        NEUTRON_COMPRESSOR_RECIPES.recipeBuilder(GTOCore.id("combined_singularity_10"))
        ...
        NEUTRON_COMPRESSOR_RECIPES.recipeBuilder(GTOCore.id("combined_singularity_11"))
