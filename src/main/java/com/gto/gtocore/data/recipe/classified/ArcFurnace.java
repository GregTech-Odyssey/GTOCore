...
interface ArcFurnace {
    ...
    static void init() {
        GTORecipeTypes.ARC_FURNACE_RECIPES.recipeBuilder(GTOCore.id("warped_ender_pearl"))
        ...
        GTORecipeTypes.ARC_FURNACE_RECIPES.recipeBuilder(GTOCore.id("anthracene"))
        ...
        GTORecipeTypes.ARC_FURNACE_RECIPES.recipeBuilder(GTOCore.id("germanium_ash_dust"))
        ...
        GTORecipeTypes.ARC_FURNACE_RECIPES.recipeBuilder(GTOCore.id("cosmic_singularity"))
