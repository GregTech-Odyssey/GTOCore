...
import static com.gto.gtocore.common.data.GTORecipeTypes.DECAY_HASTENER_RECIPES;

interface DecayHastener {

    static void init() {
        DECAY_HASTENER_RECIPES.recipeBuilder(GTOCore.id("polonium_dust"))
        ...
        DECAY_HASTENER_RECIPES.recipeBuilder(GTOCore.id("rutherfordium_dust"))
        ...
        DECAY_HASTENER_RECIPES.recipeBuilder(GTOCore.id("flyb_plasma"))
        ...
        DECAY_HASTENER_RECIPES.recipeBuilder(GTOCore.id("rutherfordium_dust1"))
        ...
        DECAY_HASTENER_RECIPES.recipeBuilder(GTOCore.id("hafnium"))
        ...
        DECAY_HASTENER_RECIPES.recipeBuilder(GTOCore.id("copper76_dust"))
        ...
        DECAY_HASTENER_RECIPES.recipeBuilder(GTOCore.id("actinium_dust"))
        ...
        DECAY_HASTENER_RECIPES.recipeBuilder(GTOCore.id("meitnerium_dust"))
