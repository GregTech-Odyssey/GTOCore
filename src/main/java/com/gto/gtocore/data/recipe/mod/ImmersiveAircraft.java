package com.gto.gtocore.data.recipe.mod;
    ...
    static void init(Consumer<FinishedRecipe> provider) {
        if (GTCEu.isModLoaded("immersive_aircraft")) {
            ...
            VanillaRecipeHelper.addShapedRecipe(provider, GTOCore.id("aircraft_propeller"), RegistriesUtils.getItemStack("immersive_aircraft:propeller"),
                    ...
                    "CDs",
                    "BAA",
                    'A', new MaterialEntry(TagPrefix.plate, GTMaterials.Iron), 'B', new MaterialEntry(TagPrefix.screw, GTMaterials.Iron), 'C', RegistriesUtils.getItemStack("gtceu:wood_mallet"), 'D', new MaterialEntry(TagPrefix.ring, GTMaterials.Iron));
