...
import static com.gto.gtocore.common.data.GTORecipeTypes.CANNER_RECIPES;

interface Canner {

    static void init() {
        CANNER_RECIPES.recipeBuilder(GTOCore.id("ender_air"))
        ...
        CANNER_RECIPES.recipeBuilder(GTOCore.id("sculk"))
        ...
        CANNER_RECIPES.recipeBuilder(GTOCore.id("infused_breath"))
