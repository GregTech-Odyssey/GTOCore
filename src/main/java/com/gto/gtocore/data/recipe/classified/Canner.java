...
interface Canner {
    ...
    static void init() {
        GTORecipeTypes.CANNER_RECIPES.recipeBuilder(GTOCore.id("ender_air"))
        ...
        GTORecipeTypes.CANNER_RECIPES.recipeBuilder(GTOCore.id("reactor_uranium_simple"))
        ...
        GTORecipeTypes.CANNER_RECIPES.recipeBuilder(GTOCore.id("sculk"))
        ...
        GTORecipeTypes.CANNER_RECIPES.recipeBuilder(GTOCore.id("dense_neutron_plasma_cell"))
        ...
        GTORecipeTypes.CANNER_RECIPES.recipeBuilder(GTOCore.id("reactor_mox_simple"))
                .inputItems(GTOItems.REACTOR_FUEL_ROD.asStack())
        ...
        GTORecipeTypes.CANNER_RECIPES.recipeBuilder(GTOCore.id("reactor_thorium_simple"))
                .inputItems(GTOItems.REACTOR_FUEL_ROD.asStack())
        ...
        GTORecipeTypes.CANNER_RECIPES.recipeBuilder(GTOCore.id("infused_breath"))
        ...
        GTORecipeTypes.CANNER_RECIPES.recipeBuilder(GTOCore.id("crystal_matrix_plasma_containment_cell"))
        ...
        GTORecipeTypes.CANNER_RECIPES.recipeBuilder(GTOCore.id("reactor_naquadah_simple"))
        ...
        GTORecipeTypes.CANNER_RECIPES.recipeBuilder(GTOCore.id("rhenium_plasma_containment_cell"))
        ...
        GTORecipeTypes.CANNER_RECIPES.recipeBuilder(GTOCore.id("chaos_containment_unit"))
        ...
        GTORecipeTypes.CANNER_RECIPES.recipeBuilder(GTOCore.id("bose_einstein_cooling_container"))
        ...
        GTORecipeTypes.CANNER_RECIPES.recipeBuilder(GTOCore.id("actinium_superhydride_plasma_containment_cell"))
        ...
        GTORecipeTypes.CANNER_RECIPES.recipeBuilder(GTOCore.id("awakened_draconium_plasma_containment_cell"))
        ...
        GTORecipeTypes.CANNER_RECIPES.recipeBuilder(GTOCore.id("charged_triplet_neutronium_sphere"))
                .notConsumable(GTOTagPrefix.nanites, GTMaterials.Neutronium)
        ...
        GTORecipeTypes.CANNER_RECIPES.recipeBuilder(GTOCore.id("cosmic_mesh_containment_unit"))
