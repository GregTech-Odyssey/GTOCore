...
import static com.gto.gtocore.api.data.tag.GTOTagPrefix.nanoswarm;
...
public class Lanthanidetreatment {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        DIGESTION_TREATMENT.recipeBuilder(GTOCore.id("monazite_rare_earth_turbid_liquid1"))
        ...
        DISSOLUTION_TREATMENT.recipeBuilder(GTOCore.id("diluted_monazite_slurry2"))
        ...
        GTORecipeTypes.REACTION_FURNACE_RECIPES.recipeBuilder(GTOCore.id("thorium_phosphate_filter_cake_powder8"))
        ...
        GTORecipeTypes.REACTION_FURNACE_RECIPES.recipeBuilder(GTOCore.id("concentrated_monazite_rare_earth_hydroxide_powder14"))
        ...
        GTORecipeTypes.REACTION_FURNACE_RECIPES.recipeBuilder(GTOCore.id("vanadium_pentoxide_powder24"))
        ...
        GTORecipeTypes.REACTION_FURNACE_RECIPES.recipeBuilder(GTOCore.id("cerium_oxalate_powder25"))
        ...
        DIGESTION_TREATMENT.recipeBuilder(GTOCore.id("concentrated_cerium_chloride_solution26"))
        ...
        GTORecipeTypes.REACTION_FURNACE_RECIPES.recipeBuilder(GTOCore.id("heterogeneous_halide_monazite_rare_earth_mixture_powder30"))
        ...
        DIGESTION_TREATMENT.recipeBuilder(GTOCore.id("samarium_rare_earth_turbid_liquid35"))
        ...
        DISSOLUTION_TREATMENT.recipeBuilder(GTOCore.id("samarium_rare_earth_turbid_liquid36"))
        ...
        DISSOLUTION_TREATMENT.recipeBuilder(GTOCore.id("samarium_rare_earth_slurry37"))
        ...
        DIGESTION_TREATMENT.recipeBuilder(GTOCore.id("monazite_rare_earth_turbid_liquid_output44"))
        ...
        /* 氟碳镧铈线 */
        DIGESTION_TREATMENT.recipeBuilder(GTOCore.id("fluoro_carbon_lanthanide_cerium_solution47"))
        ...
        DISSOLUTION_TREATMENT.recipeBuilder(GTOCore.id("diluted_fluoro_carbon_lanthanide_slurry51"))
        ...
        GTORecipeTypes.REACTION_FURNACE_RECIPES.recipeBuilder(GTOCore.id("fluoro_carbon_lanthanide_cerium_oxide_powder53"))
        ...
        GTORecipeTypes.REACTION_FURNACE_RECIPES.recipeBuilder(GTOCore.id("calcined_rare_earth_oxide_powder55"))
        ...
        GTORecipeTypes.REACTION_FURNACE_RECIPES.recipeBuilder(GTOCore.id("samarium_terbium_mixture_powder63"))
