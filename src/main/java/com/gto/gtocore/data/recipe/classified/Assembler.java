...
interface Assembler {
    ...
    static void init() {
        ...
        ASSEMBLER_RECIPES.builder("manganese_phosphide")
                .inputItems(GTOTagPrefix.SUPERCONDUCTOR_BASE, GTMaterials.ManganesePhosphide, 8)
                .inputItems(TagPrefix.pipeTinyFluid, GTMaterials.Steel)
                .inputItems(GTItems.ELECTRIC_PUMP_LV.asStack(2))
                .outputItems(TagPrefix.wireGtSingle, GTMaterials.ManganesePhosphide, 8)
        ...
        ASSEMBLER_RECIPES.builder("magnesium_diboride")
                .inputItems(GTOTagPrefix.SUPERCONDUCTOR_BASE, GTMaterials.MagnesiumDiboride, 8)
                .inputItems(TagPrefix.pipeTinyFluid, GTMaterials.Aluminium)
                .inputItems(GTItems.ELECTRIC_PUMP_MV.asStack(2))
                .outputItems(TagPrefix.wireGtSingle, GTMaterials.MagnesiumDiboride, 8)
                .inputFluids(GTOMaterials.HighPressureNitrogen, 1000)
                .EUt(120)
                .duration(400)
                .save();
        ...
        ASSEMBLER_RECIPES.builder("mercury_barium_calciumcuprate")
                .inputItems(GTOTagPrefix.SUPERCONDUCTOR_BASE, GTMaterials.MercuryBariumCalciumCuprate, 8)
                .inputItems(TagPrefix.pipeTinyFluid, GTMaterials.StainlessSteel)
                .inputItems(GTItems.ELECTRIC_PUMP_HV.asStack(2))
                .outputItems(TagPrefix.wireGtSingle, GTMaterials.MercuryBariumCalciumCuprate, 8)
        ...
        ASSEMBLER_RECIPES.builder("uranium_triplatinum")
                .inputItems(GTOTagPrefix.SUPERCONDUCTOR_BASE, GTMaterials.UraniumTriplatinum, 8)
                .inputItems(TagPrefix.pipeTinyFluid, GTMaterials.Titanium)
                .inputItems(GTItems.ELECTRIC_PUMP_EV.asStack(2))
                .outputItems(TagPrefix.wireGtSingle, GTMaterials.UraniumTriplatinum, 8)
                .inputFluids(GTOMaterials.LiquidNitrogen, 1000)
                .EUt(1920)
                .duration(400)
                .save();
        ...
        ASSEMBLER_RECIPES.builder("samarium_iron_arsenic_oxide")
                .inputItems(GTOTagPrefix.SUPERCONDUCTOR_BASE, GTMaterials.SamariumIronArsenicOxide, 8)
                .inputItems(TagPrefix.pipeTinyFluid, GTMaterials.TungstenSteel)
                .inputItems(GTItems.ELECTRIC_PUMP_IV.asStack(2))
                .outputItems(TagPrefix.wireGtSingle, GTMaterials.SamariumIronArsenicOxide, 8)
        ...
        ASSEMBLER_RECIPES.builder("indium_tin_barium_titanium_cuprate")
                .inputItems(GTOTagPrefix.SUPERCONDUCTOR_BASE, GTMaterials.IndiumTinBariumTitaniumCuprate, 8)
                .inputItems(TagPrefix.pipeTinyFluid, GTMaterials.Duranium)
                .inputItems(GTItems.ELECTRIC_PUMP_LuV.asStack(2))
                .outputItems(TagPrefix.wireGtSingle, GTMaterials.IndiumTinBariumTitaniumCuprate, 8)
                .inputFluids(GTOMaterials.LiquidHydrogen, 1000)
                .EUt(30720)
                .duration(400)
                .save();
