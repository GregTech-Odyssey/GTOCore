...
interface AlloySmelter {
    ...
    static void init() {
        GTORecipeTypes.ALLOY_SMELTER_RECIPES.recipeBuilder(GTOCore.id("vibrant_gear"))
        ...
        GTORecipeTypes.ALLOY_SMELTER_RECIPES.recipeBuilder(GTOCore.id("infinity_gear"))
        ...
        GTORecipeTypes.ALLOY_SMELTER_RECIPES.recipeBuilder(GTOCore.id("soularium_ingot"))
        ...
        GTORecipeTypes.ALLOY_SMELTER_RECIPES.recipeBuilder(GTOCore.id("dark_bimetal_gear"))
        ...
        GTORecipeTypes.ALLOY_SMELTER_RECIPES.recipeBuilder(GTOCore.id("netherite_ingot"))
        ...
        GTORecipeTypes.ALLOY_SMELTER_RECIPES.recipeBuilder(GTOCore.id("energetic_gear"))
                .inputItems(EIOItems.GEAR_IRON.asStack())
