...
import static com.gto.gtocore.common.data.GTORecipeTypes.DRAGON_EGG_COPIER_RECIPES;

interface DragonEggCopier {

    static void init() {
        DRAGON_EGG_COPIER_RECIPES.recipeBuilder(GTOCore.id("dragon_egg_copier"))
