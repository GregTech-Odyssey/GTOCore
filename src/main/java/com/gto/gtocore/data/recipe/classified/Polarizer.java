...
interface Polarizer {
    ...
    static void init() {
        GTORecipeTypes.POLARIZER_RECIPES.recipeBuilder(GTOCore.id("attuned_tengam_dust"))
        ...
        GTORecipeTypes.POLARIZER_RECIPES.recipeBuilder(GTOCore.id("magnetic_long_netherite_rod"))
        ...
        GTORecipeTypes.POLARIZER_RECIPES.recipeBuilder(GTOCore.id("magnetic_netherite_rod"))
        ...
        GTORecipeTypes.POLARIZER_RECIPES.recipeBuilder(GTOCore.id("small_attuned_tengam_dust"))
        ...
        GTORecipeTypes.POLARIZER_RECIPES.recipeBuilder(GTOCore.id("triplet_neutronium_sphere"))
