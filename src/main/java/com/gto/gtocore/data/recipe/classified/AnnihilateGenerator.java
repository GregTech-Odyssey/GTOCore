...
import static com.gto.gtocore.common.data.GTORecipeTypes.ANNIHILATE_GENERATOR_RECIPES;

interface AnnihilateGenerator {

    static void init() {
        ANNIHILATE_GENERATOR_RECIPES.recipeBuilder(GTOCore.id("neutronium_antimatter_fuel_rod"))
        ...
        ANNIHILATE_GENERATOR_RECIPES.recipeBuilder(GTOCore.id("draconium_antimatter_fuel_rod"))
        ...
        ANNIHILATE_GENERATOR_RECIPES.recipeBuilder(GTOCore.id("cosmic_neutronium_antimatter_fuel_rod"))
        ...
        ANNIHILATE_GENERATOR_RECIPES.recipeBuilder(GTOCore.id("infinity_antimatter_fuel_rod"))
