...
interface RocketAssembler {
    ...
    static void init(Consumer<FinishedRecipe> provider) {
        GTORecipeTypes.ROCKET_ASSEMBLER_RECIPES.recipeBuilder(GTOCore.id("tier_1_rocket"))
                ...
                .inputItems(RegistriesUtils.getItemStack("ad_astra:steel_tank", 4))
                ...
                .inputItems(RegistriesUtils.getItemStack("ad_astra:steel_engine", 4))
                ...
                .outputItems(RegistriesUtils.getItemStack("ad_astra:tier_1_rocket"))
                .EUt(480)
                .duration(600)
                .save(provider);
        ...
        GTORecipeTypes.ROCKET_ASSEMBLER_RECIPES.recipeBuilder(GTOCore.id("tier_4_rocket"))
                ...
                .inputItems(TagPrefix.bolt, GTMaterials.TungstenSteel, 32)
                .inputItems(RegistriesUtils.getItemStack("ad_astra:rocket_fin", 4))
                .inputItems(RegistriesUtils.getItemStack("ad_astra:desh_engine", 8))
                .inputItems(TagPrefix.plateDense, GTOMaterials.Desh, 16)
                .inputFluids(GTMaterials.Aluminium.getFluid(2304))
                .inputFluids(GTMaterials.Polytetrafluoroethylene.getFluid(2304))
                .inputFluids(GTMaterials.Lubricant.getFluid(8000))
                .outputItems(RegistriesUtils.getItemStack("ad_astra:tier_4_rocket"))
                .EUt(7680)
                .duration(1200)
                .save(provider);
        ...
        GTORecipeTypes.ROCKET_ASSEMBLER_RECIPES.recipeBuilder(GTOCore.id("tier_5_rocket"))
                ...
                .inputItems(RegistriesUtils.getItemStack("ad_astra:ostrum_tank", 8))
                .inputItems(TagPrefix.pipeSmallFluid, GTMaterials.TungstenCarbide, 8)
                .inputItems(TagPrefix.bolt, GTMaterials.Neodymium, 32)
                .inputItems(RegistriesUtils.getItemStack("ad_astra:rocket_fin", 4))
                .inputItems(RegistriesUtils.getItemStack("ad_astra:ostrum_engine", 8))
                ...
                .inputFluids(GTMaterials.Lubricant.getFluid(8000))
                .outputItems(RegistriesUtils.getItemStack("ad_astra_rocketed:tier_5_rocket"))
                .EUt(30720)
                .duration(1200)
                .save(provider);
        ...
        GTORecipeTypes.ROCKET_ASSEMBLER_RECIPES.recipeBuilder(GTOCore.id("tier_6_rocket"))
                ...
                .inputItems(RegistriesUtils.getItemStack("ad_astra:calorite_tank", 8))
                .inputItems(TagPrefix.pipeSmallFluid, GTMaterials.Tungsten, 8)
                .inputItems(TagPrefix.bolt, GTMaterials.NiobiumTitanium, 32)
                .inputItems(RegistriesUtils.getItemStack("ad_astra:rocket_fin", 4))
                .inputItems(RegistriesUtils.getItemStack("ad_astra:calorite_engine", 8))
                .inputItems(TagPrefix.plateDense, GTOMaterials.Calorite, 16)
                .inputFluids(GTMaterials.Titanium.getFluid(2304))
                .inputFluids(GTMaterials.Polybenzimidazole.getFluid(2304))
                .inputFluids(GTMaterials.Lubricant.getFluid(8000))
                .outputItems(RegistriesUtils.getItemStack("ad_astra_rocketed:tier_6_rocket"))
                .EUt(122880)
                .duration(1200)
                .save(provider);
    }
