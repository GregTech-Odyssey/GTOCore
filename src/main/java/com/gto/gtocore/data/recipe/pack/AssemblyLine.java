...
final class AssemblyLine {
    ...
    static void init(Consumer<FinishedRecipe> provider) {
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("magnetic_confinement_dimensionality_shock_device"))
                ...
                .outputItems(MultiBlockMachineA.MAGNETIC_CONFINEMENT_DIMENSIONALITY_SHOCK_DEVICE.asStack())
                .EUt(31457280)
                .duration(2000)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("sps_crafting"))
                ...
                .outputItems(MultiBlockMachineA.SPS_CRAFTING.asStack())
                .EUt(31457280)
                .duration(600)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("engraving_laser_plant"))
                ...
                .inputFluids(GTOMaterials.MutatedLivingSolder.getFluid(1296))
                .inputFluids(GTMaterials.SolderingAlloy.getFluid(2880))
                .outputItems(MultiBlockMachineA.ENGRAVING_LASER_PLANT.asStack())
                .EUt(491520)
                .duration(1200)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("power_module"))
                ...
                .outputItems(GTOBlocks.POWER_MODULE.asStack())
                .EUt(30720)
                .duration(400)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("mega_canner"))
                ...
                .outputItems(MultiBlockMachineA.MEGA_CANNER.asStack())
                .EUt(7864320)
                .duration(800)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("pcb_factory"))
                ...
                .inputItems(MultiBlockMachineA.CHEMICAL_PLANT.asStack(4))
                ...
                .outputItems(MultiBlockMachineD.PCB_FACTORY.asStack())
                .EUt(1966080)
                .duration(600)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("chemical_plant"))
                ...
                .outputItems(MultiBlockMachineA.CHEMICAL_PLANT.asStack())
                .EUt(30720)
                .duration(600)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("aggregation_device"))
                ...
                .inputItems(TagPrefix.wireGtHex, GTOMaterials.Enderite, 4)
                .inputItems(GTItems.FIELD_GENERATOR_UEV.asStack(4))
                .inputItems(GTOItems.REALLY_MAX_BATTERY.asStack())
                .inputItems(TagPrefix.screw, GTOMaterials.Quantanium, 64)
                .inputItems(TagPrefix.plateDouble, GTOMaterials.Dalisenite, 8)
                ...
                .outputItems(MultiBlockMachineA.AGGREGATION_DEVICE.asStack())
                .EUt(7864320)
                .duration(1600)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("super_particle_collider"))
                ...
                .outputItems(MultiBlockMachineF.SUPER_PARTICLE_COLLIDER.asStack())
                .EUt(122880)
                .duration(800)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("annihilate_generator"))
                ...
                .outputItems(GeneratorMultiblockMachine.ANNIHILATE_GENERATOR.asStack())
                .EUt(125829120)
                .duration(1800)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("eye_of_harmony"))
                ...
                .inputItems(MultiBlockMachineD.RESOURCE_COLLECTION_MODULE.asStack(64))
                ...
                .outputItems(MultiBlockMachineD.EYE_OF_HARMONY.asStack())
                .EUt(2013265920)
                .duration(2400)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("precision_assembler"))
                ...
                .outputItems(MultiBlockMachineA.PRECISION_ASSEMBLER.asStack())
                .EUt(122880)
                .duration(1000)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("create_aggregation"))
                ...
                .outputItems(MultiBlockMachineD.CREATE_AGGREGATION.asStack())
                .EUt(125829120)
                .duration(12000)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("circuit_assembly_line"))
                ...
                .outputItems(MultiBlockMachineD.CIRCUIT_ASSEMBLY_LINE.asStack())
                .EUt(491520)
                .duration(800)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("assembler_module"))
                ...
                .inputFluids(GTMaterials.SolderingAlloy.getFluid(2880))
                .inputFluids(GTOMaterials.ArtheriumTin.getFluid(2880))
                .outputItems(MultiBlockMachineD.ASSEMBLER_MODULE.asStack())
                .EUt(491520)
                .duration(1200)
                .stationResearch(b -> b.researchStack(MultiBlockMachineD.ADVANCED_ASSEMBLY_LINE.asStack())
                        .CWUt(256)
                        .EUt(491520))
                .save(provider);
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("atomic_energy_excitation_plant"))
                ...
                .outputItems(MultiBlockMachineA.ATOMIC_ENERGY_EXCITATION_PLANT.asStack())
                .EUt(31457280)
                .duration(4000)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("magic_manufacturer"))
                ...
                .outputItems(MultiBlockMachineA.MAGIC_MANUFACTURER.asStack())
                .EUt(7864320)
                .duration(600)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("element_copying"))
                ...
                .outputItems(MultiBlockMachineA.ELEMENT_COPYING.asStack())
                .EUt(125829120)
                .duration(800)
                .stationResearch(b -> b.researchStack(MultiBlockMachineE.STAR_ULTIMATE_MATERIAL_FORGE_FACTORY.asStack())
                        .CWUt(2048)
                        .EUt(125829120))
                .save(provider);
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("suprachronal_assembly_line"))
                ...
                .inputItems(MultiBlockMachineD.ADVANCED_ASSEMBLY_LINE.asStack(16))
                .inputItems(MultiBlockMachineD.CIRCUIT_ASSEMBLY_LINE.asStack(16))
                ...
                .outputItems(MultiBlockMachineD.SUPRACHRONAL_ASSEMBLY_LINE.asStack())
                .EUt(7864320)
                .duration(800)
                .stationResearch(b -> b.researchStack(MultiBlockMachineD.ASSEMBLER_MODULE.asStack())
                        .CWUt(256)
                        .EUt(7864320))
                .save(provider);
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("dyson_sphere_receiving_station"))
                ...
                .outputItems(GeneratorMultiblockMachine.DYSON_SPHERE_RECEIVING_STATION.asStack())
                .EUt(31457280)
                .duration(1600)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("mass_fabricator"))
                ...
                .inputFluids(GTOMaterials.Indalloy140.getFluid(2592))
                .inputFluids(GTOMaterials.MutatedLivingSolder.getFluid(1296))
                .outputItems(MultiBlockMachineA.MASS_FABRICATOR.asStack())
                .EUt(125829120)
                .duration(600)
                .stationResearch(b -> b.researchStack(MultiBlockMachineA.MATTER_FABRICATOR.asStack())
                        .CWUt(512)
                        .EUt(125829120))
                .save(provider);
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("hyper_reactor"))
                ...
                .outputItems(GeneratorMultiblockMachine.HYPER_REACTOR.asStack())
                .EUt(2000000)
                .duration(500)
                .stationResearch(b -> b.researchStack(GeneratorMultiblockMachine.LARGE_NAQUADAH_REACTOR.asStack())
                        .CWUt(128)
                        .EUt(7864320))
                .save(provider);
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("dimensional_focus_engraving_array"))
                ...
                .outputItems(MultiBlockMachineE.DIMENSIONAL_FOCUS_ENGRAVING_ARRAY.asStack())
                .EUt(7864320)
                .duration(1600)
                .stationResearch(b -> b.researchStack(MultiBlockMachineA.ENGRAVING_LASER_PLANT.asStack())
                        .CWUt(256)
                        .EUt(7864320))
                .save(provider);
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("super_blast_smelter"))
                ...
                .inputItems(MultiBlockMachineA.MEGA_ALLOY_BLAST_SMELTER.asStack(64))
                ...
                .outputItems(MultiBlockMachineF.SUPER_BLAST_SMELTER.asStack())
                .EUt(1966080)
                .duration(1200)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("flotation_cell_regulator"))
                ...
                .outputItems(MultiBlockMachineA.FLOTATION_CELL_REGULATOR.asStack())
                .EUt(30720)
                .duration(2400)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("star_ultimate_material_forge_factory"))
                .inputItems(MultiBlockMachineA.STELLAR_FORGE.asStack(4))
                ...
                .outputItems(MultiBlockMachineE.STAR_ULTIMATE_MATERIAL_FORGE_FACTORY.asStack())
                .EUt(31457280)
                .duration(1200)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("bedrock_drilling_rig"))
                ...
                .outputItems(MultiBlockMachineD.BEDROCK_DRILLING_RIG.asStack())
                .EUt(7864320)
                .duration(1200)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("advanced_mass_fabricator"))
                ...
                .inputItems(MultiBlockMachineA.MASS_FABRICATOR.asStack(4))
                ...
                .outputItems(MultiBlockMachineA.ADVANCED_MASS_FABRICATOR.asStack())
                .EUt(31457280)
                .duration(1800)
                .stationResearch(b -> b.researchStack(MultiBlockMachineA.MASS_FABRICATOR.asStack())
                        .CWUt(1024)
                        .EUt(31457280))
                .save(provider);
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("space_elevator"))
                ...
                .outputItems(MultiBlockMachineD.SPACE_ELEVATOR.asStack())
                .EUt(491520)
                .duration(1600)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("resource_collection_module"))
                .inputItems(MultiBlockMachineA.LARGE_VOID_MINER.asStack())
                .inputItems(MultiBlockMachineA.VOID_FLUID_DRILLING_RIG.asStack())
                .inputItems(GTItems.ROBOT_ARM_UV.asStack(4))
                ...
                .inputFluids(GTMaterials.SolderingAlloy.getFluid(2880))
                .inputFluids(GTOMaterials.ArtheriumTin.getFluid(2880))
                .outputItems(MultiBlockMachineD.RESOURCE_COLLECTION_MODULE.asStack())
                .EUt(491520)
                .duration(1200)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("fuel_refining_complex"))
                ...
                .inputFluids(GTMaterials.Polytetrafluoroethylene.getFluid(2304))
                .inputFluids(GTMaterials.WatertightSteel.getFluid(1152))
                .outputItems(MultiBlockMachineB.FUEL_REFINING_COMPLEX.asStack())
                .EUt(122880)
                .duration(1000)
                .stationResearch(b -> b.researchStack(MultiBlockMachineA.LARGE_CRACKER.asStack())
                        .CWUt(512)
                        .EUt(122880))
                .save(provider);
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("super_computation"))
                ...
                .inputItems(TagPrefix.wireGtQuadruple, GTOMaterials.Enderite, 64)
                .inputItems(GTBlocks.OPTICAL_PIPES[0].asStack(64))
                .inputFluids(GTOMaterials.MutatedLivingSolder.getFluid(2880))
                .inputFluids(GTMaterials.VanadiumGallium.getFluid(2880))
                .inputFluids(GTMaterials.PCBCoolant.getFluid(16000))
                .inputFluids(new FluidStack(GTOFluids.GELID_CRYOTHEUM.get(), 16000))
                .outputItems(MultiBlockMachineD.SUPER_COMPUTATION.asStack())
                .EUt(7864320)
                .duration(600)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("uev_fusion_reactor"))
                ...
                .outputItems(MultiBlockMachineD.FUSION_REACTOR[GTValues.UEV].asStack())
                .EUt(1966080)
                .duration(1000)
                .stationResearch(b -> b.researchStack(MultiBlockMachineD.FUSION_REACTOR[GTValues.UHV].asStack())
                        .CWUt(600)
                        .EUt(7864320))
                .save(provider);
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("super_cooler_component"))
                ...
                .inputItems(TagPrefix.wireFine, GTMaterials.Rhodium, 32)
                ...
                .outputItems(GTOBlocks.SUPER_COOLER_COMPONENT.asStack())
                .EUt(1966080)
                .duration(400)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("tier_7_rocket"))
                ...
                .inputItems(RegistriesUtils.getItemStack("ad_astra:calorite_tank", 4))
                .inputItems(RegistriesUtils.getItemStack("ad_astra:calorite_engine"))
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("void_fluid_drilling_rig"))
                ...
                .outputItems(MultiBlockMachineA.VOID_FLUID_DRILLING_RIG.asStack())
                .EUt(30720)
                .duration(600)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("holy_separator"))
                ...
                .outputItems(MultiBlockMachineF.HOLY_SEPARATOR.asStack())
                .EUt(7864320)
                .duration(1000)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("uhv_fusion_reactor"))
                ...
                .outputItems(MultiBlockMachineD.FUSION_REACTOR[GTValues.UHV].asStack())
                .EUt(491520)
                .duration(1000)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("dimensionally_transcendent_plasma_forge"))
                ...
                .inputItems(MultiBlockMachineF.SUPER_BLAST_SMELTER.asStack(16))
                ...
                .outputItems(MultiBlockMachineD.DIMENSIONALLY_TRANSCENDENT_PLASMA_FORGE.asStack())
                .EUt(31457280)
                .duration(4000)
                .stationResearch(b -> b.researchStack(MultiBlockMachineA.STELLAR_FORGE.asStack())
                        .CWUt(4096)
                        .EUt(31457280))
                .save(provider);
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("door_of_create"))
                ...
                .inputItems(MultiBlockMachineD.EYE_OF_HARMONY.asStack(16))
                .inputItems(GTOBlocks.DIMENSION_CREATION_CASING.asStack(16))
                ...
                .outputItems(MultiBlockMachineD.DOOR_OF_CREATE.asStack())
                .EUt(8053063680L)
                .duration(2400)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("power_module_3"))
                .inputItems(GTOBlocks.POWER_MODULE_2.asStack())
                ...
                .inputFluids(GTMaterials.Lubricant.getFluid(2304))
                .outputItems(GTOBlocks.POWER_MODULE_3.asStack())
                .EUt(491520)
                .duration(400)
                .stationResearch(b -> b.researchStack(GTOBlocks.POWER_MODULE_2.asStack())
                        .CWUt(256)
                        .EUt(491520))
                .save(provider);

        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("power_module_2"))
                .inputItems(GTOBlocks.POWER_MODULE.asStack())
                ...
                .inputFluids(GTMaterials.Lubricant.getFluid(2304))
                .outputItems(GTOBlocks.POWER_MODULE_2.asStack())
                .EUt(122880)
                .duration(400)
                .stationResearch(b -> b.researchStack(GTOBlocks.POWER_MODULE.asStack())
                        .CWUt(128)
                        .EUt(122880))
                .save(provider);

        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("power_module_5"))
                .inputItems(GTOBlocks.POWER_MODULE_4.asStack())
                .inputItems(GTItems.FIELD_GENERATOR_UHV.asStack(2))
                ...
                .inputFluids(GTMaterials.Lubricant.getFluid(2304))
                .outputItems(GTOBlocks.POWER_MODULE_5.asStack())
                .EUt(7864320)
                .duration(400)
                .stationResearch(b -> b.researchStack(GTOBlocks.POWER_MODULE_4.asStack())
                        .CWUt(1024)
                        .EUt(7864320))
                .save(provider);

        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("power_module_4"))
                .inputItems(GTOBlocks.POWER_MODULE_3.asStack())
                .inputItems(GTItems.FIELD_GENERATOR_UV.asStack(2))
                ...
                .inputFluids(GTMaterials.Lubricant.getFluid(2304))
                .outputItems(GTOBlocks.POWER_MODULE_4.asStack())
                .EUt(1966080)
                .duration(400)
                .stationResearch(b -> b.researchStack(GTOBlocks.POWER_MODULE_3.asStack())
                        .CWUt(512)
                        .EUt(1966080))
                .save(provider);
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("matter_fabricator"))
                ...
                .outputItems(MultiBlockMachineA.MATTER_FABRICATOR.asStack())
                .EUt(1966080)
                .duration(800)
                .stationResearch(b -> b.researchStack(MultiBlockMachineA.RECYCLER.asStack())
                        .CWUt(128)
                        .EUt(1966080))
                .save(provider);
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("compound_distillation_fractionator"))
                ...
                .outputItems(MultiBlockMachineF.COMPOUND_DISTILLATION_FRACTIONATOR.asStack())
                .EUt(1966080)
                .duration(800)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("mega_wiremill"))
                ...
                .outputItems(MultiBlockMachineA.MEGA_WIREMILL.asStack())
                .EUt(7864320)
                .duration(800)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("plasma_condenser"))
                ...
                .outputItems(MultiBlockMachineA.PLASMA_CONDENSER.asStack())
                .EUt(1966080)
                .duration(300)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("large_chemical_plant"))
                ...
                .outputItems(MultiBlockMachineA.LARGE_CHEMICAL_PLANT.asStack())
                .EUt(1966080)
                .duration(800)
                .stationResearch(b -> b.researchStack(MultiBlockMachineA.CHEMICAL_PLANT.asStack())
                        .CWUt(256)
                        .EUt(1966080))
                .save(provider);
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("field_extruder_factory"))
                ...
                .outputItems(MultiBlockMachineF.FIELD_EXTRUDER_FACTORY.asStack())
                .EUt(7864320)
                .duration(800)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("advanced_sps_crafting"))
                ...
                .outputItems(MultiBlockMachineA.ADVANCED_SPS_CRAFTING.asStack())
                .EUt(125829120)
                .duration(600)
                .stationResearch(b -> b.researchStack(MultiBlockMachineA.SPS_CRAFTING.asStack())
                        .CWUt(256)
                        .EUt(125829120))
                .save(provider);
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("nano_forge"))
                ...
                .outputItems(MultiBlockMachineD.NANO_FORGE.asStack())
                .EUt(491520)
                .duration(2400)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("space_probe_surface_reception"))
                ...
                .outputItems(MultiBlockMachineD.SPACE_PROBE_SURFACE_RECEPTION.asStack())
                .EUt(125829120)
                .duration(400)
                .stationResearch(b -> b.researchStack(MultiBlockMachineD.RESOURCE_COLLECTION_MODULE.asStack())
                        .CWUt(512)
                        .EUt(125829120))
                .save(provider);
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("large_void_miner"))
                ...
                .outputItems(MultiBlockMachineA.LARGE_VOID_MINER.asStack())
                .EUt(122880)
                .duration(800)
                .stationResearch(b -> b.researchStack(MultiBlockMachineA.VOID_MINER.asStack())
                        .CWUt(64)
                        .EUt(122880))
                .save(provider);
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("mega_brewer"))
                ...
                .outputItems(MultiBlockMachineB.MEGA_BREWER.asStack())
                .EUt(1966080)
                .duration(1000)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("phase_change_cube"))
                ...
                .outputItems(MultiBlockMachineA.PHASE_CHANGE_CUBE.asStack())
                .EUt(7864320)
                .duration(800)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("dyson_deployment_core"))
                ...
                .EUt(31457280)
                .duration(1200)
                .stationResearch(b -> b.researchStack(GTOBlocks.POWER_CORE.asStack())
                        .CWUt(512)
                        .EUt(31457280))
                .save(provider);
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("super_computation_component"))
                ...
                .inputItems(CustomTags.UEV_CIRCUITS)
                .inputItems(GTItems.FIELD_GENERATOR_ZPM.asStack(2))
                .inputItems(GTItems.TOOL_DATA_ORB.asStack())
                .inputItems(GTOItems.HIGH_PRECISION_CRYSTAL_SOC.asStack())
                .inputItems(GTBlocks.OPTICAL_PIPES[0].asStack(4))
                .inputFluids(GTMaterials.SolderingAlloy.getFluid(576))
                .inputFluids(GTMaterials.VanadiumGallium.getFluid(576))
                .inputFluids(GTMaterials.PCBCoolant.getFluid(1000))
                .inputFluids(new FluidStack(GTOFluids.GELID_CRYOTHEUM.get(), 1000))
                .outputItems(GTOBlocks.SUPER_COMPUTATION_COMPONENT.asStack())
                .EUt(1966080)
                .duration(400)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("compound_extreme_cooling_unit"))
                ...
                .inputItems(MultiBlockMachineA.PLASMA_CONDENSER.asStack(16))
                ...
                .outputItems(MultiBlockMachineF.COMPOUND_EXTREME_COOLING_UNIT.asStack())
                .EUt(1966080)
                .duration(1200)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("decay_hastener"))
                ...
                .inputFluids(GTMaterials.SolderingAlloy.getFluid(1296))
                .inputFluids(GTOMaterials.Indalloy140.getFluid(1296))
                .outputItems(MultiBlockMachineA.DECAY_HASTENER.asStack())
                .EUt(491520)
                .duration(400)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("crystal_builder"))
                ...
                .inputFluids(GTMaterials.BatteryAlloy.getFluid(5760))
                .inputFluids(GTMaterials.MolybdenumDisilicide.getFluid(1296))
                .outputItems(MultiBlockMachineF.CRYSTAL_BUILDER.asStack())
                .EUt(7864320)
                .duration(600)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("component_assembly_line"))
                ...
                .outputItems(MultiBlockMachineA.COMPONENT_ASSEMBLY_LINE.asStack())
                .EUt(1966080)
                .duration(4200)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("stellar_forge"))
                ...
                .inputFluids(GTMaterials.Fermium.getFluid(2880))
                .outputItems(MultiBlockMachineA.STELLAR_FORGE.asStack())
                .EUt(1966080)
                .duration(600)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("quantum_force_transformer"))
                ...
                .outputItems(MultiBlockMachineA.QUANTUM_FORCE_TRANSFORMER.asStack())
                .EUt(125829120)
                .duration(2400)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("nano_core"))
                ...
                .inputItems(GTOTagPrefix.nanites, GTOMaterials.CosmicNeutronium, 16)
                .inputItems(MultiBlockMachineD.SUPRACHRONAL_ASSEMBLY_LINE.asStack(16))
                ...
                .outputItems(MultiBlockMachineF.NANO_CORE.asStack())
                .EUt(125829120)
                .duration(800)
                .stationResearch(b -> b.researchStack(MultiBlockMachineD.NANO_FORGE.asStack())
                        .CWUt(1200)
                        .EUt(503316480))
                .save(provider);
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("advanced_hyper_reactor"))
                ...
                .inputFluids(GTOMaterials.Indalloy140.getFluid(1296))
                .inputFluids(GTOMaterials.SuperMutatedLivingSolder.getFluid(864))
                .outputItems(GeneratorMultiblockMachine.ADVANCED_HYPER_REACTOR.asStack())
                .EUt(32000000)
                .duration(600)
                .stationResearch(b -> b.researchStack(GeneratorMultiblockMachine.HYPER_REACTOR.asStack())
                        .CWUt(1024)
                        .EUt(31457280))
                .save(provider);
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("molten_core"))
                ...
                .outputItems(MultiBlockMachineA.MOLTEN_CORE.asStack())
                .EUt(31457280)
                .duration(1600)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("mage_assembler"))
                ...
                .inputFluids(GTMaterials.Nobelium.getFluid(2880))
                .inputFluids(GTMaterials.Lawrencium.getFluid(2880))
                .outputItems(MultiBlockMachineA.MAGE_ASSEMBLER.asStack())
                .EUt(1966080)
                .duration(800)
                .stationResearch(b -> b.researchStack(MultiBlockMachineA.PRECISION_ASSEMBLER.asStack())
                        .CWUt(128)
                        .EUt(1966080))
                .save(provider);
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("large_naquadah_reactor"))
                ...
                .outputItems(GeneratorMultiblockMachine.LARGE_NAQUADAH_REACTOR.asStack())
                .EUt(90000)
                .duration(1000)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("superconducting_electromagnetism"))
                ...
                .outputItems(MultiBlockMachineF.SUPERCONDUCTING_ELECTROMAGNETISM.asStack())
                .EUt(7864320)
                .duration(1200)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("isa_mill"))
                ...
                .outputItems(MultiBlockMachineD.ISA_MILL.asStack())
                .EUt(30720)
                .duration(2400)
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("advanced_assembly_line"))
                ...
                .outputItems(MultiBlockMachineD.ADVANCED_ASSEMBLY_LINE.asStack())
                .EUt(491520)
                .duration(400)
