...
public class ComponentRecipes {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        VanillaRecipeHelper.addShapedRecipe(provider, GTOCore.id("ulv_electric_motor"), GTOItems.ELECTRIC_MOTOR_ULV.asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, GTOCore.id("ulv_electric_piston"), GTOItems.ELECTRIC_PISTON_ULV.asStack(),
                "PPP", "CRR", "CMG", 'P', new UnificationEntry(plate, Copper), 'C', new UnificationEntry(cableGtSingle, Lead),
                'R', new UnificationEntry(rod, Copper), 'M', GTOItems.ELECTRIC_MOTOR_ULV.asStack(), 'G', new UnificationEntry(gearSmall, Copper));
        VanillaRecipeHelper.addShapedRecipe(provider, GTOCore.id("ulv_electric_conveyor"), GTOItems.CONVEYOR_MODULE_ULV.asStack(),
                "RRR", "MCM", "RRR", 'R', new UnificationEntry(plate, Rubber), 'M', GTOItems.ELECTRIC_MOTOR_ULV.asStack(),
                'C', new UnificationEntry(cableGtSingle, Lead));
        VanillaRecipeHelper.addShapedRecipe(provider, GTOCore.id("ulv_electric_pump"), GTOItems.ELECTRIC_PUMP_ULV.asStack(),
                "SFR", "sPw", "RMC", 'S', new UnificationEntry(screw, Iron), 'R', new UnificationEntry(ring, Rubber),
                'F', new UnificationEntry(rotor, Iron), 'P', new UnificationEntry(pipeNormalFluid, Copper), 'M', GTOItems.ELECTRIC_MOTOR_ULV.asStack(), 'C', new UnificationEntry(cableGtSingle, Lead));
        VanillaRecipeHelper.addShapedRecipe(provider, GTOCore.id("ulv_robot_arm"), GTOItems.ROBOT_ARM_ULV.asStack(),
                "CCC", "MRM", "PVR", 'R', new UnificationEntry(rod, Copper), 'C', new UnificationEntry(cableGtSingle, Lead),
                'M', GTOItems.ELECTRIC_MOTOR_ULV.asStack(), 'P', GTOItems.ELECTRIC_PISTON_ULV.asStack(), 'V', GTItems.VACUUM_TUBE.asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, GTOCore.id("ulv_fluid_regulator"), GTOItems.FLUID_REGULATOR_ULV.asStack(),
                "SFR", "sPw", "RMC", 'S', new UnificationEntry(screw, Iron), 'R', GTItems.VACUUM_TUBE.asStack(),
                'F', new UnificationEntry(rotor, Iron), 'P', GTOItems.ELECTRIC_PUMP_ULV.asStack(), 'M', GTOItems.ELECTRIC_MOTOR_ULV.asStack(), 'C', new UnificationEntry(cableGtSingle, Lead));

        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("electric_motor_lv_steel"), ELECTRIC_MOTOR_LV.asStack(), "CWR",
                "WMW", "RWC", 'C', new UnificationEntry(GTOTagPrefix.curvedPlate, Steel), 'W',
                new UnificationEntry(wireGtSingle, Copper), 'R', new UnificationEntry(rod, Steel), 'M',
                new UnificationEntry(rod, SteelMagnetic));
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("electric_motor_mv"), ELECTRIC_MOTOR_MV.asStack(), "CWR",
                "WMW", "RWC", 'C', new UnificationEntry(GTOTagPrefix.curvedPlate, Aluminium), 'W',
                new UnificationEntry(wireGtDouble, Cupronickel), 'R', new UnificationEntry(rod, Aluminium), 'M',
                new UnificationEntry(rod, SteelMagnetic));
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("electric_motor_hv"), ELECTRIC_MOTOR_HV.asStack(), "CWR",
                "WMW", "RWC", 'C', new UnificationEntry(GTOTagPrefix.curvedPlate, StainlessSteel), 'W',
                new UnificationEntry(wireGtDouble, Electrum), 'R', new UnificationEntry(rod, StainlessSteel), 'M',
                new UnificationEntry(rod, SteelMagnetic));
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("electric_motor_ev"), ELECTRIC_MOTOR_EV.asStack(), "CWR",
                "WMW", "RWC", 'C', new UnificationEntry(GTOTagPrefix.curvedPlate, Titanium), 'W',
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("electric_motor_iv"), ELECTRIC_MOTOR_IV.asStack(), "CWR",
                "WMW", "RWC", 'C', new UnificationEntry(GTOTagPrefix.curvedPlate, TungstenSteel), 'W',
                new UnificationEntry(wireGtDouble, Graphene), 'R', new UnificationEntry(rod, TungstenSteel), 'M',
                new UnificationEntry(rod, NeodymiumMagnetic));

        ASSEMBLER_RECIPES.recipeBuilder(GTOCore.id("electric_motor_lv_steel"))
                .inputItems(GTOTagPrefix.curvedPlate, Steel, 2)
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTOCore.id("electric_motor_mv"))
                .inputItems(GTOTagPrefix.curvedPlate, Aluminium, 2)
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTOCore.id("electric_motor_hv"))
                .inputItems(GTOTagPrefix.curvedPlate, StainlessSteel, 2)
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTOCore.id("electric_motor_ev"))
                .inputItems(GTOTagPrefix.curvedPlate, Titanium, 2)
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTOCore.id("electric_motor_iv"))
                .inputItems(GTOTagPrefix.curvedPlate, TungstenSteel, 2)
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("electric_motor_luv"))
                ...
                .inputItems(GTOTagPrefix.curvedPlate, HSSS, 2)
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("electric_motor_zpm"))
                .inputItems(rodLong, SamariumMagnetic)
                ...
                .inputItems(GTOTagPrefix.curvedPlate, Osmiridium, 2)
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder(GTOCore.id("electric_motor_uv"))
                .inputItems(rodLong, SamariumMagnetic)
                ...
                .inputItems(wireFine, Americium, 64)
                .inputItems(GTOTagPrefix.curvedPlate, Tritanium, 2)
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true,
                "conveyor_module_lv", CONVEYOR_MODULE_LV.asStack(), "RRR", "MCM", "RRR",
                'R', new UnificationEntry(plate, Rubber), 'C', new UnificationEntry(cableGtSingle, Tin), 'M',
                ELECTRIC_MOTOR_LV.asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, true,
                "conveyor_module_mv", CONVEYOR_MODULE_MV.asStack(), "RRR", "MCM", "RRR",
                'R', new UnificationEntry(plate, Rubber), 'C', new UnificationEntry(cableGtSingle, Copper), 'M',
                ELECTRIC_MOTOR_MV.asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, true,
                "conveyor_module_hv", CONVEYOR_MODULE_HV.asStack(), "RRR", "MCM", "RRR",
                'R', new UnificationEntry(plate, Rubber), 'C', new UnificationEntry(cableGtSingle, Gold), 'M',
                ELECTRIC_MOTOR_HV.asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, true,
                "conveyor_module_ev", CONVEYOR_MODULE_EV.asStack(), "RRR", "MCM", "RRR",
                'R', new UnificationEntry(plate, SiliconeRubber), 'C', new UnificationEntry(cableGtSingle, Aluminium),
                'M', ELECTRIC_MOTOR_EV.asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, true,
                "conveyor_module_iv", CONVEYOR_MODULE_IV.asStack(),
                "RRR", "MCM", "RRR", 'R', new UnificationEntry(plate, SiliconeRubber), 'C',
                new UnificationEntry(cableGtSingle, Tungsten), 'M', ELECTRIC_MOTOR_IV.asStack());

        ASSEMBLER_RECIPES.recipeBuilder("conveyor_module_lv")
                .inputItems(cableGtSingle, Tin)
                .inputItems(ELECTRIC_MOTOR_LV, 2)
                .inputFluids(Rubber.getFluid(L * 6))
                .circuitMeta(1)
                .outputItems(CONVEYOR_MODULE_LV)
                .duration(100).EUt(VA[LV]).save(provider);

        ASSEMBLER_RECIPES.recipeBuilder("conveyor_module_mv")
        ...
        ASSEMBLER_RECIPES.recipeBuilder("conveyor_module_hv")
        ...
        ASSEMBLER_RECIPES.recipeBuilder("conveyor_module_ev")
                .inputItems(cableGtSingle, Aluminium)
                .inputItems(ELECTRIC_MOTOR_EV, 2)
                .inputFluids(SiliconeRubber.getFluid(L * 6))
                .circuitMeta(1)
                .outputItems(CONVEYOR_MODULE_EV)
                .duration(100).EUt(VA[LV]).save(provider);

        ASSEMBLER_RECIPES.recipeBuilder("conveyor_module_iv")
        ...
        // Start---------------------------------------------------------------------------------------------------
        VanillaRecipeHelper.addShapedRecipe(provider, true,
                "electric_pump_lv", ELECTRIC_PUMP_LV.asStack(), "SXR", "dPw", "RMC", 'S',
                new UnificationEntry(screw, Tin), 'X', new UnificationEntry(rotor, Tin), 'P',
                new UnificationEntry(pipeNormalFluid, Bronze), 'R', new UnificationEntry(ring, Rubber), 'C',
                new UnificationEntry(cableGtSingle, Tin), 'M', ELECTRIC_MOTOR_LV.asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, true,
                "electric_pump_mv", ELECTRIC_PUMP_MV.asStack(), "SXR", "dPw", "RMC", 'S',
                new UnificationEntry(screw, Bronze), 'X', new UnificationEntry(rotor, Bronze), 'P',
                new UnificationEntry(pipeNormalFluid, Steel), 'R', new UnificationEntry(ring, Rubber), 'C',
                new UnificationEntry(cableGtSingle, Copper), 'M', ELECTRIC_MOTOR_MV.asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, true,
                "electric_pump_hv", ELECTRIC_PUMP_HV.asStack(), "SXR", "dPw", "RMC", 'S',
                new UnificationEntry(screw, Steel), 'X', new UnificationEntry(rotor, Steel), 'P',
                new UnificationEntry(pipeNormalFluid, StainlessSteel), 'R', new UnificationEntry(ring, Rubber),
                'C', new UnificationEntry(cableGtSingle, Gold), 'M', ELECTRIC_MOTOR_HV.asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, true,
                "electric_pump_ev", ELECTRIC_PUMP_EV.asStack(), "SXR", "dPw", "RMC", 'S',
                new UnificationEntry(screw, StainlessSteel), 'X', new UnificationEntry(rotor, StainlessSteel), 'P',
                new UnificationEntry(pipeNormalFluid, Titanium), 'R', new UnificationEntry(ring, SiliconeRubber), 'C',
                new UnificationEntry(cableGtSingle, Aluminium), 'M', ELECTRIC_MOTOR_EV.asStack());

        VanillaRecipeHelper.addShapedRecipe(provider, true,
                "electric_pump_iv", ELECTRIC_PUMP_IV.asStack(), "SXR", "dPw", "RMC",
                'S', new UnificationEntry(screw, TungstenSteel), 'X',
                new UnificationEntry(rotor, TungstenSteel), 'P',
                new UnificationEntry(pipeNormalFluid, TungstenSteel), 'R', new UnificationEntry(ring, SiliconeRubber),
                'C', new UnificationEntry(cableGtSingle, Tungsten), 'M', ELECTRIC_MOTOR_IV.asStack());

        ASSEMBLER_RECIPES.recipeBuilder("electric_pump_lv")
                .inputItems(cableGtSingle, Tin)
        ...
        ASSEMBLER_RECIPES.recipeBuilder("electric_pump_mv")
                .inputItems(cableGtSingle, Copper)
        ...
        ASSEMBLER_RECIPES.recipeBuilder("electric_pump_hv")
                .inputItems(cableGtSingle, Gold)
