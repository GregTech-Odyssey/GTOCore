...
interface Vanilla {
    ...
    static void init(Consumer<FinishedRecipe> provider) {
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("ev_rocket_engine"), GTOMachines.ROCKET_ENGINE_GENERATOR[GTValues.EV].asStack(),
                ...
                "CDC",
                "EFE",
                'A', new UnificationEntry(TagPrefix.rotor, GTMaterials.Lead), 'B', CustomTags.EV_CIRCUITS, 'C', GTItems.ELECTRIC_MOTOR_EV.asStack(), 'D', GTMachines.HULL[GTValues.EV].asStack(), 'E', new UnificationEntry(TagPrefix.cableGtDouble, GTMaterials.Steel), 'F', GTItems.ELECTRIC_PUMP_EV.asItem());
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("iv_rocket_engine"), GTOMachines.ROCKET_ENGINE_GENERATOR[GTValues.IV].asStack(),
                ...
                "CDC",
                "EFE",
                'A', new UnificationEntry(TagPrefix.rotor, GTMaterials.Chromium), 'B', CustomTags.IV_CIRCUITS, 'C', GTItems.ELECTRIC_MOTOR_IV.asStack(), 'D', GTMachines.HULL[GTValues.IV].asStack(), 'E', new UnificationEntry(TagPrefix.cableGtDouble, GTMaterials.TungstenSteel), 'F', GTItems.ELECTRIC_PUMP_IV.asItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("opv_thread_hatch"), GTOMachines.THREAD_HATCH[GTValues.OpV].asStack(),
                ...
                "CDC",
                "EFE",
                'A', CustomTags.MAX_CIRCUITS, 'B', GTItems.ROBOT_ARM_OpV.asStack(), 'C', GTItems.CONVEYOR_MODULE_OpV.asStack(), 'D', RegistriesUtils.getItemStack("gtceu:opv_parallel_hatch"), 'E', new UnificationEntry(TagPrefix.wireGtHex, GTOMaterials.AwakenedDraconium), 'F', GTItems.FIELD_GENERATOR_OpV.asItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("max_thread_hatch"), GTOMachines.THREAD_HATCH[GTValues.MAX].asStack(),
                ...
                "CDC",
                "EFE",
                'A', GTOItems.SUPRACHRONAL_CIRCUIT[GTValues.MAX].asStack(), 'B', GTOItems.MAX_ROBOT_ARM.asStack(), 'C', GTOItems.MAX_CONVEYOR_MODULE.asStack(), 'D', RegistriesUtils.getItemStack("gtceu:max_parallel_hatch"), 'E', new UnificationEntry(TagPrefix.wireGtHex, GTOMaterials.Hypogen), 'F', GTOItems.MAX_FIELD_GENERATOR.asItem());
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("uev_thread_hatch"), GTOMachines.THREAD_HATCH[GTValues.UEV].asStack(),
                ...
                "CDC",
                "EFE",
                'A', CustomTags.UIV_CIRCUITS, 'B', GTItems.ROBOT_ARM_UEV.asStack(), 'C', GTItems.CONVEYOR_MODULE_UEV.asStack(), 'D', RegistriesUtils.getItemStack("gtceu:uev_parallel_hatch"), 'E', new UnificationEntry(TagPrefix.wireGtHex, GTOMaterials.Enderite), 'F', GTItems.FIELD_GENERATOR_UEV.asItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("steam_cracker"), MultiBlockC.STEAM_CRACKER.asStack(),
                ...
                "BCB",
                "DBD",
                'A', new UnificationEntry(TagPrefix.pipeNormalFluid, GTMaterials.TinAlloy), 'B', new UnificationEntry(TagPrefix.pipeQuadrupleFluid, GTMaterials.Potin), 'C', RegistriesUtils.getItemStack("gtceu:hp_steam_alloy_smelter"), 'D', GTOItems.ULV_FLUID_REGULATOR.asItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("large_steam_centrifuge"), MultiBlockA.LARGE_STEAM_CENTRIFUGE.asStack(),
                ...
                "CDC",
                "ABA",
                'A', new UnificationEntry(TagPrefix.block, GTMaterials.Bronze), 'B', GTOItems.PRECISION_STEAM_MECHANISM.asStack(), 'C', new UnificationEntry(TagPrefix.gearSmall, GTMaterials.Iron), 'D', MultiBlockA.STEAM_SEPARATOR.getItem());
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("large_cracker"), MultiBlockA.LARGE_CRACKER.asStack(),
                "ABA",
                "CDC",
                "ABA",
                'A', GTItems.FIELD_GENERATOR_LuV.asStack(), 'B', CustomTags.UV_CIRCUITS, 'C', new UnificationEntry(TagPrefix.spring, GTMaterials.Naquadah), 'D', GTMultiMachines.CRACKER.getItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("large_rock_crusher"), MultiBlockA.LARGE_ROCK_CRUSHER.asStack(),
                ...
                "CDC",
                "ABA",
                'A', GTItems.ELECTRIC_PISTON_IV.asStack(), 'B', CustomTags.IV_CIRCUITS, 'C', new UnificationEntry(TagPrefix.cableGtDouble, GTMaterials.Platinum), 'D', GTMachines.ROCK_CRUSHER[GTValues.IV].getItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("block_bus"), GTOMachines.BLOCK_BUS.asStack(),
                ...
                "CDC",
                "ABA",
                'A', new UnificationEntry(TagPrefix.block, GTOMaterials.EnergeticAlloy), 'B', new UnificationEntry(TagPrefix.block, GTOMaterials.ConductiveAlloy), 'C', RegistriesUtils.getItemStack("enderio:vacuum_chest"), 'D', GTMachines.ITEM_IMPORT_BUS[GTValues.LuV].getItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("uxv_thread_hatch"), GTOMachines.THREAD_HATCH[GTValues.UXV].asStack(),
                ...
                "CDC",
                "EFE",
                'A', CustomTags.OpV_CIRCUITS, 'B', GTItems.ROBOT_ARM_UXV.asStack(), 'C', GTItems.CONVEYOR_MODULE_UXV.asStack(), 'D', RegistriesUtils.getItemStack("gtceu:uxv_parallel_hatch"), 'E', new UnificationEntry(TagPrefix.wireGtHex, GTOMaterials.Legendarium), 'F', GTItems.FIELD_GENERATOR_UXV.asItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("heat_sensor"), GTOMachines.HEAT_SENSOR.asStack(),
                ...
                "BCB",
                "ABA",
                'A', new UnificationEntry(TagPrefix.pipeTinyFluid, GTMaterials.Steel), 'B', new ItemStack(Blocks.REPEATER.asItem()), 'C', GTBlocks.MACHINE_CASING_LV.asItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("leap_forward_one_blast_furnace"), MultiBlockA.LEAP_FORWARD_ONE_BLAST_FURNACE.asStack(),
                ...
                "BCB",
                "DDD",
                'A', new UnificationEntry(TagPrefix.foil, GTMaterials.WroughtIron), 'B', RegistriesUtils.getItemStack("ad_astra:airlock"), 'C', GTMultiMachines.PRIMITIVE_BLAST_FURNACE.asStack(), 'D', GTItems.FIRECLAY_BRICK.asItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("large_steam_thermal_centrifuge"), MultiBlockA.LARGE_STEAM_THERMAL_CENTRIFUGE.asStack(),
                ...
                "CDC",
                "ABA",
                'A', new UnificationEntry(TagPrefix.plate, GTMaterials.Bronze), 'B', GTOItems.PRECISION_STEAM_MECHANISM.asStack(), 'C', new UnificationEntry(TagPrefix.rodLong, GTMaterials.Copper), 'D', MultiBlockA.STEAM_SEPARATOR.getItem());
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("precision_steam_mechanism"), GTOItems.PRECISION_STEAM_MECHANISM.asStack(),
                ...
                "CDC",
                "EBE",
                'A', new UnificationEntry(TagPrefix.rod, GTMaterials.Bronze), 'B', new UnificationEntry(TagPrefix.gearSmall, GTMaterials.Bronze), 'C', new UnificationEntry(TagPrefix.springSmall, GTMaterials.Copper), 'D', RegistriesUtils.getItemStack("enderio:dark_bimetal_gear"), 'E', GTOItems.ULV_FLUID_REGULATOR.asItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("advanced_assembly_line_unit"), GTOBlocks.ADVANCED_ASSEMBLY_LINE_UNIT.asStack(),
                ...
                "CDC",
                "ABA",
                'A', new UnificationEntry(TagPrefix.plate, GTMaterials.HSSG), 'B', new UnificationEntry(TagPrefix.gear, GTMaterials.Rhodium), 'C', CustomTags.UV_CIRCUITS, 'D', GTBlocks.CASING_ASSEMBLY_LINE.asItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("dragon_stabilizer_core"), GTOItems.DRAGON_STABILIZER_CORE.asStack(),
                ...
                "BCB",
                "ABA",
                'A', new UnificationEntry(TagPrefix.plateDouble, GTOMaterials.Draconium), 'B', new UnificationEntry(TagPrefix.rodLong, GTOMaterials.CosmicNeutronium), 'C', GTOItems.STABILIZER_CORE.asItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("processing_plant"), MultiBlockD.PROCESSING_PLANT.asStack(),
                ...
                "CDE",
                "AFA",
                'A', new UnificationEntry(TagPrefix.foil, GTMaterials.Aluminium), 'B', GTItems.CONVEYOR_MODULE_MV.asStack(), 'C', GTItems.SENSOR_MV.asStack(), 'D', GTOBlocks.MULTI_FUNCTIONAL_CASING.asStack(), 'E', GTItems.EMITTER_MV.asStack(), 'F', GTItems.FLUID_REGULATOR_MV.asItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("liquefaction_furnace"), MultiBlockB.LIQUEFACTION_FURNACE.asStack(),
                ...
                "CDC",
                "ABA",
                'A', new UnificationEntry(TagPrefix.plate, GTMaterials.Invar), 'B', new UnificationEntry(TagPrefix.cableGtDouble, GTMaterials.Nickel), 'C', new ItemStack(Blocks.BLAST_FURNACE.asItem()), 'D', GTMachines.EXTRACTOR[GTValues.LV].getItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("uhv_thread_hatch"), GTOMachines.THREAD_HATCH[GTValues.UHV].asStack(),
                ...
                "CDC",
                "EFE",
                'A', CustomTags.UEV_CIRCUITS, 'B', GTItems.ROBOT_ARM_UHV.asStack(), 'C', GTItems.CONVEYOR_MODULE_UHV.asStack(), 'D', RegistriesUtils.getItemStack("gtceu:uhv_parallel_hatch"), 'E', new UnificationEntry(TagPrefix.wireGtHex, GTMaterials.RutheniumTriniumAmericiumNeutronate), 'F', GTItems.FIELD_GENERATOR_UHV.asItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("vacuum_hatch"), GTOMachines.VACUUM_HATCH.asStack(),
                ...
                "BCB",
                "ABA",
                'A', GTItems.ROBOT_ARM_EV.asStack(), 'B', new UnificationEntry(TagPrefix.pipeLargeFluid, GTMaterials.VanadiumSteel), 'C', GTMachines.PUMP[GTValues.EV].getItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("multi_functional_casing"), GTOBlocks.MULTI_FUNCTIONAL_CASING.asStack(),
                ...
                "CDC",
                "ABA",
                'A', new UnificationEntry(TagPrefix.plateDouble, GTMaterials.Aluminium), 'B', GTItems.ROBOT_ARM_MV.asStack(), 'C', GTItems.ELECTRIC_PISTON_MV.asStack(), 'D', GTBlocks.CASING_STEEL_SOLID.asItem());
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("large_pyrolyse_oven"), MultiBlockA.LARGE_PYROLYSE_OVEN.asStack(),
                "ABA",
                "CDC",
                "ABA",
                'A', new UnificationEntry(TagPrefix.plateDouble, GTMaterials.StainlessSteel), 'B', GTItems.FIELD_GENERATOR_IV.asStack(), 'C', new UnificationEntry(TagPrefix.pipeHugeFluid, GTMaterials.VanadiumSteel), 'D', GTMultiMachines.PYROLYSE_OVEN.getItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("stabilizer_core"), GTOItems.STABILIZER_CORE.asStack(),
                ...
                "BCB",
                "ABA",
                'A', new UnificationEntry(TagPrefix.plateDouble, GTOMaterials.Infuscolium), 'B', new UnificationEntry(TagPrefix.rodLong, GTMaterials.Neutronium), 'C', GTOItems.TIME_DILATION_CONTAINMENT_UNIT.asItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("uiv_thread_hatch"), GTOMachines.THREAD_HATCH[GTValues.UIV].asStack(),
                ...
                "CDC",
                "EFE",
                'A', CustomTags.UXV_CIRCUITS, 'B', GTItems.ROBOT_ARM_UIV.asStack(), 'C', GTItems.CONVEYOR_MODULE_UIV.asStack(), 'D', RegistriesUtils.getItemStack("gtceu:uiv_parallel_hatch"), 'E', new UnificationEntry(TagPrefix.wireGtHex, GTOMaterials.Echoite), 'F', GTItems.FIELD_GENERATOR_UIV.asItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("reaction_furnace"), MultiBlockB.REACTION_FURNACE.asStack(),
                ...
                "CDC",
                "BAB",
                'A', GTMachines.ELECTRIC_FURNACE[GTValues.MV].asStack(), 'B', RegistriesUtils.getItemStack("gtceu:gold_drum"), 'C', new UnificationEntry(TagPrefix.cableGtOctal, GTMaterials.Iron), 'D', GTMachines.CHEMICAL_REACTOR[GTValues.LV].getItem());
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("aggregatione_core"), GTOBlocks.AGGREGATIONE_CORE.asStack(),
                "ABA",
                "BCB",
                "ABA",
                'A', new UnificationEntry(TagPrefix.ingot, GTOMaterials.AttunedTengam), 'B', GTOBlocks.INFUSED_OBSIDIAN.asStack(), 'C', GTOBlocks.MAGIC_CORE.asItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("large_steam_macerator"), MultiBlockA.LARGE_STEAM_MACERATOR.asStack(),
                ...
                "CDC",
                "ABA",
                'A', new UnificationEntry(TagPrefix.block, GTMaterials.Bronze), 'B', RegistriesUtils.getItemStack("enderio:energetic_alloy_grinding_ball"), 'C', GTOItems.PRECISION_STEAM_MECHANISM.asStack(), 'D', GTMultiMachines.STEAM_GRINDER.getItem());
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("luv_rocket_engine"), GTOMachines.ROCKET_ENGINE_GENERATOR[GTValues.LuV].asStack(),
                ...
                "CDC",
                "EFE",
                'A', new UnificationEntry(TagPrefix.rotor, GTMaterials.RhodiumPlatedPalladium), 'B', CustomTags.LuV_CIRCUITS, 'C', GTItems.ELECTRIC_MOTOR_LuV.asStack(), 'D', GTMachines.HULL[GTValues.LuV].asStack(), 'E', new UnificationEntry(TagPrefix.cableGtDouble, GTMaterials.Osmium), 'F', GTItems.ELECTRIC_PUMP_LuV.asItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("lava_furnace"), MultiBlockA.LAVA_FURNACE.asStack(),
                ...
                "CDC",
                "ABA",
                'A', new UnificationEntry(TagPrefix.plateDouble, GTMaterials.Copper), 'B', new UnificationEntry(TagPrefix.plateDouble, GTMaterials.WroughtIron), 'C', new UnificationEntry(TagPrefix.cableGtHex, GTMaterials.Tin), 'D', GTMultiMachines.STEAM_OVEN.getItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, GTOCore.id("ulv_output_hatch"), GTMachines.FLUID_EXPORT_HATCH[GTValues.ULV].asStack(),
                ...
                "hBw",
                " C ",
                'B', GTItems.STICKY_RESIN.asStack(), 'C', new UnificationEntry(TagPrefix.block, GTMaterials.Glass), 'A', GTMachines.HULL[GTValues.ULV].getItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("drone_control_center"), MultiBlockG.DRONE_CONTROL_CENTER.asStack(),
                ...
                "CDC",
                "EEE",
                'B', GTItems.ROBOT_ARM_HV.asStack(), 'D', GTMachines.HULL[GTValues.HV].asStack(), 'C', GTItems.SENSOR_HV.asStack(), 'E', new UnificationEntry(TagPrefix.plateDouble, GTMaterials.StainlessSteel), 'A', GTItems.EMITTER_HV.asItem());
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("three_dimensional_printer"), MultiBlockC.THREE_DIMENSIONAL_PRINTER.asStack(),
                ...
                "CDC",
                "EFE",
                'B', GTItems.CONVEYOR_MODULE_HV.asStack(), 'F', new UnificationEntry(TagPrefix.plateDouble, GTMaterials.Titanium), 'D', GTMachines.HULL[GTValues.HV].asStack(), 'C', GTItems.FLUID_REGULATOR_HV.asStack(), 'E', GTItems.ROBOT_ARM_HV.asStack(), 'A', GTItems.SENSOR_HV.asItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("satellite_control_center"), MultiBlockG.SATELLITE_CONTROL_CENTER.asStack(),
                ...
                "CDC",
                "EFE",
                'B', GTItems.EMITTER_HV.asStack(), 'F', new ItemStack(AEItems.WIRELESS_BOOSTER.asItem()), 'D', GTMachines.HULL[GTValues.HV].asStack(), 'C', CustomTags.HV_CIRCUITS, 'E', new UnificationEntry(TagPrefix.rodLong, GTMaterials.StainlessSteel), 'A', GTItems.SENSOR_HV.asItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("drilling_control_center"), MultiBlockG.DRILLING_CONTROL_CENTER.asStack(),
                ...
                "BCB",
                "DBD",
                'B', GTItems.FIELD_GENERATOR_IV.asStack(), 'D', new UnificationEntry(TagPrefix.wireGtHex, GTMaterials.SamariumIronArsenicOxide), 'C', GTMachines.WORLD_ACCELERATOR[GTValues.EV].asStack(), 'A', GTItems.SENSOR_IV.asItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("polymerization_reactor"), MultiBlockG.POLYMERIZATION_REACTOR.asStack(),
                ...
                "CDC",
                "EFE",
                'A', RegistriesUtils.getItemStack("gtceu:huge_duct_pipe"), 'B', GTItems.ELECTRIC_PUMP_HV.asStack(), 'C', new UnificationEntry(TagPrefix.pipeHugeFluid, GTMaterials.StainlessSteel), 'D', GTBlocks.COIL_KANTHAL.asStack(), 'E', CustomTags.EV_CIRCUITS, 'F', GTMachines.HULL[GTValues.HV].getItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("ulv_lathe"), GTOMachines.ULV_LATHE[GTValues.ULV].asStack(),
                ...
                "CDE",
                "BAF",
                'A', new UnificationEntry(TagPrefix.cableGtSingle, GTMaterials.RedAlloy), 'B', CustomTags.ULV_CIRCUITS, 'C', GTOItems.ULV_ELECTRIC_MOTOR.asStack(), 'D', GTMachines.HULL[GTValues.ULV].asStack(), 'E', new UnificationEntry(TagPrefix.gem, GTMaterials.Diamond), 'F', GTOItems.ULV_ELECTRIC_PISTON.asItem());
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("ulv_wiremill"), GTOMachines.ULV_WIREMILL[GTValues.ULV].asStack(),
                "ABA",
                "CDC",
                "ABA",
                'A', GTOItems.ULV_ELECTRIC_MOTOR.asStack(), 'B', new UnificationEntry(TagPrefix.cableGtSingle, GTMaterials.RedAlloy), 'C', CustomTags.ULV_CIRCUITS, 'D', GTMachines.HULL[GTValues.ULV].getItem());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, GTOCore.id("crystallization_chamber"), MultiBlockG.CRYSTALLIZATION_CHAMBER.asStack(),
                ...
                "CDC",
                "ABA",
                'A', GTBlocks.COIL_CUPRONICKEL.asStack(), 'B', new UnificationEntry(TagPrefix.pipeHugeFluid, GTMaterials.Gold), 'C', GTItems.FLUID_REGULATOR_MV.asStack(), 'D', GTMachines.AUTOCLAVE[GTValues.LV].getItem());
