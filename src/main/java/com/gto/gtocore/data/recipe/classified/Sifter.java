...
interface Sifter {
    ...
    static void init(Consumer<FinishedRecipe> provider) {
        GTRecipeTypes.SIFTER_RECIPES.recipeBuilder(GTOCore.id("tricalcium_phosphate_ceramic_dust"))
        ...
        GTRecipeTypes.SIFTER_RECIPES.recipeBuilder(GTOCore.id("cobalt_oxide_ceramic_dust"))
        ...
        GTRecipeTypes.SIFTER_RECIPES.recipeBuilder(GTOCore.id("alumina_ceramic_dust"))
        ...
        GTRecipeTypes.SIFTER_RECIPES.recipeBuilder(GTOCore.id("magnesium_oxide_ceramic_dust"))
        ...
        GTRecipeTypes.SIFTER_RECIPES.recipeBuilder(GTOCore.id("boron_carbide_ceramics_dust"))
        ...
        GTRecipeTypes.SIFTER_RECIPES.recipeBuilder(GTOCore.id("zirconia_ceramic_dust"))
