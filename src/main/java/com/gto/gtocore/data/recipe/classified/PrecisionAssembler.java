...
interface PrecisionAssembler {
    ...
    static void init() {
        ...
        PRECISION_ASSEMBLER_RECIPES.recipeBuilder(GTOCore.id("uv_kuangbiao_one_giant_nuclear_fusion_reactor"))
                ...
                .outputItems(MultiBlockD.KUANGBIAO_ONE_GIANT_NUCLEAR_FUSION_REACTOR[GTValues.UV].asStack())
                .EUt(491520)
                .duration(400)
                .cleanroom(CleanroomType.CLEANROOM)
                .save();
        ...
        PRECISION_ASSEMBLER_RECIPES.recipeBuilder(GTOCore.id("luv_kuangbiao_one_giant_nuclear_fusion_reactor"))
                ...
                .inputFluids(GTMaterials.SolderingAlloy.getFluid(2304))
                .inputFluids(GTMaterials.Polybenzimidazole.getFluid(2304))
                .outputItems(MultiBlockD.KUANGBIAO_ONE_GIANT_NUCLEAR_FUSION_REACTOR[GTValues.LuV].asStack())
                .EUt(30720)
                .duration(400)
                .cleanroom(CleanroomType.CLEANROOM)
                .save();
        ...
        PRECISION_ASSEMBLER_RECIPES.recipeBuilder(GTOCore.id("uev_kuangbiao_one_giant_nuclear_fusion_reactor"))
                ...
                .inputFluids(GTMaterials.SolderingAlloy.getFluid(2304))
                .inputFluids(GTMaterials.Polybenzimidazole.getFluid(2304))
                .outputItems(MultiBlockD.KUANGBIAO_ONE_GIANT_NUCLEAR_FUSION_REACTOR[GTValues.UEV].asStack())
                .EUt(7864320)
                .duration(400)
                .cleanroom(CleanroomType.CLEANROOM)
                .save();
        ...
        PRECISION_ASSEMBLER_RECIPES.recipeBuilder(GTOCore.id("uhv_kuangbiao_one_giant_nuclear_fusion_reactor"))
                ...
                .inputFluids(GTMaterials.SolderingAlloy.getFluid(2304))
                .inputFluids(GTMaterials.Polybenzimidazole.getFluid(2304))
                .outputItems(MultiBlockD.KUANGBIAO_ONE_GIANT_NUCLEAR_FUSION_REACTOR[GTValues.UHV].asStack())
                .EUt(1966080)
                .duration(400)
                .cleanroom(CleanroomType.CLEANROOM)
                .save();
        ...
        PRECISION_ASSEMBLER_RECIPES.recipeBuilder(GTOCore.id("zpm_kuangbiao_one_giant_nuclear_fusion_reactor"))
                ...
                .inputFluids(GTMaterials.SolderingAlloy.getFluid(2304))
                .inputFluids(GTMaterials.Polybenzimidazole.getFluid(2304))
                .outputItems(MultiBlockD.KUANGBIAO_ONE_GIANT_NUCLEAR_FUSION_REACTOR[GTValues.ZPM].asStack())
                .EUt(122880)
                .duration(400)
                .cleanroom(CleanroomType.CLEANROOM)
                .save();
