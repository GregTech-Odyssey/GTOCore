...
public class ExDataAccessHatchMachine extends TieredPartMachine
                                      implements IMachineLife, IDataAccessHatch, IDataInfoProvider {

    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(
            ExDataAccessHatchMachine.class, MultiblockPartMachine.MANAGED_FIELD_HOLDER);
    ...
    public ExDataAccessHatchMachine(IMachineBlockEntity holder, int tier, boolean isCreative) {
        super(holder, tier);
