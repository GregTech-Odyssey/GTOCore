...
public class ExDataComputationHatchMachine extends MultiblockPartMachine {
    ...
    public ExDataComputationHatchMachine(IMachineBlockEntity holder, boolean transmitter) {
        super(holder);
