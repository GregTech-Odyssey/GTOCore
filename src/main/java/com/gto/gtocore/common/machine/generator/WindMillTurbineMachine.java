...
public final class WindMillTurbineMachine extends TieredEnergyMachine implements IMachineModifyDrops, IFancyUIMachine {
    ...
    public void attachTooltips(TooltipsPanel tooltipsPanel) {
        ...
        tooltipsPanel.attachTooltips(new IFancyTooltip.Basic(() -> GuiTextures.INFO_ICON,
                () -> List.of(Component.translatable("gtocore.machine.wind_mill_turbine.wind", FormattingUtil.formatNumbers(wind)),
                        Component.translatable("gtocore.machine.wind_mill_turbine.actualPower", actualPower)),
                () -> true, () -> null));
    }
