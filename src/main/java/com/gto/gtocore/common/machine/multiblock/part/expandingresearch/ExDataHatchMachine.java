...
public class ExDataHatchMachine extends MultiblockPartMachine implements IOpticalDataAccessHatch {

    @Getter
    private final boolean isTransmitter;

    public ExDataHatchMachine(IMachineBlockEntity holder, boolean isTransmitter) {
        super(holder);
