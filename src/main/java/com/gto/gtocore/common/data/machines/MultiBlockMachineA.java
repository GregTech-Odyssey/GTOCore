...
public final class MultiBlockMachineA {

    public static void init() {}

    public final static MultiblockMachineDefinition PLASMA_CONDENSER = multiblock("plasma_condenser", "等离子冷凝器", ElectricMultiblockMachine::new)
            .allRotation()
            .recipe(GTORecipeTypes.PLASMA_CONDENSER_RECIPES)
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .where('b', blocks(GTOBlocks.NEUTRONIUM_PIPE_CASING.get()))
    ...
    public final static MultiblockMachineDefinition RARE_EARTH_CENTRIFUGAL = multiblock("rare_earth_centrifugal", "稀土离心机", ElectricMultiblockMachine::new)
            .allRotation()
            .recipe(GTORecipeTypes.RARE_EARTH_CENTRIFUGAL_RECIPES)
            ...
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .where('d', blocks(GTOBlocks.NEUTRONIUM_PIPE_CASING.get()))
                    .where(' ', any())
                    .build())
    ...
    public final static MultiblockMachineDefinition ADVANCED_RARE_EARTH_CENTRIFUGAL = multiblock("advanced_rare_earth_centrifugal", "进阶稀土离心机", ElectricMultiblockMachine::new)
            .nonYAxisRotation()
            .recipe(GTORecipeTypes.RARE_EARTH_CENTRIFUGAL_RECIPES)
            .parallelizableTooltips()
            ...
            .pattern((definition) -> FactoryBlockPattern.start(RelativeDirection.FRONT, RelativeDirection.UP, RelativeDirection.RIGHT)
                    ...
                    .where('G', blocks(GTOBlocks.NEUTRONIUM_GEARBOX.get()))
                    .where('H', blocks(GTOBlocks.NEUTRONIUM_PIPE_CASING.get()))
    ...
    public final static MultiblockMachineDefinition MAGIC_MANUFACTURER = multiblock("magic_manufacturer", "魔法制造机", ElectricManaMultiblockMachine::new)
            .nonYAxisRotation()
    ...
    public final static MultiblockMachineDefinition ADVANCED_SPS_CRAFTING = multiblock("advanced_sps_crafting", "进阶超临界合成机", ElectricMultiblockMachine::new)
            ...
            .pattern((definition) -> FactoryBlockPattern.start(RelativeDirection.FRONT, RelativeDirection.UP, RelativeDirection.RIGHT)
                    ...
                    .where('E', blocks(GTOBlocks.NEUTRONIUM_ACTIVE_CASING.get()))
                    ...
                    .where('K', blocks(GTOBlocks.NEUTRONIUM_CASING.get()))
                    .where('L', blocks(GTOBlocks.FUSION_COIL_MK2.get()))
                    .where('M', blocks(GTOBlocks.NEUTRONIUM_PIPE_CASING.get()))
    ...
    public final static MultiblockMachineDefinition MATTER_FABRICATOR = multiblock("matter_fabricator", "物质生成机", ElectricMultiblockMachine::new)
            .allRotation()
            .recipe(GTORecipeTypes.MATTER_FABRICATOR_RECIPES)
            .parallelizableTooltips()
    ...
    public final static MultiblockMachineDefinition VOID_FLUID_DRILLING_RIG = multiblock("void_fluid_drilling_rig", "虚空流体钻机", VoidFluidDrillingRigMachine::new)
            .nonYAxisRotation()
    ...
    public final static MultiblockMachineDefinition VOID_MINER = multiblock("void_miner", "虚空采矿机", VoidMinerMachine::new)
            .nonYAxisRotation()
    ...
    public final static MultiblockMachineDefinition LARGE_VOID_MINER = multiblock("large_void_miner", "大型虚空采矿厂", ElectricMultiblockMachine::new)
            .nonYAxisRotation()
            .recipe(GTORecipeTypes.LARGE_VOID_MINER_RECIPES)
    ...
    public final static MultiblockMachineDefinition CHEMICAL_PLANT = multiblock("chemical_plant", "化工厂", CoilMultiblockMachine.createCoilMachine(false, false))
            .allRotation()
            .recipe(GTORecipeTypes.CHEMICAL)
    ...
    public final static MultiblockMachineDefinition DECAY_HASTENER = multiblock("decay_hastener", "衰变加速器", ElectricMultiblockMachine::new)
            .allRotation()
            .recipe(GTORecipeTypes.DECAY_HASTENER_RECIPES)
            .parallelizableTooltips()
            .parallelizableOverclock()
    ...
    public final static MultiblockMachineDefinition RECYCLER = multiblock("recycler", "回收机", CustomParallelMultiblockMachine.createParallel(m -> 1 << Math.max(0, (2 * (m.getTier() - 4))), true))
            .allRotation()
            .recipe(GTORecipeTypes.RECYCLER_RECIPES)
    ...
    public final static MultiblockMachineDefinition MASS_FABRICATOR = multiblock("mass_fabricator", "质量发生器", ElectricMultiblockMachine::new)
            .allRotation()
            .recipe(GTORecipeTypes.MASS_FABRICATOR_RECIPES)
            .parallelizableTooltips()
            .customTooltipsBuilder(true, false, false)
            .parallelizablePerfectOverclock()
    ...
    public final static MultiblockMachineDefinition ADVANCED_MASS_FABRICATOR = multiblock("advanced_mass_fabricator", "进阶质量发生器", ElectricMultiblockMachine::new)
            .allRotation()
            .recipe(GTORecipeTypes.MASS_FABRICATOR_RECIPES)
            ...
            .parallelizableTooltips()
            .customTooltipsBuilder(true, true, false)
            .recipeModifiers(GTORecipeModifiers.HATCH_PARALLEL, GTORecipeModifiers.overclocking(true, 0.8, 0.5))
    ...
    public final static MultiblockMachineDefinition PRECISION_ASSEMBLER = multiblock("precision_assembler", "精密组装机", TierCasingParallelMultiblockMachine.createParallel(m -> 1 << (m.getCasingTiers().get(GLASS_TIER)), true, GLASS_TIER, MACHINE_CASING_TIER))
            .allRotation()
    ...
    public final static MultiblockMachineDefinition FISHING_GROUND = multiblock("fishing_ground", "渔场", FishingGroundMachine::new)
            .nonYAxisRotation()
            .recipe(GTORecipeTypes.FISHING_GROUND_RECIPES)
            .parallelizableTooltips()
            .parallelizableOverclock()
    ...
    public final static MultiblockMachineDefinition LAVA_FURNACE = multiblock("lava_furnace", "熔岩炉", ElectricMultiblockMachine::new)
            .allRotation()
            .recipe(GTORecipeTypes.LAVA_FURNACE_RECIPES)
    ...
    public final static MultiblockMachineDefinition LARGE_GAS_COLLECTOR = multiblock("large_gas_collector", "大型集气室", CustomParallelMultiblockMachine.createParallel(m -> 100000, true))
            .noneRotation()
            .recipe(GTORecipeTypes.LARGE_GAS_COLLECTOR_RECIPES)
            .overclock()
    ...
    public final static MultiblockMachineDefinition AGGREGATION_DEVICE = multiblock("aggregation_device", "聚合装置", CustomParallelMultiblockMachine.createParallel(m -> 1 << Math.max(0, (m.getTier() - GTValues.UEV)), true))
            .allRotation()
    ...
    public final static MultiblockMachineDefinition ENGRAVING_LASER_PLANT = multiblock("engraving_laser_plant", "激光蚀刻工厂", ElectricMultiblockMachine::new)
            .allRotation()
            .recipe(GTORecipeTypes.PRECISION_LASER_ENGRAVER_RECIPES)
            .recipe(GTRecipeTypes.LASER_ENGRAVER_RECIPES)
            .recipe(GTORecipeTypes.LASER_WELDER_RECIPES)
            ...
            .recipeModifiers((machine, r) -> recipe -> {
                if (machine instanceof ElectricMultiblockMachine workableElectricMultiblockMachine) {
                    ...
                    if (workableElectricMultiblockMachine.getRecipeType() == GTORecipeTypes.LASER_WELDER_RECIPES) {
                        ...
                        return GTORecipeModifiers.hatchParallel(workableElectricMultiblockMachine, recipe);
                    }
                }
                return recipe;
            }, GTORecipeModifiers.PERFECT_OVERCLOCKING)
            ...
            .pattern(definition -> FactoryBlockPattern.start(RelativeDirection.RIGHT, RelativeDirection.UP, RelativeDirection.BACK)
                    ...
                    .where('D', blocks(GTOBlocks.NEUTRONIUM_GEARBOX.get()))
                    ...
                    .where('I', blocks(GTOBlocks.NEUTRONIUM_PIPE_CASING.get()))
    ...
    public final static MultiblockMachineDefinition MEGA_ALLOY_BLAST_SMELTER = multiblock("mega_alloy_blast_smelter", "巨型合金冶炼炉", CoilMultiblockMachine.createCoilMachine(true, true))
            .nonYAxisRotation()
    ...
    public final static MultiblockMachineDefinition MAGNETIC_CONFINEMENT_DIMENSIONALITY_SHOCK_DEVICE = multiblock("magnetic_confinement_dimensionality_shock_device", "磁约束维度震荡装置", ElectricMultiblockMachine::new)
            .allRotation()
            .recipe(GTORecipeTypes.DIMENSIONALLY_TRANSCENDENT_MIXER_RECIPES)
            ...
            .recipeModifiers((machine, r) -> recipe -> {
                ...
                return recipe;
            }, GTORecipeModifiers.HATCH_PARALLEL, GTORecipeModifiers.PERFECT_OVERCLOCKING)
            ...
            .pattern(definition -> FactoryBlockPattern.start(RelativeDirection.FRONT, RelativeDirection.UP, RelativeDirection.RIGHT)
                    ...
                    .where('C', blocks(GTOBlocks.NEUTRONIUM_ACTIVE_CASING.get()))
                    ...
                    .where('J', blocks(GTOBlocks.NEUTRONIUM_GEARBOX.get()))
                    ...
                    .where('N', blocks(GTOBlocks.NEUTRONIUM_CASING.get()))
    ...
    public final static MultiblockMachineDefinition QUANTUM_FORCE_TRANSFORMER = multiblock("quantum_force_transformer", "量子操纵者", ElectricMultiblockMachine::new)
            .nonYAxisRotation()
            .recipe(GTORecipeTypes.QUANTUM_FORCE_TRANSFORMER_RECIPES)
            .parallelizableTooltips()
            .customTooltipsBuilder(false, true, false)
            .parallelizableOverclock()
            ...
            .pattern(definition -> FactoryBlockPattern.start(RelativeDirection.BACK, RelativeDirection.UP, RelativeDirection.LEFT)
                    ...
                    .where('L', blocks(GTOBlocks.NEUTRONIUM_ACTIVE_CASING.get()))
    ...
    public final static MultiblockMachineDefinition LARGE_CHEMICAL_PLANT = multiblock("large_chemical_plant", "大型化工厂", CoilCrossRecipeMultiblockMachine::createCoilParallel)
            .allRotation()
            .recipe(GTORecipeTypes.CHEMICAL)
            ...
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .where('a', blocks(GTBlocks.CASING_PTFE_INERT.get())
                            .setMinGlobalLimited(60)
                            .or(blocks(GTOMachines.CATALYST_HATCH.getBlock()).setMaxGlobalLimited(2))
    ...
    public final static MultiblockMachineDefinition INTEGRATED_ORE_PROCESSOR = multiblock("integrated_ore_processor", "集成矿石处理厂", ElectricMultiblockMachine::new)
            .nonYAxisRotation()
    ...
    public final static MultiblockMachineDefinition DRAGON_EGG_COPIER = multiblock("dragon_egg_copier", "龙蛋复制机", ElectricMultiblockMachine::new)
            .allRotation()
            .recipe(GTORecipeTypes.DRAGON_EGG_COPIER_RECIPES)
            .parallelizableTooltips()
            .customTooltipsBuilder(true, false, false)
            .parallelizablePerfectOverclock()
    ...
    public final static MultiblockMachineDefinition LARGE_CRACKER = multiblock("large_cracker", "大型裂化机", CoilMultiblockMachine.createCoilMachine(false, false))
            .allRotation()
            .recipe(GTRecipeTypes.CRACKING_RECIPES)
            .parallelizableTooltips()
            .recipeModifiers(GTORecipeModifiers.HATCH_PARALLEL, GTORecipeModifiers::crackerOverclock)
            .block(GTBlocks.CASING_STAINLESS_CLEAN)
            .pattern((definition) -> FactoryBlockPattern.start()
    ...
    public final static MultiblockMachineDefinition LARGE_GREENHOUSE = multiblock("large_greenhouse", "大型温室", ElectricMultiblockMachine::new)
            .nonYAxisRotation()
    ...
    public final static MultiblockMachineDefinition STEAM_PISTON_HAMMER = multiblock("steam_piston_hammer", "蒸汽活塞锤", (holder) -> new LargeSteamParallelMultiblockMachine(holder, 8))
            .allRotation()
    ...
    public final static MultiblockMachineDefinition STEAM_PRESSOR = multiblock("steam_pressor", "蒸汽挤压机", (holder) -> new LargeSteamParallelMultiblockMachine(holder, 8))
            .allRotation()
    ...
    public final static MultiblockMachineDefinition STEAM_FOUNDRY = multiblock("steam_foundry", "蒸汽铸造炉", (holder) -> new LargeSteamParallelMultiblockMachine(holder, 8))
            .allRotation()
    ...
    public final static MultiblockMachineDefinition LARGE_STEAM_MACERATOR = multiblock("large_steam_macerator", "大型蒸汽研磨机", (holder) -> new LargeSteamParallelMultiblockMachine(holder, 32))
            .allRotation()
    ...
    public final static MultiblockMachineDefinition LARGE_STEAM_CIRCUIT_ASSEMBLER = multiblock("large_steam_circuit_assembler", "大型蒸汽电路组装机", largeSteamCircuitAssemblerMachine::new)
            .allRotation()
    ...
    public final static MultiblockMachineDefinition LARGE_STEAM_MIXER = multiblock("large_steam_mixer", "大型蒸汽搅拌机", (holder) -> new LargeSteamParallelMultiblockMachine(holder, 32))
            .allRotation()
            .recipe(GTRecipeTypes.MIXER_RECIPES)
            .steamOverclock()
            .block(GTBlocks.CASING_BRONZE_BRICKS)
    ...
    public final static MultiblockMachineDefinition STEAM_MIXER = multiblock("steam_mixer", "蒸汽搅拌机", (holder) -> new LargeSteamParallelMultiblockMachine(holder, 8))
            .allRotation()
            .recipe(GTRecipeTypes.MIXER_RECIPES)
    ...
    public final static MultiblockMachineDefinition STEAM_SEPARATOR = multiblock("steam_separator", "蒸汽分离机", (holder) -> new LargeSteamParallelMultiblockMachine(holder, 8))
            .allRotation()
    ...
    public final static MultiblockMachineDefinition LARGE_STEAM_CENTRIFUGE = multiblock("large_steam_centrifuge", "大型蒸汽离心机", (holder) -> new LargeSteamParallelMultiblockMachine(holder, 32))
            .allRotation()
            .recipe(GTRecipeTypes.CENTRIFUGE_RECIPES)
            .steamOverclock()
            .block(GTBlocks.CASING_BRONZE_BRICKS)
    ...
    public final static MultiblockMachineDefinition LARGE_STEAM_THERMAL_CENTRIFUGE = multiblock("large_steam_thermal_centrifuge", "大型蒸汽热力离心机", (holder) -> new LargeSteamParallelMultiblockMachine(holder, 32))
            .allRotation()
    ...
    public final static MultiblockMachineDefinition LARGE_STEAM_BATH = multiblock("large_steam_bath", "大型蒸汽浸洗机", (holder) -> new LargeSteamParallelMultiblockMachine(holder, 32))
            .allRotation()
    ...
    public final static MultiblockMachineDefinition STEAM_BATH = multiblock("steam_bath", "蒸汽浸洗机", (holder) -> new LargeSteamParallelMultiblockMachine(holder, 8))
            .allRotation()
            .recipe(GTRecipeTypes.CHEMICAL_BATH_RECIPES)
            .steamOverclock()
            .block(GTBlocks.CASING_BRONZE_BRICKS)
    ...
    public final static MultiblockMachineDefinition LARGE_STEAM_ORE_WASHER = multiblock("large_steam_ore_washer", "大型蒸汽洗矿机", (holder) -> new LargeSteamParallelMultiblockMachine(holder, 32))
            .allRotation()
    ...
    public final static MultiblockMachineDefinition STEAM_ORE_WASHER = multiblock("steam_ore_washer", "蒸汽洗矿机", (holder) -> new LargeSteamParallelMultiblockMachine(holder, 8))
            .allRotation()
            .recipe(GTRecipeTypes.ORE_WASHER_RECIPES)
            .steamOverclock()
            .block(GTBlocks.CASING_BRONZE_BRICKS)
    ...
    public static final MultiblockMachineDefinition LARGE_STEAM_FURNACE = multiblock("large_steam_furnace", "大型蒸汽熔炉", (holder) -> new LargeSteamParallelMultiblockMachine(holder, 32))
            .allRotation()
    ...
    public final static MultiblockMachineDefinition PETROCHEMICAL_PLANT = multiblock("petrochemical_plant", "石化工厂", CoilCrossRecipeMultiblockMachine::createCoilParallel)
            .nonYAxisRotation()
            .recipe(GTORecipeTypes.PETROCHEMICAL_PLANT_RECIPES)
            .coilParallelTooltips()
            .customTooltipsBuilder(true, true, true)
            .block(GTBlocks.HIGH_POWER_CASING)
            .pattern((definition) -> FactoryBlockPattern.start(RelativeDirection.RIGHT, RelativeDirection.UP, RelativeDirection.BACK)
    ...
    public final static MultiblockMachineDefinition LARGE_PYROLYSE_OVEN = multiblock("large_pyrolyse_oven", "大型热解炉", CoilMultiblockMachine.createCoilMachine(false, false))
            .allRotation()
            .recipe(GTRecipeTypes.PYROLYSE_RECIPES)
            .parallelizableTooltips()
            .recipeModifiers(GTORecipeModifiers.HATCH_PARALLEL, GTORecipeModifiers::pyrolyseOvenOverclock)
            .block(GTBlocks.CASING_STAINLESS_CLEAN)
            .pattern(definition -> FactoryBlockPattern.start()
    ...
    public final static MultiblockMachineDefinition LARGE_ROCK_CRUSHER = multiblock("large_rock_crusher", "大型碎岩机", ElectricMultiblockMachine::new)
            .allRotation()
    ...
    public final static MultiblockMachineDefinition MEGA_WIREMILL = multiblock("mega_wiremill", "特大线材轧机", CoilCrossRecipeMultiblockMachine::createCoilParallel)
            .allRotation()
            ...
            .pattern((definition) -> FactoryBlockPattern.start(RelativeDirection.RIGHT, RelativeDirection.UP, RelativeDirection.BACK)
                    ...
                    .where('H', blocks(GTOBlocks.NEUTRONIUM_GEARBOX.get()))
    ...
    public final static MultiblockMachineDefinition SUPERCONDUCTING_MAGNETIC_PRESSER = multiblock("superconducting_magnetic_presser", "超导磁驱冲击装置", CrossRecipeMultiblockMachine::createHatchParallel)
            .allRotation()
            ...
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .where('I', blocks(GTBlocks.SUPERCONDUCTING_COIL.get()))
                    .where('J', blocks(GTOBlocks.NEUTRONIUM_BOROSILICATE_GLASS.get()))
                    ...
                    .where('S', blocks(GTOBlocks.NEUTRONIUM_ACTIVE_CASING.get()))
                    .where(' ', any())
                    .build())
            .workableCasingRenderer(GTOCore.id("block/casings/iridium_casing"), GTCEu.id("block/multiblock/fusion_reactor"))
            .register();

    public final static MultiblockMachineDefinition FIELD_FORGE_PRESS = multiblock("field_forge_press", "力场锻压机", CrossRecipeMultiblockMachine::createHatchParallel)
            .allRotation()
            .recipe(GTRecipeTypes.FORGE_HAMMER_RECIPES)
            .parallelizableTooltips()
            .customTooltipsBuilder(true, true, true)
    ...
    public final static MultiblockMachineDefinition HEAVY_ROLLING = multiblock("heavy_rolling", "重型辊压机", CoilCrossRecipeMultiblockMachine::createCoilParallel)
            .allRotation()
            ...
            .pattern((definition) -> FactoryBlockPattern.start(RelativeDirection.BACK, RelativeDirection.UP, RelativeDirection.LEFT)
                    ...
                    .where('C', blocks(GTOBlocks.HYPER_MECHANICAL_CASING.get()))
                    .where('D', blocks(GTOBlocks.NEUTRONIUM_GEARBOX.get()))
                    .where('E', blocks(GTOBlocks.NEUTRONIUM_PIPE_CASING.get()))
    ...
    public final static MultiblockMachineDefinition PHASE_CHANGE_CUBE = multiblock("phase_change_cube", "相变魔方", CoilCrossRecipeMultiblockMachine::createCoilParallel)
            .allRotation()
            ...
            .pattern((definition) -> FactoryBlockPattern.start(RelativeDirection.BACK, RelativeDirection.UP, RelativeDirection.LEFT)
                    ...
                    .where('G', blocks(GTBlocks.HIGH_POWER_CASING.get())
                            .or(GTOPredicates.autoThreadLaserAbilities(definition.getRecipeTypes()))
                            .or(abilities(MAINTENANCE).setExactLimit(1)))
                    .where('H', blocks(GTOBlocks.NEUTRONIUM_ACTIVE_CASING.get()))
    ...
    public final static MultiblockMachineDefinition MEGA_CANNER = multiblock("mega_canner", "特大装罐机", CrossRecipeMultiblockMachine::createHatchParallel)
            .allRotation()
    ...
    public final static MultiblockMachineDefinition DISASSEMBLY = multiblock("disassembly", "拆解机", ElectricMultiblockMachine::new)
            .allRotation()
            .recipe(GTORecipeTypes.DISASSEMBLY_RECIPES)
    ...
    public final static MultiblockMachineDefinition ATOMIC_ENERGY_EXCITATION_PLANT = multiblock("atomic_energy_excitation_plant", "原子能激发工厂", CoilMultiblockMachine.createCoilMachine(false, true))
            .allRotation()
            .recipe(GTORecipeTypes.ATOMIC_ENERGY_EXCITATION_RECIPES)
            .parallelizableTooltips()
            .customTooltipsBuilder(false, true, false)
            .parallelizableOverclock()
    ...
    public final static MultiblockMachineDefinition FLOTATION_CELL_REGULATOR = multiblock("flotation_cell_regulator", "工业浮选机", ElectricMultiblockMachine::new)
            .allRotation()
            .recipe(GTORecipeTypes.FLOTATING_BENEFICIATION_RECIPES)
    ...
    public final static MultiblockMachineDefinition VACUUM_DRYING_FURNACE = multiblock("vacuum_drying_furnace", "真空干燥炉", CoilCustomParallelMultiblockMachine.createParallelCoil(m -> {
    ...
    public final static MultiblockMachineDefinition MOLTEN_CORE = multiblock("molten_core", "熔火之心", CoilCrossRecipeMultiblockMachine::createCoilParallel)
            .nonYAxisRotation()
    ...
    public final static MultiblockMachineDefinition ELECTRIC_IMPLOSION_COMPRESSOR = multiblock("electric_implosion_compressor", "电力聚爆压缩机", ElectricMultiblockMachine::new)
            .nonYAxisRotation()
            .eutMultiplierTooltips(0.8)
            .durationMultiplierTooltips(0.6)
            .parallelizableTooltips()
    ...
    public final static MultiblockMachineDefinition STELLAR_FORGE = multiblock("stellar_forge", "恒星炎炀锻炉", TierCasingMultiblockMachine.createMachine(STELLAR_CONTAINMENT_TIER))
            .nonYAxisRotation()
    ...
    public final static MultiblockMachineDefinition COMPONENT_ASSEMBLY_LINE = multiblock("component_assembly_line", "部件装配线", TierCasingMultiblockMachine.createMachine(COMPONENT_ASSEMBLY_CASING_TIER))
            .allRotation()
    ...
    public final static MultiblockMachineDefinition ADVANCED_INTEGRATED_ORE_PROCESSOR = multiblock("advanced_integrated_ore_processor", "进阶集成矿石处理厂", CrossRecipeMultiblockMachine.createParallel(true, false, m -> Integer.MAX_VALUE))
            .nonYAxisRotation()
            .recipe(GTORecipeTypes.INTEGRATED_ORE_PROCESSOR)
            ...
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .where('I', blocks(GTOBlocks.NEUTRONIUM_ACTIVE_CASING.get()))
                    .where('J', frames(GTOMaterials.Mithril))
                    .where('K', blocks(GTOBlocks.NEUTRONIUM_GEARBOX.get()))
                    .where('L', blocks(GTOBlocks.IRIDIUM_CASING.get()))
                    .where('M', blocks(GCYMBlocks.CASING_WATERTIGHT.get()))
                    .where('N', blocks(GTOBlocks.HOLLOW_CASING.get()))
                    .where('O', blocks(GTOBlocks.NEUTRONIUM_BOROSILICATE_GLASS.get()))
    ...
    public final static MultiblockMachineDefinition MAGE_ASSEMBLER = multiblock("mage_assembler", "综合组装车间", CrossRecipeMultiblockMachine::createHatchParallel)
            .nonYAxisRotation()
            .recipe(GTRecipeTypes.ASSEMBLER_RECIPES)
            .parallelizableTooltips()
            .customTooltipsBuilder(true, true, true)
            ...
            .pattern((definition) -> FactoryBlockPattern.start(RelativeDirection.FRONT, RelativeDirection.UP, RelativeDirection.RIGHT)
                    ...
                    .where('F', blocks(GTOBlocks.NEUTRONIUM_GEARBOX.get()))
                    ...
                    .where('S', blocks(GTOBlocks.NEUTRONIUM_PIPE_CASING.get()))
