...
public class MultiBlockMachineA {
    ...
    public final static MultiblockMachineDefinition PLASMA_CONDENSER = REGISTRATE.multiblock("plasma_condenser", WorkableElectricMultiblockMachine::new)
            ...
            .recipeType(GTORecipeTypes.PLASMA_CONDENSER_RECIPES)
            ...
            .appearanceBlock(GTOBlocks.ANTIFREEZE_HEATPROOF_MACHINE_CASING)
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .aisle("       ", "  aaa  ", " aaaaa ", " aabaa ", " aaaaa ", "  aaa  ", "       ")
                    .aisle("       ", "       ", "  aaa  ", "  ada  ", "  aaa  ", "       ", "       ")
                    .where("a", Predicates.blocks(GTOBlocks.ANTIFREEZE_HEATPROOF_MACHINE_CASING.get())
                            .setMinGlobalLimited(120)
                            .or(Predicates.autoAbilities(definition.getRecipeTypes()))
                            .or(Predicates.abilities(PartAbility.MAINTENANCE).setExactLimit(1)))
                    .where("b", Predicates.blocks(GTOBlocks.NEUTRONIUM_PIPE_CASING.get()))
                    .where("c", Predicates.blocks(GTOBlocks.LASER_COOLING_CASING.get()))
    ...
    public final static MultiblockMachineDefinition RARE_EARTH_CENTRIFUGAL = REGISTRATE.multiblock("rare_earth_centrifugal", WorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.ALL)
            .recipeType(GTORecipeTypes.RARE_EARTH_CENTRIFUGAL_RECIPES)
            ...
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .where("d", Predicates.blocks(GTOBlocks.NEUTRONIUM_PIPE_CASING.get()))
                    .where(" ", Predicates.any())
                    .build())
    ...
    public final static MultiblockMachineDefinition ADVANCED_RARE_EARTH_CENTRIFUGAL = REGISTRATE.multiblock("advanced_rare_earth_centrifugal", WorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.ALL)
            .recipeType(GTORecipeTypes.RARE_EARTH_CENTRIFUGAL_RECIPES)
            .tooltips(Component.translatable("gtocore.machine.laser.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.perfect_oc"))
            .tooltips(Component.translatable("gtceu.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gtceu.rare_earth_centrifugal")))
            ...
            .appearanceBlock(GTOBlocks.SPS_CASING)
            .pattern((definition) -> FactoryBlockPattern.start(RelativeDirection.FRONT, RelativeDirection.UP, RelativeDirection.RIGHT)
                    ...
                    .where("A", Predicates.blocks(GTOBlocks.SPS_CASING.get()))
                    .where("B", Predicates.blocks(GTOBlocks.DEGENERATE_RHENIUM_CONSTRAINED_CASING.get()))
                    .where("C", Predicates.blocks(GTOBlocks.ADVANCED_FUSION_COIL.get()))
                    .where("D", Predicates.blocks(GTOBlocks.HYPER_MECHANICAL_CASING.get()))
                    .where("E", Predicates.blocks(GTBlocks.CASING_HSSE_STURDY.get()))
                    .where("F", Predicates.blocks(GTOBlocks.HYPER_CORE.get()))
                    .where("G", Predicates.blocks(GTOBlocks.NEUTRONIUM_GEARBOX.get()))
                    .where("H", Predicates.blocks(GTOBlocks.NEUTRONIUM_PIPE_CASING.get()))
                    .where("I", Predicates.blocks(ChemicalHelper.getBlock(TagPrefix.frameGt, GTMaterials.HastelloyX)))
                    .where("b", Predicates.blocks(GTOBlocks.SPS_CASING.get())
    ...
    public final static MultiblockMachineDefinition SLAUGHTERHOUSE = REGISTRATE.multiblock("magic_manufacturer", WorkableElectricMultiblockMachine::new)
            ...
            .recipeType(GTORecipeTypes.MAGIC_MANUFACTURER_RECIPES)
            .tooltips(Component.translatable("gtceu.machine.perfect_oc"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
            ...
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .where("e", Predicates.blocks(GTOBlocks.HYPER_CORE.get()))
                    ...
                    .where("i", Predicates.blocks(GTOBlocks.MAGIC_CORE.get()))
                    .where(" ", Predicates.any())
                    .build())
    ...
    public final static MultiblockMachineDefinition SPS_CRAFTING = REGISTRATE.multiblock("sps_crafting", WorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.ALL)
            .recipeType(GTORecipeTypes.SPS_CRAFTING_RECIPES)
            .tooltips(Component.translatable("gtceu.machine.perfect_oc"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
            ...
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .where("g", Predicates.blocks(GTOBlocks.MAGIC_CORE.get()))
    ...
    public final static MultiblockMachineDefinition ADVANCED_SPS_CRAFTING = REGISTRATE.multiblock("advanced_sps_crafting", WorkableElectricMultiblockMachine::new)
            ...
            .pattern((definition) -> FactoryBlockPattern.start(RelativeDirection.FRONT, RelativeDirection.UP, RelativeDirection.RIGHT)
                    ...
                    .where("A", Predicates.blocks(GTOBlocks.SPS_CASING.get())
                            ...
                            .or(Predicates.abilities(PartAbility.PARALLEL_HATCH).setMaxGlobalLimited(1))
                            .or(Predicates.abilities(PartAbility.MAINTENANCE).setExactLimit(1)))
                    .where("B", Predicates.blocks(GTOBlocks.FUSION_CASING_MK4.get()))
                    .where("C", Predicates.blocks(GTOBlocks.HYPER_MECHANICAL_CASING.get()))
                    .where("D", Predicates.blocks(GTOBlocks.IRIDIUM_CASING.get()))
                    .where("E", Predicates.blocks(GTOBlocks.NEUTRONIUM_ACTIVE_CASING.get()))
                    .where("F", Predicates.blocks(Blocks.CRYING_OBSIDIAN))
                    .where("G", Predicates.blocks(GTOBlocks.ACCELERATED_PIPELINE.get()))
                    ...
                    .where("J", Predicates.blocks(GTOBlocks.MAGIC_CORE.get()))
                    .where("K", Predicates.blocks(GTOBlocks.NEUTRONIUM_CASING.get()))
                    .where("L", Predicates.blocks(GTOBlocks.FUSION_COIL_MK2.get()))
                    .where("M", Predicates.blocks(GTOBlocks.NEUTRONIUM_PIPE_CASING.get()))
                    .where("N", Predicates.blocks(GTOBlocks.HIGH_PRESSURE_RESISTANT_CASING.get()))
                    .where(" ", Predicates.any())
                    .build())
            .workableCasingRenderer(GTCEu.id("block/casings/fusion/fusion_casing_mk2"), GTCEu.id("block/multiblock/assembly_line"))
            .register();
    ...
    public final static MultiblockMachineDefinition MATTER_FABRICATOR = REGISTRATE.multiblock("matter_fabricator", WorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.ALL)
            .recipeType(GTORecipeTypes.MATTER_FABRICATOR_RECIPES)
            .tooltips(Component.translatable("gtocore.machine.laser.tooltip"))
            .tooltips(Component.translatable("gtceu.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
    ...
    public final static MultiblockMachineDefinition VOID_FLUID_DRILLING_RIG = REGISTRATE.multiblock("void_fluid_drilling_rig", WorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.NON_Y_AXIS)
            .allowExtendedFacing(false)
            .recipeType(GTORecipeTypes.VOID_FLUID_DRILLING_RIG_RECIPES)
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
    ...
    public final static MultiblockMachineDefinition VOID_MINER = REGISTRATE.multiblock("void_miner", WorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.NON_Y_AXIS)
            .allowExtendedFacing(false)
            .recipeType(GTORecipeTypes.VOID_MINER_RECIPES)
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
    ...
    public final static MultiblockMachineDefinition LARGE_VOID_MINER = REGISTRATE.multiblock("large_void_miner", WorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.NON_Y_AXIS)
            .allowExtendedFacing(false)
            .recipeType(GTORecipeTypes.LARGE_VOID_MINER_RECIPES)
            .recipeType(GTORecipeTypes.RANDOM_ORE_RECIPES)
            .tooltips(Component.translatable("gtocore.machine.large_void_miner.tooltip.0"))
            .tooltips(Component.translatable("gtocore.machine.large_void_miner.tooltip.1"))
    ...
    public final static MultiblockMachineDefinition CHEMICAL_PLANT = REGISTRATE.multiblock("chemical_plant", CoilWorkableElectricMultiblockMachine::new)
            ...
            .tooltips(Component.translatable("gtocore.machine.chemical_plant.tooltip.0"))
            .tooltips(Component.translatable("gtceu.machine.perfect_oc"))
            .tooltips(Component.translatable("gtceu.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
            ...
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .where(" ", Predicates.any())
                    .build())
            .additionalDisplay(GTOMachines.CHEMICAL_PLANT_DISPLAY)
    ...
    public final static MultiblockMachineDefinition DECAY_HASTENER = REGISTRATE.multiblock("decay_hastener", WorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.ALL)
            .recipeType(GTORecipeTypes.DECAY_HASTENER_RECIPES)
            .tooltips(Component.translatable("gtceu.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
            ...
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .aisle("bbbbb", "bbbbb", "bbabb", "bbbbb", "bbbbb")
                    .where("a", Predicates.controller(Predicates.blocks(definition.get())))
                    .where("b", Predicates.blocks(GTOBlocks.HYPER_MECHANICAL_CASING.get())
                            .setMinGlobalLimited(80)
                            .or(Predicates.abilities(PartAbility.PARALLEL_HATCH).setMaxGlobalLimited(1))
                            .or(Predicates.autoAbilities(definition.getRecipeTypes()))
                            .or(Predicates.abilities(PartAbility.MAINTENANCE).setExactLimit(1)))
    ...
    public final static MultiblockMachineDefinition LARGE_RECYCLER = REGISTRATE.multiblock("large_recycler", WorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.ALL)
            .recipeType(GTORecipeTypes.LARGE_RECYCLER_RECIPES)
            .tooltips(Component.translatable("gtocore.machine.large_recycler.tooltip.0"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
    ...
    public final static MultiblockMachineDefinition MASS_FABRICATOR = REGISTRATE.multiblock("mass_fabricator", WorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.ALL)
            .recipeType(GTORecipeTypes.MASS_FABRICATOR_RECIPES)
            .tooltips(Component.translatable("gtceu.machine.perfect_oc"))
            .tooltips(Component.translatable("gtceu.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
            ...
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .where("d", Predicates.blocks(GTOBlocks.HYPER_CORE.get()))
    ...
    public final static MultiblockMachineDefinition A_MASS_FABRICATOR = REGISTRATE.multiblock("a_mass_fabricator", WorkableElectricMultiblockMachine::new)
            ...
            .recipeType(GTORecipeTypes.MASS_FABRICATOR_RECIPES)
            .tooltips(Component.translatable("gtocore.machine.eut_multiplier.tooltip", 0.8))
            .tooltips(Component.translatable("gtocore.machine.duration_multiplier.tooltip", 0.5))
            .tooltips(Component.translatable("gtocore.machine.laser.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.perfect_oc"))
            .tooltips(Component.translatable("gtceu.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gtceu.mass_fabricator")))
            .recipeModifiers((machine, recipe, params, result) -> GTORecipeModifiers.reduction(machine, recipe, 0.8, 0.5), GTRecipeModifiers.PARALLEL_HATCH, GTRecipeModifiers.ELECTRIC_OVERCLOCK.apply(OverclockingLogic.PERFECT_OVERCLOCK_SUBTICK))
            ...
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .where("I", Predicates.blocks(GTBlocks.MACHINE_CASING_UXV.get())
                            ...
                            .or(Predicates.abilities(PartAbility.PARALLEL_HATCH).setMaxGlobalLimited(1))
                            .or(Predicates.abilities(PartAbility.MAINTENANCE).setExactLimit(1)))
                    .where("B", Predicates.blocks(GTOBlocks.RHENIUM_REINFORCED_ENERGY_GLASS.get()))
                    .where("C", Predicates.blocks(GTOBlocks.COIL_TITANSTEEL.get()))
                    .where("D", Predicates.blocks(ChemicalHelper.getBlock(TagPrefix.frameGt, GTMaterials.Neutronium)))
                    .where("E", Predicates.blocks(GTOBlocks.HOLLOW_CASING.get()))
                    .where("F", Predicates.blocks(GTOBlocks.HYPER_CORE.get()))
                    .build())
    ...
    public final static MultiblockMachineDefinition PRECISION_ASSEMBLER = REGISTRATE.multiblock("precision_assembler", WorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.ALL)
            .recipeType(GTORecipeTypes.PRECISION_ASSEMBLER_RECIPES)
            ...
            .recipeModifiers(GTRecipeModifiers.PARALLEL_HATCH, GTRecipeModifiers.ELECTRIC_OVERCLOCK.apply(OverclockingLogic.PERFECT_OVERCLOCK_SUBTICK))
            .appearanceBlock(GTOBlocks.OXIDATION_RESISTANT_HASTELLOY_N_MECHANICAL_CASING)
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .where("a", Predicates.controller(Predicates.blocks(definition.get())))
                    .where("b", Predicates.blocks(GTOBlocks.OXIDATION_RESISTANT_HASTELLOY_N_MECHANICAL_CASING.get())
                            .setMinGlobalLimited(90)
                            .or(Predicates.autoAbilities(definition.getRecipeTypes()))
                            .or(Predicates.abilities(PartAbility.PARALLEL_HATCH).setMaxGlobalLimited(1))
                            .or(Predicates.abilities(PartAbility.MAINTENANCE).setExactLimit(1)))
                    .where("c", Predicates.blocks(GTBlocks.CASING_LAMINATED_GLASS.get()))
                    .where("d", Predicates.blocks(ChemicalHelper.getBlock(TagPrefix.frameGt, GTOMaterials.HastelloyN)))
                    .where("-", Predicates.air())
                    .where(" ", Predicates.any())
                    .build())
    ...
    public final static MultiblockMachineDefinition FISHING_GROUND = REGISTRATE.multiblock("fishing_ground", WorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.NON_Y_AXIS)
            .allowExtendedFacing(false)
            .recipeType(GTORecipeTypes.FISHING_GROUND_RECIPES)
            .tooltips(Component.translatable("gtceu.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gtceu.fishing_ground")))
            .recipeModifiers(GTRecipeModifiers.PARALLEL_HATCH, GTRecipeModifiers.ELECTRIC_OVERCLOCK.apply(OverclockingLogic.NON_PERFECT_OVERCLOCK_SUBTICK))
            .appearanceBlock(GTOBlocks.ALUMINIUM_BRONZE_CASING)
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .where("a", Predicates.controller(Predicates.blocks(definition.get())))
                    .where("b", Predicates.blocks(GTOBlocks.ALUMINIUM_BRONZE_CASING.get())
                            .setMinGlobalLimited(60)
                            .or(Predicates.autoAbilities(definition.getRecipeTypes()))
                            .or(Predicates.abilities(PartAbility.PARALLEL_HATCH).setMaxGlobalLimited(1))
                            .or(Predicates.abilities(PartAbility.MAINTENANCE).setExactLimit(1)))
    ...
    public final static MultiblockMachineDefinition LAVA_FURNACE = REGISTRATE.multiblock("lava_furnace", WorkableElectricMultiblockMachine::new)
            ...
            .recipeType(GTORecipeTypes.LAVA_FURNACE_RECIPES)
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
    ...
    public final static MultiblockMachineDefinition LARGE_GAS_COLLECTOR = REGISTRATE.multiblock("large_gas_collector", WorkableElectricMultiblockMachine::new)
            ...
            .allowExtendedFacing(false)
            .allowFlip(false)
            .recipeType(GTORecipeTypes.LARGE_GAS_COLLECTOR_RECIPES)
            .tooltips(Component.translatable("gtocore.machine.large_gas_collector.tooltip.0"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
    ...
    public final static MultiblockMachineDefinition AGGREGATION_DEVICE = REGISTRATE.multiblock("aggregation_device", WorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.ALL)
            .recipeType(GTORecipeTypes.AGGREGATION_DEVICE_RECIPES)
            .tooltips(Component.translatable("gtocore.machine.aggregation_device.tooltip.0"))
            .tooltips(Component.translatable("gtceu.machine.perfect_oc"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
            ...
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .where("e", Predicates.blocks(GTOBlocks.AGGREGATIONE_CORE.get()))
    ...
    public final static MultiblockMachineDefinition ENGRAVING_LASER_PLANT = REGISTRATE.multiblock("engraving_laser_plant", WorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.ALL)
            .recipeType(GTORecipeTypes.PRECISION_LASER_ENGRAVER_RECIPES)
            .recipeType(GTRecipeTypes.LASER_ENGRAVER_RECIPES)
            .recipeType(GTORecipeTypes.LASER_WELDER_RECIPES)
            .tooltips(Component.translatable("gtocore.machine.engraving_laser_plant.tooltip.0"))
            .tooltips(Component.translatable("gtceu.machine.perfect_oc"))
            .tooltips(Component.translatable("gtceu.multiblock.parallelizable.tooltip"))
            ...
            .appearanceBlock(GTOBlocks.IRIDIUM_CASING)
            .pattern(definition -> FactoryBlockPattern.start(RelativeDirection.RIGHT, RelativeDirection.UP, RelativeDirection.BACK)
                    ...
                    .where("~", Predicates.controller(Predicates.blocks(definition.get())))
                    .where("A", Predicates.blocks(GTOBlocks.IRIDIUM_CASING.get()))
                    .where("B", Predicates.blocks(GTBlocks.HIGH_POWER_CASING.get()))
                    .where("C", Predicates.blocks(ChemicalHelper.getBlock(TagPrefix.frameGt, GTMaterials.Neutronium)))
                    .where("D", Predicates.blocks(GTOBlocks.NEUTRONIUM_GEARBOX.get()))
                    .where("E", Predicates.blocks(GTOBlocks.COMPONENT_ASSEMBLY_LINE_CASING_UV.get()))
                    .where("F", Predicates.blocks(GTBlocks.FUSION_GLASS.get()))
                    ...
                    .where("K", Predicates.blocks(GTOBlocks.ADVANCED_COMPRESSED_FUSION_COIL.get()))
                    .where("L", Predicates.blocks(GCyMBlocks.ELECTROLYTIC_CELL.get()))
                    .where("M", Predicates.blocks(GTOBlocks.MOLECULAR_CASING.get()))
                    .where("a", Predicates.blocks(GTOBlocks.IRIDIUM_CASING.get())
                            .or(Predicates.abilities(PartAbility.PARALLEL_HATCH).setMaxGlobalLimited(1))
    ...
    public final static MultiblockMachineDefinition MEGA_ALLOY_BLAST_SMELTER = REGISTRATE.multiblock("mega_alloy_blast_smelter", AlloyBlastSmelterMachine::new)
            .rotationState(RotationState.NON_Y_AXIS)
            .allowExtendedFacing(false)
            .recipeModifiers(GTORecipeModifiers.GCYM_REDUCTION, GTRecipeModifiers.PARALLEL_HATCH, AlloyBlastSmelterMachine::recipeModifier)
    ...
    public final static MultiblockMachineDefinition DIMENSIONALLY_TRANSCENDENT_MIXER = REGISTRATE.multiblock("dimensionally_transcendent_mixer", WorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.ALL)
            .recipeType(GTORecipeTypes.DIMENSIONALLY_TRANSCENDENT_MIXER_RECIPES)
            .recipeType(GTRecipeTypes.MIXER_RECIPES)
            .tooltips(Component.translatable("gtocore.machine.dimensionally_transcendent_mixer.tooltip.0"))
            .tooltips(Component.translatable("gtocore.machine.laser.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.perfect_oc"))
            .tooltips(Component.translatable("gtceu.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_2.tooltip",
            ...
            .appearanceBlock(GTOBlocks.MOLECULAR_CASING)
            .pattern(definition -> FactoryBlockPattern.start(RelativeDirection.FRONT, RelativeDirection.UP, RelativeDirection.RIGHT)
                    ...
                    .where("C", Predicates.blocks(GTOBlocks.NEUTRONIUM_ACTIVE_CASING.get()))
                    .where("D", Predicates.blocks(GTOBlocks.HIGH_PRESSURE_RESISTANT_CASING.get()))
                    .where("E", Predicates.blocks(GTOBlocks.DIMENSIONAL_BRIDGE_CASING.get()))
                    .where("F", Predicates.blocks(GTBlocks.FUSION_COIL.get()))
                    .where("G", Predicates.blocks(GTOBlocks.DEGENERATE_RHENIUM_CONSTRAINED_CASING.get()))
                    .where("H", Predicates.blocks(ChemicalHelper.getBlock(TagPrefix.block, GTMaterials.SamariumMagnetic)))
                    .where("I", Predicates.blocks(GTOBlocks.DIMENSIONALLY_TRANSCENDENT_CASING.get()))
                    .where("J", Predicates.blocks(GTOBlocks.NEUTRONIUM_GEARBOX.get()))
                    .where("K", Predicates.blocks(GTOBlocks.DIMENSION_INJECTION_CASING.get()))
                    .where("L", Predicates.blocks(ChemicalHelper.getBlock(TagPrefix.block, GTOMaterials.HeavyQuarkDegenerateMatter)))
                    .where("N", Predicates.blocks(GTOBlocks.NEUTRONIUM_CASING.get()))
                    .where("O", Predicates.blocks(GTOBlocks.NEUTRONIUM_PIPE_CASING.get()))
                    .where("a", Predicates.blocks(GTOBlocks.MOLECULAR_CASING.get())
                            .or(GTOPredicates.autoLaserAbilities(definition.getRecipeTypes()))
                            .or(Predicates.abilities(PartAbility.PARALLEL_HATCH).setMaxGlobalLimited(1))
                            .or(Predicates.abilities(PartAbility.MAINTENANCE).setExactLimit(1)))
                    .where(" ", Predicates.any())
                    .build())
            .workableCasingRenderer(GTOCore.id("block/molecular_casing"), GTCEu.id("block/multiblock/fusion_reactor"))
            .register();
    ...
    public final static MultiblockMachineDefinition QUANTUM_FORCE_TRANSFORMER = REGISTRATE.multiblock("quantum_force_transformer", WorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.NON_Y_AXIS)
            .allowExtendedFacing(false)
            .recipeType(GTORecipeTypes.QUANTUM_FORCE_TRANSFORMER_RECIPES)
            .tooltips(Component.translatable("gtocore.machine.laser.tooltip"))
            .tooltips(Component.translatable("gtceu.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gtceu.quantum_force_transformer")))
            .recipeModifiers(GTRecipeModifiers.PARALLEL_HATCH, GTRecipeModifiers.ELECTRIC_OVERCLOCK.apply(OverclockingLogic.NON_PERFECT_OVERCLOCK_SUBTICK))
            .appearanceBlock(GTOBlocks.MANIPULATOR)
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .aisle("    a     a    ", "    a     a    ", "    a     a    ", "    a     a    ", "   caccaccac   ", "   caccaccac   ", "   ccccacccc   ", "      cac      ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ")
                    .where("~", Predicates.controller(Predicates.blocks(definition.get())))
                    .where("b", Predicates.blocks(GTOBlocks.MANIPULATOR.get())
                            .or(GTOPredicates.autoLaserAbilities(definition.getRecipeTypes()))
                            .or(Predicates.abilities(PartAbility.PARALLEL_HATCH).setMaxGlobalLimited(1)))
                    .where("a", Predicates.blocks(GTOBlocks.SPACETIMECONTINUUMRIPPER.get()))
                    .where("c", Predicates.blocks(GTOBlocks.SPACETIMEBENDINGCORE.get()))
                    .where("d", Predicates.blocks(GTOBlocks.MANIPULATOR.get()))
                    .where("e", Predicates.blocks(GTOBlocks.FORCE_FIELD_GLASS.get()))
                    .where("f", Predicates.blocks(GTOBlocks.quantum_force_transformer_coil.get()))
                    .where(" ", Predicates.any())
                    .build())
    ...
    public final static MultiblockMachineDefinition INTEGRATED_ORE_PROCESSOR = REGISTRATE.multiblock("integrated_ore_processor", WorkableElectricMultiblockMachine::new)
            ...
            .tooltips(Component.translatable("gtocore.machine.integrated_ore_processor.tooltip.1"))
            .tooltips(Component.translatable("gtocore.machine.integrated_ore_processor.tooltip.2"))
            .tooltips(Component.translatable("gtocore.machine.integrated_ore_processor.tooltip.3"))
            .tooltips(Component.translatable("gtocore.machine.integrated_ore_processor.tooltip.4"))
            .tooltips(Component.translatable("gtocore.machine.integrated_ore_processor.tooltip.5"))
            .tooltips(Component.translatable("gtocore.machine.integrated_ore_processor.tooltip.6"))
            .tooltips(Component.translatable("gtocore.machine.integrated_ore_processor.tooltip.7"))
            .tooltips(Component.translatable("gtceu.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gtceu.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
    ...
    public final static MultiblockMachineDefinition DRAGON_EGG_COPIER = REGISTRATE.multiblock("dragon_egg_copier", WorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.ALL)
            .recipeType(GTORecipeTypes.DRAGON_EGG_COPIER_RECIPES)
            .tooltips(Component.translatable("gtceu.machine.perfect_oc"))
            .tooltips(Component.translatable("gtceu.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gtceu.dragon_egg_copier")))
            .recipeModifiers(GTRecipeModifiers.PARALLEL_HATCH, GTRecipeModifiers.ELECTRIC_OVERCLOCK.apply(OverclockingLogic.PERFECT_OVERCLOCK_SUBTICK))
            .appearanceBlock(GTOBlocks.DRAGON_STRENGTH_TRITANIUM_CASING)
            .pattern((definition) -> FactoryBlockPattern.start()
                    .aisle("bbb", "bbb", "bbb")
                    .aisle("bbb", "bcb", "bdb")
                    .aisle("bbb", "bab", "bbb")
                    .where("a", Predicates.controller(Predicates.blocks(definition.get())))
                    .where("b", Predicates.blocks(GTOBlocks.DRAGON_STRENGTH_TRITANIUM_CASING.get())
                            .setMinGlobalLimited(10)
                            .or(Predicates.autoAbilities(definition.getRecipeTypes()))
                            .or(Predicates.abilities(PartAbility.PARALLEL_HATCH).setMaxGlobalLimited(1))
                            .or(Predicates.abilities(PartAbility.MAINTENANCE).setExactLimit(1)))
                    .where("c", Predicates.blocks(GTOBlocks.MAGIC_CORE.get()))
    ...
    public final static MultiblockMachineDefinition LARGE_GREENHOUSE = REGISTRATE.multiblock("large_greenhouse", WorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.ALL)
            .recipeType(GTORecipeTypes.GREENHOUSE_RECIPES)
            .tooltips(Component.translatable("gtocore.machine.large_greenhouse.tooltip.0"))
            .tooltips(Component.translatable("gtceu.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
    ...
    public final static MultiblockMachineDefinition STEAM_PISTON_HAMMER = REGISTRATE.multiblock("steam_piston_hammer", (holder) -> new LargeSteamParallelMultiblockMachine(holder, 8))
            ...
            .recipeModifier(GTORecipeModifiers.STEAM_OC)
    ...
    public final static MultiblockMachineDefinition LARGE_STEAM_MACERATOR = REGISTRATE.multiblock("large_steam_macerator", (holder) -> new LargeSteamParallelMultiblockMachine(holder, 64))
            ...
            .recipeModifier(GTORecipeModifiers.LARGE_STEAM_OC)
            .appearanceBlock(GTBlocks.CASING_BRONZE_BRICKS)
            .addOutputLimit(ItemRecipeCapability.CAP, 1)
            .pattern(definition -> FactoryBlockPattern.start()
    ...
    public final static MultiblockMachineDefinition LARGE_STEAM_CIRCUIT_ASSEMBLER = REGISTRATE.multiblock("large_steam_circuit_assembler", largeSteamCircuitAssemblerMachine::new)
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .where("C", Predicates.blocks(GTOBlocks.STEAM_ASSEMBLY_BLOCK.get()))
                    .where("D", Predicates.blocks(GTBlocks.CASING_BRONZE_BRICKS.get())
                            .or(Predicates.abilities(PartAbility.STEAM_IMPORT_ITEMS).setMaxGlobalLimited(1).setPreviewCount(1))
                            .or(Predicates.abilities(PartAbility.STEAM_EXPORT_ITEMS).setMaxGlobalLimited(1).setPreviewCount(1))
                            .or(Predicates.abilities(PartAbility.IMPORT_FLUIDS).setMaxGlobalLimited(1).setPreviewCount(1))
    ...
    public final static MultiblockMachineDefinition DIMENSIONALLY_TRANSCENDENT_DIRT_FORGE = REGISTRATE.multiblock("dimensionally_transcendent_dirt_forge", WorkableNoEnergyMultiblockMachine::new)
            ...
            .pattern(definition -> GTOMachines.DTPF.where("a", Predicates.controller(Predicates.blocks(definition.get())))
    ...
    public final static MultiblockMachineDefinition PETROCHEMICAL_PLANT = REGISTRATE.multiblock("petrochemical_plant", CoilWorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.NON_Y_AXIS)
            .allowExtendedFacing(false)
            .recipeType(GTORecipeTypes.PETROCHEMICAL_PLANT_RECIPES)
            .tooltips(Component.translatable("gtceu.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
    ...
    public final static MultiblockMachineDefinition LARGE_ROCK_CRUSHER = REGISTRATE.multiblock("large_rock_crusher", WorkableElectricMultiblockMachine::new)
            ...
            .tooltips(Component.translatable("gtocore.machine.eut_multiplier.tooltip", 0.8))
            .tooltips(Component.translatable("gtocore.machine.duration_multiplier.tooltip", 0.6))
            .tooltips(Component.translatable("gtocore.machine.large_rock_crusher.tooltip.0"))
            .tooltips(Component.translatable("gtceu.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gtceu.rock_breaker")))
            .recipeModifiers(GTORecipeModifiers.GCYM_REDUCTION, GTRecipeModifiers.PARALLEL_HATCH, GTRecipeModifiers.ELECTRIC_OVERCLOCK.apply(OverclockingLogic.NON_PERFECT_OVERCLOCK_SUBTICK))
    ...
    public final static MultiblockMachineDefinition CHEMICAL_DISTORT = REGISTRATE.multiblock("chemical_distort", CoilWorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.ALL)
            .recipeType(GTORecipeTypes.DISTORT_RECIPES)
            .tooltips(Component.translatable("gtocore.machine.chemical_distort.tooltip.0"))
            .tooltips(Component.translatable("gtocore.machine.chemical_distort.tooltip.1"))
            .tooltips(Component.translatable("gtocore.machine.laser.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
            ...
            .additionalDisplay(GTOMachines.TEMPERATURE)
    ...
    public final static MultiblockMachineDefinition MEGA_WIREMILL = REGISTRATE.multiblock("mega_wiremill", CoilWorkableElectricMultipleRecipesMultiblockMachine::new)
            ...
            .tooltips(Component.translatable("gtocore.machine.laser.tooltip"))
            .tooltips(Component.translatable("gtocore.machine.multiple_recipes.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_2.tooltip",
            ...
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .aisle("  aaa  ", "  a~a  ", "  aaa  ", "       ", "       ", "       ", "       ")
                    .where("~", Predicates.controller(Predicates.blocks(definition.get())))
                    .where("A", Predicates.blocks(GTOBlocks.OXIDATION_RESISTANT_HASTELLOY_N_MECHANICAL_CASING.get()))
                    .where("a", Predicates.blocks(GTOBlocks.OXIDATION_RESISTANT_HASTELLOY_N_MECHANICAL_CASING.get())
                            .or(GTOPredicates.autoLaserAbilities(definition.getRecipeTypes()))
                            .or(Predicates.abilities(PartAbility.MAINTENANCE).setExactLimit(1)))
                    .where("B", Predicates.blocks(GTOBlocks.IRIDIUM_CASING.get()))
                    .where("C", Predicates.blocks(GTOBlocks.IRIDIUM_CASING.get()))
                    .where("D", Predicates.blocks(GTOBlocks.HYPER_MECHANICAL_CASING.get()))
                    .where("E", Predicates.blocks(GTOBlocks.HOLLOW_CASING.get()))
                    ...
                    .where(" ", Predicates.any())
                    .build())
            .additionalDisplay(GTOMachines.COIL_PARALLEL)
            .workableCasingRenderer(GTOCore.id("block/casings/oxidation_resistant_hastelloy_n_mechanical_casing"), GTCEu.id("block/multiblock/gcym/large_wiremill"))
            .register();
    ...
    public final static MultiblockMachineDefinition MEGA_PRESSER = REGISTRATE.multiblock("mega_presser", CoilWorkableElectricMultipleRecipesMultiblockMachine::new)
            ...
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .where("A", Predicates.blocks(GTOBlocks.MOLECULAR_CASING.get()))
                    .where("B", Predicates.blocks(GTOBlocks.IRIDIUM_CASING.get()))
                    .where("C", Predicates.blocks(GTOBlocks.MOLECULAR_CASING.get())
                            .or(GTOPredicates.autoLaserAbilities(definition.getRecipeTypes()))
                            .or(Predicates.abilities(PartAbility.MAINTENANCE).setExactLimit(1)))
    ...
    public final static MultiblockMachineDefinition FIELD_FORGE_PRESS = REGISTRATE.multiblock("field_forge_press", WorkableElectricParallelHatchMultipleRecipesMachine::new)
            ...
            .pattern((definition) -> FactoryBlockPattern.start(RelativeDirection.RIGHT, RelativeDirection.UP, RelativeDirection.BACK)
                    ...
                    .where("A", Predicates.blocks(GTOBlocks.MOLECULAR_CASING.get()))
                    .where("B", Predicates.blocks(GTOBlocks.IRIDIUM_CASING.get()))
                    .where("C", Predicates.blocks(ChemicalHelper.getBlock(TagPrefix.frameGt, GTOMaterials.Inconel792)))
                    .where("D", Predicates.blocks(GCyMBlocks.CASING_STRESS_PROOF.get()))
                    .where("E", Predicates.blocks(GTBlocks.MACHINE_CASING_UEV.get()))
                    .where("F", Predicates.blocks(GTOBlocks.HYPER_MECHANICAL_CASING.get()))
                    .where("G", Predicates.blocks(GTOBlocks.DIMENSIONAL_BRIDGE_CASING.get()))
                    .where("H", Predicates.blocks(GTOBlocks.PRESSURE_CONTAINMENT_CASING.get()))
                    .where("I", Predicates.blocks(GTOBlocks.HIGH_PRESSURE_RESISTANT_CASING.get()))
    ...
    public final static MultiblockMachineDefinition HEAVY_ROLLING = REGISTRATE.multiblock("heavy_rolling", CoilWorkableElectricMultipleRecipesMultiblockMachine::new)
            ...
            .recipeType(GTORecipeTypes.CLUSTER_RECIPES)
            .recipeType(GTORecipeTypes.ROLLING_RECIPES)
            .tooltips(Component.translatable("gtocore.machine.coil_parallel"))
            .tooltips(Component.translatable("gtocore.machine.laser.tooltip"))
            .tooltips(Component.translatable("gtocore.machine.multiple_recipes.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_3.tooltip",
            ...
            .pattern((definition) -> FactoryBlockPattern.start(RelativeDirection.BACK, RelativeDirection.UP, RelativeDirection.LEFT)
                    ...
                    .where("P", Predicates.blocks(GTOBlocks.ANTIFREEZE_HEATPROOF_MACHINE_CASING.get()))
    ...
    public final static MultiblockMachineDefinition MEGA_EXTRACTOR = REGISTRATE.multiblock("mega_extractor", CoilWorkableElectricMultipleRecipesMultiblockMachine::new)
            ...
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .where("C", Predicates.blocks(GTOBlocks.IRIDIUM_CASING.get()))
                    .where("D", Predicates.heatingCoils())
                    .where("E", Predicates.blocks(GTOBlocks.MOLECULAR_CASING.get()))
                    .where("F", Predicates.blocks(GTBlocks.CASING_TUNGSTENSTEEL_PIPE.get()))
                    .where(" ", Predicates.any())
                    .build())
            .additionalDisplay(GTOMachines.COIL_PARALLEL)
            .workableCasingRenderer(GTOCore.id("block/casings/hyper_mechanical_casing"), GTCEu.id("block/multiblock/gcym/large_extractor"))
            .register();
    ...
    public final static MultiblockMachineDefinition MEGA_CANNER = REGISTRATE.multiblock("mega_canner", WorkableElectricParallelHatchMultipleRecipesMachine::new)
            ...
            .appearanceBlock(GTOBlocks.LAFIUM_MECHANICAL_CASING)
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .where("A", Predicates.blocks(GTOBlocks.LAFIUM_MECHANICAL_CASING.get())
                            .or(GTOPredicates.autoLaserAbilities(definition.getRecipeTypes()))
                            .or(Predicates.abilities(PartAbility.MAINTENANCE).setExactLimit(1))
                            .or(Predicates.abilities(PartAbility.PARALLEL_HATCH).setMaxGlobalLimited(1)))
                    .where("B", Predicates.blocks(GCyMBlocks.CASING_STRESS_PROOF.get()))
                    .where("C", Predicates.blocks(GTBlocks.SUPERCONDUCTING_COIL.get()))
                    .where("D", Predicates.blocks(GTOBlocks.ENHANCE_HYPER_MECHANICAL_CASING.get()))
    ...
    public final static MultiblockMachineDefinition DISASSEMBLY = REGISTRATE.multiblock("disassembly", WorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.ALL)
            .recipeType(GTORecipeTypes.DISASSEMBLY_RECIPES)
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gtceu.disassembly")))
            .recipeModifier(GTRecipeModifiers.ELECTRIC_OVERCLOCK.apply(OverclockingLogic.NON_PERFECT_OVERCLOCK_SUBTICK))
            .appearanceBlock(GTOBlocks.PROCESS_MACHINE_CASING)
            .pattern((definition) -> FactoryBlockPattern.start()
                    .aisle("AAA", "AAA", "AAA")
                    .aisle("AAA", "ABA", "AAA")
                    .aisle("AAA", "A~A", "AAA")
                    .where("~", Predicates.controller(Predicates.blocks(definition.get())))
                    .where("A", Predicates.blocks(GTOBlocks.PROCESS_MACHINE_CASING.get())
                            .or(Predicates.abilities(PartAbility.IMPORT_ITEMS).setMaxGlobalLimited(1).setPreviewCount(1))
                            .or(Predicates.abilities(PartAbility.EXPORT_ITEMS).setMaxGlobalLimited(1).setPreviewCount(1))
                            .or(Predicates.abilities(PartAbility.EXPORT_FLUIDS).setMaxGlobalLimited(1).setPreviewCount(1))
                            .or(Predicates.abilities(PartAbility.IMPORT_FLUIDS).setMaxGlobalLimited(1).setPreviewCount(1))
    ...
    public final static MultiblockMachineDefinition ELEMENT_COPYING = REGISTRATE.multiblock("element_copying", WorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.ALL)
            .recipeType(GTORecipeTypes.ELEMENT_COPYING_RECIPES)
            .tooltips(Component.translatable("gtocore.machine.laser.tooltip"))
            .tooltips(Component.translatable("gtceu.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
            ...
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .where("C", Predicates.blocks(GTOBlocks.MOLECULAR_COIL.get()))
    ...
    public final static MultiblockMachineDefinition ATOMIC_ENERGY_EXCITATION_PLANT = REGISTRATE.multiblock("atomic_energy_excitation_plant", CoilWorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.NON_Y_AXIS)
            .recipeType(GTORecipeTypes.ATOMIC_ENERGY_EXCITATION_RECIPES)
            .tooltips(Component.translatable("gtocore.machine.laser.tooltip"))
            .tooltips(Component.translatable("gtceu.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gtceu.atomic_energy_excitation")))
            .recipeModifiers(GTRecipeModifiers.PARALLEL_HATCH, GTRecipeModifiers.ELECTRIC_OVERCLOCK.apply(OverclockingLogic.NON_PERFECT_OVERCLOCK_SUBTICK))
            .appearanceBlock(GTOBlocks.DIMENSIONALLY_TRANSCENDENT_CASING)
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .aisle("                   ", "                   ", "                   ", "                   ", "         A         ", "        ABA        ", "        CCC        ", "        ABA        ", "         A         ", "                   ", "                   ", "                   ", "                   ")
                    .where("~", Predicates.controller(Predicates.blocks(definition.get())))
                    .where("A", Predicates.blocks(GTOBlocks.DEGENERATE_RHENIUM_CONSTRAINED_CASING.get()))
                    .where("B", Predicates.blocks(GTOBlocks.RHENIUM_REINFORCED_ENERGY_GLASS.get()))
                    .where("C", Predicates.heatingCoils())
                    .where("D", Predicates.blocks(GTOBlocks.DIMENSIONALLY_TRANSCENDENT_CASING.get())
                            .or(Predicates.abilities(PartAbility.INPUT_ENERGY).setMaxGlobalLimited(2).setPreviewCount(1))
                            .or(Predicates.abilities(PartAbility.INPUT_LASER).setMaxGlobalLimited(1))
                            ...
                            .or(Predicates.abilities(PartAbility.MAINTENANCE).setExactLimit(1))
                            .or(Predicates.abilities(PartAbility.PARALLEL_HATCH).setMaxGlobalLimited(1)))
                    .where("E", Predicates.blocks(GTOBlocks.DIMENSION_INJECTION_CASING.get()))
                    .where("F", Predicates.blocks(GTOBlocks.ACCELERATED_PIPELINE.get()))
                    .where("G", Predicates.blocks(GTOBlocks.RESTRAINT_DEVICE.get()))
                    .where("H", Predicates.blocks(GTOBlocks.NEUTRONIUM_PIPE_CASING.get()))
                    .where("I", Predicates.blocks(GTOBlocks.CONTAINMENT_FIELD_GENERATOR.get()))
                    .where("J", Predicates.blocks(GTOBlocks.AGGREGATIONE_CORE.get()))
                    .where(" ", Predicates.any())
                    .where("#", Predicates.air())
                    .build())
            .beforeWorking((machine, recipe) -> recipe.data.getInt("ebf_temp") <= ((CoilWorkableElectricMultiblockMachine) machine).getCoilType().getCoilTemperature())
    ...
    public final static MultiblockMachineDefinition FLOTATION_CELL_REGULATOR = REGISTRATE.multiblock("flotation_cell_regulator", WorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.ALL)
            .recipeType(GTORecipeTypes.FLOTATING_BENEFICIATION_RECIPES)
            .tooltips(Component.translatable("gtocore.machine.flotation_cell_regulator.tooltip.0"))
            .tooltips(Component.translatable("gtceu.machine.perfect_oc"))
            .tooltips(Component.translatable("gtceu.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gtceu.flotating_beneficiation")))
            .recipeModifiers(GTRecipeModifiers.PARALLEL_HATCH, GTRecipeModifiers.ELECTRIC_OVERCLOCK.apply(OverclockingLogic.PERFECT_OVERCLOCK_SUBTICK))
            .appearanceBlock(GTOBlocks.HASTELLOY_N_75_CASING)
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .aisle("       ", "       ", "   E   ", "  E~E  ", "   E   ", "       ", "       ")
                    .where("~", Predicates.controller(Predicates.blocks(definition.get())))
                    .where("D", Predicates.blocks(GTOBlocks.HASTELLOY_N_75_GEARBOX.get()))
                    .where("B", Predicates.blocks(GTOBlocks.FLOTATION_CELL.get()))
                    .where("A", Predicates.blocks(GTOBlocks.HASTELLOY_N_75_CASING.get())
                            .or(Predicates.abilities(PartAbility.INPUT_ENERGY).setMaxGlobalLimited(2).setPreviewCount(1))
                            .or(Predicates.abilities(PartAbility.IMPORT_FLUIDS).setMaxGlobalLimited(1).setPreviewCount(1))
                            .or(Predicates.abilities(PartAbility.IMPORT_ITEMS).setMaxGlobalLimited(2).setPreviewCount(1))
                            .or(Predicates.abilities(PartAbility.EXPORT_FLUIDS).setMaxGlobalLimited(1).setPreviewCount(1))
                            ...
                            .or(Predicates.abilities(PartAbility.MAINTENANCE).setExactLimit(1)))
                    .where("C", Predicates.blocks(GTOBlocks.HASTELLOY_N_75_PIPE.get()))
                    .where("E", Predicates.blocks(GTOBlocks.HASTELLOY_N_75_CASING.get()))
                    .where(" ", Predicates.any())
                    .where("#", Predicates.air())
                    .build())
            .workableCasingRenderer(GTOCore.id("block/hastelloy_n_75_casing"), GTCEu.id("block/multiblock/gcym/large_chemical_bath"))
            .register();
    ...
    public final static MultiblockMachineDefinition VACUUM_DRYING_FURNACE = REGISTRATE.multiblock("vacuum_drying_furnace", CoilWorkableElectricMultiblockMachine::new)
            .rotationState(RotationState.ALL)
            .recipeType(GTORecipeTypes.VACUUM_DRYING_RECIPES)
            .recipeType(GTORecipeTypes.DEHYDRATOR_RECIPES)
            .tooltips(Component.translatable("gtocore.machine.vacuum_drying_furnace.tooltip.0"))
            .tooltips(Component.translatable("gtceu.machine.electric_blast_furnace.tooltip.0"),
                    Component.translatable("gtceu.machine.electric_blast_furnace.tooltip.1"),
                    Component.translatable("gtceu.machine.electric_blast_furnace.tooltip.2"))
            .tooltips(Component.translatable("gtocore.machine.vacuum_drying_furnace.tooltip.1"))
            .tooltips(Component.translatable("gtocore.machine.coil_parallel"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_2.tooltip",
            ...
            .appearanceBlock(GTOBlocks.RED_STEEL_CASING)
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .where("A", Predicates.blocks(GTOBlocks.RED_STEEL_CASING.get())
                            .or(Predicates.abilities(PartAbility.INPUT_ENERGY).setMaxGlobalLimited(2).setPreviewCount(1))
                            .or(Predicates.abilities(PartAbility.MAINTENANCE).setExactLimit(1))
                            .or(Predicates.abilities(PartAbility.IMPORT_FLUIDS).setMaxGlobalLimited(2).setPreviewCount(1))
                            .or(Predicates.abilities(PartAbility.IMPORT_ITEMS).setMaxGlobalLimited(2).setPreviewCount(1))
            ...
            .additionalDisplay((controller, components) -> {
                if (controller instanceof CoilWorkableElectricMultiblockMachine coilMachine && controller.isFormed()) {
                    if (coilMachine.getRecipeType() == GTORecipeTypes.DEHYDRATOR_RECIPES) {
            ...
            .workableCasingRenderer(GTOCore.id("block/casings/red_steel_casing/top"), GTCEu.id("block/multiblock/fusion_reactor"))
            .register();
    ...
    public final static MultiblockMachineDefinition MEGA_FLUID_HEATER = REGISTRATE.multiblock("mega_fluid_heater", CoilWorkableElectricMultipleRecipesMultiblockMachine::new)
            ...
            .tooltips(Component.translatable("gtocore.machine.mega_fluid_heater"))
            .tooltips(Component.translatable("gtocore.machine.coil_parallel"))
            .tooltips(Component.translatable("gtocore.machine.laser.tooltip"))
            .tooltips(Component.translatable("gtocore.machine.multiple_recipes.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .where("D", Predicates.blocks(GTOBlocks.ENHANCE_HYPER_MECHANICAL_CASING.get()))
                    .where("B", Predicates.blocks(GTOBlocks.RHENIUM_REINFORCED_ENERGY_GLASS.get()))
                    .where("C", Predicates.blocks(GTOBlocks.ANTIFREEZE_HEATPROOF_MACHINE_CASING.get()))
                    .where("F", Predicates.blocks(GTBlocks.HERMETIC_CASING_UHV.get()))
                    .where("E", Predicates.blocks(GTOBlocks.IRIDIUM_CASING.get())
                            .or(GTOPredicates.autoLaserAbilities(definition.getRecipeTypes()))
                            .or(Predicates.abilities(PartAbility.MAINTENANCE).setExactLimit(1)))
                    .where(" ", Predicates.any())
                    .build())
            .additionalDisplay(GTOMachines.COIL_PARALLEL)
            .workableCasingRenderer(GTOCore.id("block/casings/iridium_casing"), GTCEu.id("block/machines/fluid_heater"))
            .register();
    ...
    public final static MultiblockMachineDefinition ELECTRIC_IMPLOSION_COMPRESSOR = REGISTRATE
            ...
            .rotationState(RotationState.ALL)
            .recipeType(GTORecipeTypes.ELECTRIC_IMPLOSION_COMPRESSOR_RECIPES)
    ...
    public final static MultiblockMachineDefinition STELLAR_FORGE = REGISTRATE.multiblock("stellar_forge", (holder) -> new TierCasingMachine(holder, "stellar_containment_tier"))
            .rotationState(RotationState.NON_Y_AXIS)
            .allowExtendedFacing(false)
            .recipeType(GTORecipeTypes.STELLAR_FORGE_RECIPES)
            .tooltips(Component.translatable("gtceu.machine.perfect_oc"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .where("d", GTOPredicates.STELLAR_CONTAINMENT)
                    .where(" ", Predicates.any())
                    .build())
    ...
    public final static MultiblockMachineDefinition COMPONENT_ASSEMBLY_LINE = REGISTRATE.multiblock("component_assembly_line", (holder) -> new TierCasingMachine(holder, "component_assembly_line_casing_tier"))
            .rotationState(RotationState.ALL)
            .recipeType(GTORecipeTypes.COMPONENT_ASSEMBLY_LINE_RECIPES)
            .tooltips(Component.translatable("gtocore.machine.laser.tooltip"))
            .tooltips(Component.translatable("gtceu.multiblock.parallelizable.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
            ...
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .where("D", Predicates.blocks(GTOBlocks.IRIDIUM_CASING.get())
                            .or(Predicates.abilities(PartAbility.PARALLEL_HATCH).setExactLimit(1))
                            .or(Predicates.abilities(PartAbility.MAINTENANCE).setExactLimit(1)))
                    .where("F", Predicates.blocks(GTOBlocks.HSSS_REINFORCED_BOROSILICATE_GLASS.get()))
                    .where("G", Predicates.blocks(GTBlocks.FILTER_CASING.get()))
                    .where("H", Predicates.blocks(GTOBlocks.IRIDIUM_CASING.get())
                            .or(Predicates.abilities(PartAbility.INPUT_ENERGY).setMaxGlobalLimited(2))
                            .or(Predicates.abilities(PartAbility.INPUT_LASER).setMaxGlobalLimited(1)))
                    .where("I", Predicates.blocks(ChemicalHelper.getBlock(TagPrefix.frameGt, GTOMaterials.HastelloyN)))
                    .where("J", Predicates.blocks(GTOBlocks.ADVANCED_ASSEMBLY_LINE_UNIT.get()))
                    .where("K", GTOPredicates.COMPONENT_ASSEMBLY_LINE_CASING)
                    ...
                    .where("N", Predicates.blocks(GTOBlocks.IRIDIUM_CASING.get())
    ...
    public final static MultiblockMachineDefinition ADVANCED_INTEGRATED_ORE_PROCESSOR = REGISTRATE.multiblock("advanced_integrated_ore_processor", h -> new WorkableElectricMultipleRecipesMachine(h, true))
            ...
            .recipeType(GTORecipeTypes.INTEGRATED_ORE_PROCESSOR)
            .tooltips(Component.translatable("gtocore.machine.integrated_ore_processor.tooltip.0"))
            .tooltips(Component.translatable("gtocore.machine.advanced_integrated_ore_processor.tooltip.0"))
            .tooltips(Component.translatable("gtocore.machine.laser.tooltip"))
            .tooltips(Component.translatable("gtocore.machine.multiple_recipes.tooltip"))
            .tooltips(Component.translatable("gtceu.machine.available_recipe_map_1.tooltip",
                    Component.translatable("gtceu.integrated_ore_processor")))
            ...
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .where("C", Predicates.blocks(GTOBlocks.RESTRAINT_DEVICE.get()))
                    ...
                    .where("H", Predicates.blocks(GTOBlocks.HSSS_REINFORCED_BOROSILICATE_GLASS.get()))
    ...
    public final static MultiblockMachineDefinition DIMENSIONALLY_TRANSCENDENT_STEAM_OVEN = REGISTRATE.multiblock("dimensionally_transcendent_steam_oven", holder -> new LargeSteamParallelMultiblockMachine(holder, 524288))
            ...
            .recipeModifiers((machine, recipe, params, result) -> GTORecipeModifiers.reduction(machine, recipe, 0.01, 1), (machine, recipe, params, result) -> LargeSteamParallelMultiblockMachine.recipeModifier(machine, recipe, 0))
    ...
    public static final MultiblockMachineDefinition ADVANCED_MULTI_SMELTER = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start(RelativeDirection.FRONT, RelativeDirection.UP, RelativeDirection.RIGHT)
                    ...
                    .aisle("        AAAAAAAAAAAAAAAAAAA      ", "             ABBBBBBBA           ", "     C    C  AAAAAAAAA           ", "     C    C  ABBBBBBBA           ", "             AAAAAAAAA           ", "             ABBBBBBBA           ", "             AAAAAAAAA           ", "                                 ", "                                 ", "                                 ", "                                 ", "                                 ", "                                 ", "                                 ", "                                 ", "                                 ", "                                 ", "                                 ", "                                 ", "                                 ", "                                 ", "                                 ", "                                 ", "                                 ", "                                 ", "                                 ")
                    .where("~", Predicates.controller(Predicates.blocks(definition.get())))
                    .where("T", Predicates.blocks(GTOBlocks.STELLAR_CONTAINMENT_CASING.get()))
                    .where("G", Predicates.blocks(GTBlocks.CASING_TUNGSTENSTEEL_GEARBOX.get()))
                    .where("K", Predicates.blocks(GTBlocks.FUSION_GLASS.get()))
                    .where("F", Predicates.blocks(GTOBlocks.HYPER_MECHANICAL_CASING.get()))
                    .where("Z", Predicates.blocks(GTOBlocks.HYPER_MECHANICAL_CASING.get())
                            .or(GTOPredicates.autoLaserAbilities(definition.getRecipeTypes()))
                    ...
                    .where("L", Predicates.blocks(GTOBlocks.NEUTRONIUM_PIPE_CASING.get()))
                    ...
                    .where("R", Predicates.blocks(GTOBlocks.NEUTRONIUM_GEARBOX.get()))
                    .where("C", Predicates.blocks(GTOBlocks.CASING_SUPERCRITICAL_TURBINE.get()))
                    .where("H", Predicates.blocks(GTBlocks.CASING_STEEL_PIPE.get()))
                    .where("S", Predicates.blocks(GTOBlocks.IRIDIUM_CASING.get()))
                    .where(' ', Predicates.any())
                    .build())
    ...
    public final static MultiblockMachineDefinition MAGE_ASSEMBLER = REGISTRATE.multiblock("mage_assembler", WorkableElectricParallelHatchMultipleRecipesMachine::new)
            ...
            .pattern((definition) -> FactoryBlockPattern.start(RelativeDirection.FRONT, RelativeDirection.UP, RelativeDirection.RIGHT)
                    ...
                    .where("~", Predicates.controller(Predicates.blocks(definition.get())))
                    .where("A", Predicates.blocks(GTOBlocks.NAQUADAH_ALLOY_CASING.get()))
                    .where("B", Predicates.blocks(GTOBlocks.IRIDIUM_CASING.get())
                            .or(GTOPredicates.autoLaserAbilities(definition.getRecipeTypes()))
                            .or(Predicates.abilities(PartAbility.PARALLEL_HATCH).setMaxGlobalLimited(1))
                            .or(Predicates.abilities(PartAbility.MAINTENANCE).setExactLimit(1)))
                    .where("C", Predicates.blocks(GTOBlocks.IRIDIUM_CASING.get()))
                    .where("D", Predicates.blocks(GTOBlocks.OXIDATION_RESISTANT_HASTELLOY_N_MECHANICAL_CASING.get()))
                    .where("E", Predicates.blocks(ChemicalHelper.getBlock(TagPrefix.frameGt, GTMaterials.HSLASteel)))
                    .where("F", Predicates.blocks(GTOBlocks.NEUTRONIUM_GEARBOX.get()))
                    .where("G", Predicates.blocks(GCyMBlocks.CASING_NONCONDUCTING.get()))
                    .where("H", Predicates.blocks(GTOBlocks.SPACETIME_ASSEMBLY_LINE_UNIT.get()))
                    ...
                    .where("L", Predicates.blocks(GTOBlocks.ADVANCED_ASSEMBLY_LINE_UNIT.get()))
                    .where("M", Predicates.blocks(GTOBlocks.PROCESS_MACHINE_CASING.get()))
                    .where("O", Predicates.blocks(GTBlocks.CASING_ASSEMBLY_LINE.get()))
                    .where("P", Predicates.blocks(GTBlocks.CLEANROOM_GLASS.get()))
                    .where("Q", Predicates.blocks(GTOBlocks.MACHINE_CASING_CIRCUIT_ASSEMBLY_LINE.get()))
                    .where("R", Predicates.blocks(Blocks.IRON_BARS))
                    .where("S", Predicates.blocks(GTOBlocks.NEUTRONIUM_PIPE_CASING.get()))
