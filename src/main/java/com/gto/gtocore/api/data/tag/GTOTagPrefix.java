...
public final class GTOTagPrefix extends TagPrefix {
    ...
    private static TagPrefix ore(String name) {
        return new GTOTagPrefix(name).defaultTagPath("ores/%s").prefixOnlyTagPath("ores_in_ground/%s").unformattedTagPath("ores").materialIconType(MaterialIconType.ore).miningToolTag(BlockTags.MINEABLE_WITH_PICKAXE).unificationEnabled(true).generationCondition(hasOreProperty);
    }
    ...
    public static final TagPrefix NANITES = new GTOTagPrefix("nanites")
            .idPattern("%s_nanites")
    ...
    public static final TagPrefix CONTAMINABLE_NANITES = new GTOTagPrefix("contaminable_nanites")
    ...
    public static final TagPrefix MILLED = new GTOTagPrefix("milled")
            .idPattern("milled_%s")
    ...
    public static final TagPrefix CURVED_PLATE = new GTOTagPrefix("curved_plate")
    ...
    public static final TagPrefix MOTOR_ENCLOSURE = new GTOTagPrefix("motor_enclosure")
    ...
    public static final TagPrefix PUMP_BARREL = new GTOTagPrefix("pump_barrel")
    ...
    public static final TagPrefix PISTON_HOUSING = new GTOTagPrefix("piston_housing")
    ...
    public static final TagPrefix EMITTER_BASES = new GTOTagPrefix("emitter_base")
    ...
    public static final TagPrefix SENSOR_CASING = new GTOTagPrefix("sensor_casing")
    ...
    public static final TagPrefix FIELD_GENERATOR_CASING = new GTOTagPrefix("field_generator_casing")
    ...
    public static final TagPrefix ROUGH_BLANK = new GTOTagPrefix("rough_blank")
    ...
    public static final TagPrefix BRICK = new GTOTagPrefix("brick")
            .idPattern("%s_brick")
    ...
    public static final TagPrefix FLAKES = new GTOTagPrefix("flake")
            .idPattern("%s_flake")
    ...
    public static final TagPrefix ARTIFICIAL_GEM = new GTOTagPrefix("artificial_gem")
    ...
    public static final TagPrefix CRYSTAL_SEED = new GTOTagPrefix("crystal_seed")
    ...
    public static final TagPrefix SUPERCONDUCTOR_BASE = new GTOTagPrefix("superconductor_base")
