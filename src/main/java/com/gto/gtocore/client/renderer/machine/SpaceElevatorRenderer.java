...
import com.gto.gtocore.common.machine.multiblock.electric.SpaceElevatorMachine;
import com.gto.gtocore.common.machine.multiblock.electric.SuperSpaceElevatorMachine;
...
public class SpaceElevatorRenderer extends WorkableCasingMachineRenderer {
    ...
    public SpaceElevatorRenderer() {
        super(GTOCore.id("block/space_elevator_mechanical_casing"), GTCEu.id("block/multiblock/data_bank"));
    }
