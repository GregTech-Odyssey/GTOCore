...
import static com.gto.gtocore.utils.register.MachineRegisterUtils.CHEMICAL_PLANT_DISPLAY;
...
public interface MultiBlockA {
    ...
    MultiblockMachineDefinition FLOTATION_CELL_REGULATOR = multiblock("flotation_cell_regulator", "工业浮选机", ElectricMultiblockMachine::new)
            .allRotation()
