...
public class PlatformDeploymentMachine extends MetaMachine implements IFancyUIMachine, IMachineLife {
    ...
    private static final NetworkPack HIGHLIGHT_REGION = NetworkPack.registerS2C((p, b) -> {
    ...
    private static final NetworkPack STOP_HIGHLIGHT = NetworkPack.registerS2C((p, b) -> {
        var start = b.readBlockPos();
        var end = b.readBlockPos();
