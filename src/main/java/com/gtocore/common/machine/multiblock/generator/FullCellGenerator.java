...
public class FullCellGenerator extends ElectricMultiblockMachine {
    ...
    @DynamicInitialValue(key = "fuelcell.chance_consume", difficultyType = "machine.generator", easyValue = "0.0d", normalValue = "0.035d", expertValue = "0.055d", typeKey = DynamicInitialValueTypes.KEY_PROBABILITY, cn = "放电时膜损坏概率", cnComment = """
            放电时使用的膜材料的损坏概率。
