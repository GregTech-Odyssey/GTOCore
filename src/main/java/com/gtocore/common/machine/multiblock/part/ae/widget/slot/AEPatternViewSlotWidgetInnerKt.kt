...
class AEPatternViewSlotWidgetInnerKt(
    itemHandler: IItemHandlerModifiable,
    slotIndex: Int,
    xPosition: Int,
    yPosition: Int,
    private val clicked: Runnable
...
class AEPatternViewSlotWidgetKt(x: Int, y: Int, val slotIndex: Int, val applyIndexSupplier: IntSupplier, val itemHandler: IItemHandlerModifiable, val clicked: Runnable) :
    SyncWidget(x, y, 18, 18) {
