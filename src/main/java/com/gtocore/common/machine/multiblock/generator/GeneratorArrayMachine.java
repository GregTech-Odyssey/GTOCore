...
public final class GeneratorArrayMachine extends StorageMultiblockMachine implements IArrayMachine, IExtendWirelessEnergyContainerHolder {
    ...
    @DynamicInitialValue(key = "generator_array.multiply", difficultyType = "machine.generator", easyValue = "2", normalValue = "1.3", expertValue = "1.3", typeKey = DynamicInitialValueTypes.KEY_MULTIPLY, cn = "发电阵列乘数", cnComment = """
    ...
    @DynamicInitialValue(key = "generator_array.loss", difficultyType = "machine.generator", typeKey = DynamicInitialValueTypes.KEY_MULTIPLY, easyValue = "4", normalValue = "5", expertValue = "8", cn = "发电阵列无线模式损耗 : 0.0%s", cnComment = """
    ...
    @DynamicInitialValue(key = "generator_array.limit", difficultyType = "machine.generator", easyValue = "16", normalValue = "4", expertValue = "4", cn = "发电阵列内部发电机限制", cnComment = """
