...
public final class MultiBlockG {
    ...
    public static final MultiblockMachineDefinition ME_ENERGY_SUBSTATION = multiblock("me_energy_substation", "ME能源塔", MEEnergySubstationMachine::new)
            ...
            .pattern(definition -> FactoryBlockPattern.start(definition)
                    ...
                    .aisle("ABBBA", "BDEDB", "BDFDB", "BDEDB", "ABBBA")
                    .aisle("ABCBA", "BEFEB", "CFHFC", "BEFEB", "ABCBA")
                    .aisle("ABBBA", "BDEDB", "BDFDB", "BDEDB", "ABBBA")
                    ...
                    .build())
            .addSubPattern(definition -> FactoryBlockPattern.start(definition)
                    .aisle("AAAAA", "AEEEA", "AEBEA", "AEEEA", "AAAAA", "DD DD", " D D ")
                    .aisle("ABCBA", "BFDFB", "CDHDC", "BFDFB", "ABCBA", "     ", " D D ")
                    .aisle("ABCBA", "BFDFB", "CDHDC", "BFDFB", "ABCBA", "     ", " D D ")
                    .aisle("ABCBA", "BFDFB", "CDHDC", "BFDFB", "ABCBA", "     ", " D D ")
                    .aisle("AACAA", "AFDFA", "CDIDC", "AFDFA", "AACAA", "DD DD", " D D ")
                    .aisle("AACAA", "AFDFA", "CDIDC", "AFDFA", "AADAA", "DDDDD", " D D ")
                    .aisle("ABCBA", "BFDFB", "CDHDC", "BFDFB", "ABCBA", "     ", " D D ")
                    .aisle("ABCBA", "BFDFB", "CDHDC", "BFDFB", "ABCBA", "     ", " D D ")
                    .aisle("ABCBA", "BFDFB", "CDHDC", "BFDFB", "ABCBA", "     ", " D D ")
                    .aisle("AAAAA", "AEEEA", "AEBEA", "AEEEA", "AADAA", "DDDDD", " D D ")
                    .aisle("     ", "     ", "     ", "     ", "     ", "DD DD", " D D ")
                    .aisle("     ", "     ", "     ", "     ", "     ", "     ", " D D ")
                    .aisle("     ", "     ", "     ", "     ", "     ", "     ", " D D ")
                    .aisle("     ", "     ", "     ", "     ", "     ", "     ", " D D ")
                    ...
                    .where('G', controller(blocks(definition.get())))
                    .where('H', blocks(GTBlocks.BATTERY_LAPOTRONIC_ZPM.get()))
                    .where('I', blocks(RegistriesUtils.getBlock("ae2:energy_acceptor")))
                    .where(' ', any())
                    .build())
            .checkPriority(1000)
            .workableCasingRenderer(GTCEu.id("block/casings/solid/machine_casing_solid_steel"), GTCEu.id("block/multiblock/fusion_reactor"))
