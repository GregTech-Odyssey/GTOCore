    ...
    private static Triple<Float, Float, Float> getTravelParticleColor() {
        if (Calendar.getInstance().get(Calendar.MONTH) == Calendar.JUNE) {
            ...
            return switch (halfTick) {
                case 0 -> Triple.of(228 / 255f, 3 / 255f, 3 / 255f);
                case 1 -> Triple.of(255 / 255f, 140 / 255f, 0 / 255f);
                case 2 -> Triple.of(255 / 255f, 237 / 255f, 0 / 255f);
                case 3 -> Triple.of(0 / 255f, 128 / 255f, 38 / 255f);
                case 4 -> Triple.of(0 / 255f, 77 / 255f, 255 / 255f);
                case 5 -> Triple.of(117 / 255f, 7 / 255f, 135 / 255f);
                default -> Triple.of(255 / 255f, 255 / 255f, 255 / 255f);
            };
        }
