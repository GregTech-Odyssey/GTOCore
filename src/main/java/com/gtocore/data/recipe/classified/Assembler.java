...
final class Assembler {
    ...
    public static void init() {
        ...
        ASSEMBLER_RECIPES.builder("wireless_charger")
                .inputItems(GTMachines.CHARGER_4[GTValues.LV].asStack())
                .inputItems(GTItems.FIELD_GENERATOR_LV.asStack(16))
                ...
                .outputItems(MultiBlockG.WIRELESS_CHARGER.asStack())
                .EUt(30)
                .duration(400)
                .save();
        if(GTOCore.isExpert()){
        ...
        ASSEMBLER_RECIPES.recipeBuilder("advanced_catalyst_hatch")
                ...
                .outputItems(GTOMachines.ADVANCED_CATALYST_HATCH.asStack())
        ...
        ASSEMBLER_RECIPES.recipeBuilder("electric_implosion_compressor")
                .inputItems(GTMultiMachines.IMPLOSION_COMPRESSOR.asStack(8))
                .inputItems(GTMachines.POWER_TRANSFORMER[GTValues.LuV].asStack(32))
                .inputItems(GTMachines.DIODE[GTValues.LuV].asStack(32))
                .inputItems(GTItems.FIELD_GENERATOR_LuV.asStack(16))
        ...
        ASSEMBLER_RECIPES.builder("space_nanomuscle_chestplate")
                ...
                .inputItems(GTItems.ELECTRIC_PUMP_HV.asStack(), 2)
                .inputItems(GTItems.SENSOR_HV.asStack())
        ...
        ASSEMBLER_RECIPES.builder("space_advanced_nanomuscle_chestplate")
                ...
                .inputItems("ad_astra:large_gas_tank", 2)
                .inputItems(GTItems.FLUID_CELL_LARGE_STAINLESS_STEEL.asStack())
                .inputItems(GTItems.ELECTRIC_PUMP_EV.asStack(), 2)
                .inputItems(GTItems.SENSOR_EV.asStack())
        ...
        ASSEMBLER_RECIPES.builder("coolant_cell_60k")
                .inputItems(GTOItems.COOLANT_CELL_30K.asStack(2))
        ...
        ASSEMBLER_RECIPES.builder("catalyst_hatch")
                .inputItems(GTMachines.ITEM_IMPORT_BUS[GTValues.MV].asStack())
                .inputItems(GTOItems.CATALYST_BASE.asStack(2))
        ...
        ASSEMBLER_RECIPES.builder("me_tag_filter_stock_bus_part_machine")
                ...
                .inputItems(GTItems.TAG_FILTER.asStack(16))
                .inputItems(GTItems.SMART_ITEM_FILTER.asStack(16))
                .outputItems(GTAEMachines.ME_TAG_FILTER_STOCK_BUS.asStack())
        ...
        ASSEMBLER_RECIPES.builder("me_tag_filter_stock_hatch_part_machine")
                ...
                .inputItems(GTItems.FLUID_FILTER.asStack(16))
                .inputItems(GTItems.SMART_ITEM_FILTER.asStack(16))
                .outputItems(GTAEMachines.ME_TAG_FILTER_STOCK_HATCH.asStack())
                .inputFluids(GTMaterials.SolderingAlloy, 576)
                .EUt(480)
                .duration(400)
                .save();
        ...
        ASSEMBLER_RECIPES.builder("abs_white_casing")
                ...
                .outputItems(GTOBlocks.ABS_WHITE_CASING.asStack())
        ...
        ASSEMBLER_RECIPES.builder("t1_me_storage_core")
                .inputItems(new ItemStack(AEBlocks.CRAFTING_STORAGE_256K.block().asItem()))
                .inputItems(GTOItems.CELL_COMPONENT_1M.asItem())
                .inputItems(GTItems.EMITTER_EV.asStack())
                .inputItems(GTItems.SENSOR_EV.asStack())
                .inputItems(TagPrefix.plateDouble, GTMaterials.Titanium, 4)
                .outputItems(GTOBlocks.T1_ME_STORAGE_CORE.asStack())
                .inputFluids(GTMaterials.SolderingAlloy, 576)
                .EUt(1920)
                .duration(200)
                .save();
        ...
        ASSEMBLER_RECIPES.builder("t2_me_storage_core")
                ...
                .inputItems(GTItems.SENSOR_IV.asStack())
                .inputItems(TagPrefix.plateDouble, GTMaterials.TungstenSteel, 4)
                .outputItems(GTOBlocks.T2_ME_STORAGE_CORE.asStack())
                .inputFluids(GTMaterials.SolderingAlloy, 576)
                .EUt(7680)
                .duration(200)
                .save();
        ...
        ASSEMBLER_RECIPES.builder("t3_me_storage_core")
                ...
                .inputItems(TagPrefix.plateDouble, GTMaterials.RhodiumPlatedPalladium, 4)
                .outputItems(GTOBlocks.T3_ME_STORAGE_CORE.asStack())
                .inputFluids(GTMaterials.SolderingAlloy, 576)
                .EUt(30720)
                .duration(200)
                .save();
        ...
        ASSEMBLER_RECIPES.builder("t4_me_storage_core")
                ...
                .inputItems(TagPrefix.plateDouble, GTMaterials.NaquadahAlloy, 4)
                .outputItems(GTOBlocks.T4_ME_STORAGE_CORE.asStack())
                .inputFluids(GTMaterials.SolderingAlloy, 576)
                .EUt(122880)
                .duration(200)
                .save();
        ...
        ASSEMBLER_RECIPES.builder("t5_me_storage_core")
                ...
                .outputItems(GTOBlocks.T5_ME_STORAGE_CORE.asStack())
                .inputFluids(GTMaterials.SolderingAlloy, 576)
                .EUt(491520)
                .duration(200)
                .save();
        ...
        ASSEMBLER_RECIPES.builder("me_storage")
                ...
                .outputItems(MultiBlockG.ME_STORAGE.asStack())
        ...
        ASSEMBLER_RECIPES.builder("quantum_glass")
                .inputItems(GTBlocks.CASING_LAMINATED_GLASS.asStack())
                .inputItems(GTOBlocks.MOLECULAR_CASING.asStack())
                .outputItems(GTOBlocks.QUANTUM_GLASS.asStack())
