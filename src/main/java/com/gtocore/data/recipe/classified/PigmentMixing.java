...
final class PigmentMixing {
    ...
    public static void init() {
        ...
        PIGMENT_MIXING_RECIPES.builder("brown_dye")
                .inputItems(GTOItems.MAGENTA_DYE_MASTERBATCH.asItem())
                .inputItems(GTOItems.YELLOW_DYE_MASTERBATCH.asItem(), 2)
                .inputItems(GTOItems.BLACK_DYE_MASTERBATCH.asItem(), 3)
        ...
        PIGMENT_MIXING_RECIPES.builder("magenta_dye")
                .inputItems(GTOItems.MAGENTA_DYE_MASTERBATCH.asItem(), 6)
                .inputFluids(GTOMaterials.DyeCarrierResin, 16000)
        ...
        PIGMENT_MIXING_RECIPES.builder("blue_dye")
                .inputItems(GTOItems.CYAN_DYE_MASTERBATCH.asItem(), 3)
                .inputItems(GTOItems.MAGENTA_DYE_MASTERBATCH.asItem(), 2)
                .inputItems(GTOItems.YELLOW_DYE_MASTERBATCH.asItem())
                .inputFluids(GTOMaterials.DyeCarrierResin, 16000)
        ...
        PIGMENT_MIXING_RECIPES.builder("pink_dye")
                .inputItems(GTOItems.MAGENTA_DYE_MASTERBATCH.asItem(), 4)
                .inputItems(GTOItems.YELLOW_DYE_MASTERBATCH.asItem(), 2)
                .inputFluids(GTOMaterials.DyeCarrierResin, 16000)
        ...
        PIGMENT_MIXING_RECIPES.builder("black_dye")
                .inputItems(GTOItems.BLACK_DYE_MASTERBATCH.asItem(), 6)
                .inputFluids(GTOMaterials.DyeCarrierResin, 16000)
        ...
        PIGMENT_MIXING_RECIPES.builder("red_dye")
                .inputItems(GTOItems.MAGENTA_DYE_MASTERBATCH.asItem(), 3)
                .inputItems(GTOItems.YELLOW_DYE_MASTERBATCH.asItem(), 3)
                .inputFluids(GTOMaterials.DyeCarrierResin, 16000)
        ...
        PIGMENT_MIXING_RECIPES.builder("orange_dye")
                .inputItems(GTOItems.MAGENTA_DYE_MASTERBATCH.asItem(), 2)
                .inputItems(GTOItems.YELLOW_DYE_MASTERBATCH.asItem(), 4)
                .inputFluids(GTOMaterials.DyeCarrierResin, 16000)
        ...
        PIGMENT_MIXING_RECIPES.builder("light_blue_dye")
                .inputItems(GTOItems.MAGENTA_DYE_MASTERBATCH.asItem(), 2)
                .inputItems(GTOItems.CYAN_DYE_MASTERBATCH.asItem(), 4)
                .inputFluids(GTOMaterials.DyeCarrierResin, 16000)
        ...
        PIGMENT_MIXING_RECIPES.builder("yellow_dye")
                .inputItems(GTOItems.YELLOW_DYE_MASTERBATCH.asItem(), 6)
                .inputFluids(GTOMaterials.DyeCarrierResin, 16000)
        ...
        PIGMENT_MIXING_RECIPES.builder("green_dye")
                .inputItems(GTOItems.YELLOW_DYE_MASTERBATCH.asItem(), 3)
                .inputItems(GTOItems.MAGENTA_DYE_MASTERBATCH.asItem())
                .inputItems(GTOItems.CYAN_DYE_MASTERBATCH.asItem(), 2)
                .inputFluids(GTOMaterials.DyeCarrierResin, 16000)
        ...
        PIGMENT_MIXING_RECIPES.builder("cyan_dye")
                .inputItems(GTOItems.CYAN_DYE_MASTERBATCH.asItem(), 6)
                .inputFluids(GTOMaterials.DyeCarrierResin, 16000)
        ...
        PIGMENT_MIXING_RECIPES.builder("light_gray_dye")
                .inputItems(GTOItems.BLACK_DYE_MASTERBATCH.asItem(), 2)
                .inputItems(GTOItems.WHITE_DYE_MASTERBATCH.asItem(), 4)
                .inputFluids(GTOMaterials.DyeCarrierResin, 16000)
        ...
        PIGMENT_MIXING_RECIPES.builder("gray_dye")
                .inputItems(GTOItems.BLACK_DYE_MASTERBATCH.asItem(), 4)
                .inputItems(GTOItems.WHITE_DYE_MASTERBATCH.asItem(), 2)
                .inputFluids(GTOMaterials.DyeCarrierResin, 16000)
        ...
        PIGMENT_MIXING_RECIPES.builder("white_dye")
                .inputItems(GTOItems.WHITE_DYE_MASTERBATCH.asItem(), 6)
                .inputFluids(GTOMaterials.DyeCarrierResin, 16000)
