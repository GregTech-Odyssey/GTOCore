...
final class Centrifuge {
    ...
    public static void init() {
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("depleted_reactor_mox_simple")
                .inputItems(GTOItems.DEPLETED_REACTOR_MOX_SIMPLE)
                .outputItems(GTOItems.REACTOR_FUEL_ROD)
                .chancedOutput(GTOItems.NUCLEAR_WASTE.asItem(), 8, 2000, 1000)
                .chancedOutput(GTOItems.NUCLEAR_WASTE.asItem(), 2, 1600, 500)
                .EUt(480)
                .duration(40)
                .save();
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("depleted_reactor_naquadah_quad")
                .inputItems(GTOItems.DEPLETED_REACTOR_NAQUADAH_QUAD)
                .outputItems(GTOItems.TUNGSTEN_CARBIDE_REACTOR_FUEL_ROD, 4)
                .outputItems(TagPrefix.rod, GTMaterials.TungstenCarbide, 12)
                .chancedOutput(TagPrefix.dust, GTMaterials.Plutonium239, 8, 8000, 200)
                .chancedOutput(GTOItems.NUCLEAR_WASTE.asItem(), 8, 8000, 500)
                .EUt(480)
                .duration(160)
                .save();

        CENTRIFUGE_RECIPES.recipeBuilder("dragon_element")
                .inputFluids(GTOMaterials.TurbidDragonBlood, 1000)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("depleted_reactor_uranium_quad")
                .inputItems(GTOItems.DEPLETED_REACTOR_URANIUM_QUAD)
                .outputItems(GTOItems.REACTOR_FUEL_ROD, 4)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("depleted_reactor_naquadah_dual")
                .inputItems(GTOItems.DEPLETED_REACTOR_NAQUADAH_DUAL)
                .outputItems(GTOItems.TUNGSTEN_CARBIDE_REACTOR_FUEL_ROD, 2)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("superheavyradox")
                .inputFluids(GTOMaterials.SuperHeavyRadox, 1000)
                .outputFluids(GTOMaterials.HeavyRadox, 2000)
                .EUt(1966080)
                .duration(200)
                .save();

        CENTRIFUGE_RECIPES.recipeBuilder("depleted_reactor_uranium_simple")
                .inputItems(GTOItems.DEPLETED_REACTOR_URANIUM_SIMPLE)
                .outputItems(GTOItems.REACTOR_FUEL_ROD)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("clean_bedrock_solution")
                .inputFluids(GTOMaterials.BedrockSootSolution, 2000)
                ...
                .outputFluids(GTOMaterials.CleanBedrockSolution, 1000)
                .EUt(491520)
                .duration(200)
                .save();

        CENTRIFUGE_RECIPES.recipeBuilder("tcetiedandelions")
                .inputFluids(GTOMaterials.SeaweedBroth, 1000)
                .outputItems(GTOItems.TCETIEDANDELIONS, 64)
                .EUt(120)
                .duration(200)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("nuclear_waste")
                .inputItems(GTOItems.NUCLEAR_WASTE)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("free_electron_gas")
                ...
                .outputFluids(GTOMaterials.FreeElectronGas, 1000)
                .outputFluids(GTOMaterials.FreeAlphaGas, 500)
                .EUt(491520)
                .duration(200)
                .save();

        CENTRIFUGE_RECIPES.recipeBuilder("iodine_dust")
                .inputFluids(GTOMaterials.IodineContainingSlurry, 1000)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("actinium_radium_nitrate_solution")
                ...
                .inputFluids(GTOMaterials.ActiniumRadiumNitrateSolution, 13000)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("uranium_sulfate_waste_solution")
                .inputFluids(GTOMaterials.UraniumSulfateWasteSolution, 1000)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("depleted_reactor_mox_dual")
                .inputItems(GTOItems.DEPLETED_REACTOR_MOX_DUAL)
                .outputItems(GTOItems.REACTOR_FUEL_ROD, 2)
                .outputItems(TagPrefix.rod, GTMaterials.Steel, 4)
                .chancedOutput(GTOItems.NUCLEAR_WASTE.asItem(), 16, 2000, 1000)
                .chancedOutput(GTOItems.NUCLEAR_WASTE.asItem(), 4, 3600, 500)
                .EUt(480)
                .duration(80)
                .save();
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("flerovium")
                ...
                .outputFluids(GTMaterials.Flerovium, 288)
                .outputFluids(GTOMaterials.Ytterbium178, 288)
                .EUt(1920)
                .duration(290)
                .save();
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("rare_earth_chlorides")
                ...
                .inputFluids(GTOMaterials.RareEarthChlorides, 2000)
                .outputFluids(GTOMaterials.LaNdOxidesSolution, 250)
                .outputFluids(GTOMaterials.SmGdOxidesSolution, 250)
                .outputFluids(GTOMaterials.TbHoOxidesSolution, 250)
                .outputFluids(GTOMaterials.ErLuOxidesSolution, 250)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("quark_gluon")
                ...
                .outputFluids(GTOMaterials.HeavyQuarks, 200)
                .outputFluids(GTOMaterials.LightQuarks, 600)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("titanium_50_tetrafluoride")
                .inputFluids(GTOMaterials.TitaniumTetrafluoride, 1000)
                .outputFluids(GTOMaterials.Titanium50Tetrafluoride, 10)
                .outputFluids(GTOMaterials.TitaniumTetrafluoride, 990)
                .EUt(480)
                .duration(200)
                .save();
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("inert_residues_dust")
                ...
                .outputFluids(GTOMaterials.OxidizedResidualSolution, 10000)
                .EUt(491520)
                .duration(200)
                .save();

        CENTRIFUGE_RECIPES.recipeBuilder("depleted_reactor_mox_quad")
                .inputItems(GTOItems.DEPLETED_REACTOR_MOX_QUAD)
                .outputItems(GTOItems.REACTOR_FUEL_ROD, 4)
                .outputItems(TagPrefix.rod, GTMaterials.Steel, 12)
                .chancedOutput(GTOItems.NUCLEAR_WASTE.asItem(), 32, 2000, 1000)
                .chancedOutput(GTOItems.NUCLEAR_WASTE.asItem(), 8, 8000, 500)
                .EUt(480)
                .duration(160)
                .save();
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("depleted_reactor_thorium_quad")
                .inputItems(GTOItems.DEPLETED_REACTOR_THORIUM_QUAD)
                .outputItems(GTOItems.REACTOR_FUEL_ROD, 4)
                .outputItems(TagPrefix.rod, GTMaterials.Steel, 12)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("depleted_reactor_naquadah_simple")
                .inputItems(GTOItems.DEPLETED_REACTOR_NAQUADAH_SIMPLE)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("taranium_enriched_liquid_helium_3")
                .notConsumable(GTOItems.SEPARATION_ELECTROMAGNET.asItem())
                .inputFluids(GTOMaterials.DustyLiquidHeliumIII, 1000)
                .outputFluids(GTOMaterials.TaraniumEnrichedLiquidHelium3, 500)
                .EUt(3000)
                .duration(400)
                .save();

        CENTRIFUGE_RECIPES.recipeBuilder("depleted_reactor_thorium_dual")
                .inputItems(GTOItems.DEPLETED_REACTOR_THORIUM_DUAL)
                .outputItems(GTOItems.REACTOR_FUEL_ROD, 2)
                .outputItems(TagPrefix.rod, GTMaterials.Steel, 4)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("heavily_fluorinated_trinium_solution")
                .inputFluids(GTOMaterials.HeavilyFluorinatedTriniumSolution, 8000)
                .outputItems(TagPrefix.dust, GTOMaterials.TriniumTetrafluoride, 60)
                .outputFluids(GTMaterials.Fluorine, 16000)
                .outputFluids(GTOMaterials.Perfluorobenzene, 2000)
                .EUt(30720)
                .duration(350)
                .save();

        CENTRIFUGE_RECIPES.recipeBuilder("water_gas")
                .inputFluids(GTOMaterials.WaterGas, 1000)
                .outputFluids(GTMaterials.Hydrogen, 900)
                .outputFluids(GTMaterials.CarbonMonoxide, 800)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("blood")
                .inputFluids(GTOMaterials.Blood, 1000)
                .outputFluids(GTOMaterials.BloodCells, 500)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("blood_plasma")
                .inputFluids(GTOMaterials.BloodPlasma, 1000)
                .outputFluids(GTOMaterials.Catalase, 200)
                .outputFluids(GTOMaterials.BasicFibroblastGrowthFactor, 200)
