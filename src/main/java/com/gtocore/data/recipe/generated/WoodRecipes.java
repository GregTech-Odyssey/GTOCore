...
public final class WoodRecipes {
    ...
    public static void init() {
        TREE_GROWTH_SIMULATOR_RECIPES.recipeBuilder("mangrove")
        ...
        TREE_GROWTH_SIMULATOR_RECIPES.recipeBuilder("mangrovea")
                ...
                .notConsumable(Blocks.MANGROVE_PROPAGULE.asItem())
                .inputItems(GTItems.FERTILIZER.asItem(), 8)
                .circuitMeta(2)
        ...
        add("minecraft", "birch");
        add("minecraft", "jungle", "cocoa_beans");
        add("minecraft", "acacia");
        add("minecraft", "dark_oak");
        add("minecraft", "cherry");
        add("deeperdarker", "echo", "sculk_gleam");

        add("gtceu", "rubber", "sticky_resin");

        add("ars_nouveau", "blue_archwood", "frostaya_pod");
        add("ars_nouveau", "red_archwood", "bombegranate_pod");
    ...
    private static void add(String mod, String mane) {
        ...
        TREE_GROWTH_SIMULATOR_RECIPES.recipeBuilder(mane)
                .inputFluids(new FluidStack(Fluids.WATER, 4000))
        ...
        ItemStack leaves = new ItemStack(RegistriesUtils.getItem(mod, mane + "_leaves"), 32);
        ...
        EXTRACTOR_RECIPES.builder(mane + "_sapling")
                .inputItems(leaves)
                .chancedOutput(sapling, 1000, 100)
                .EUt(30)
                .duration(100)
                .save();
    }

    private static void add(String mod, String mane, String add) {
        ItemStack sapling = new ItemStack(RegistriesUtils.getItem(mod, mane + "_sapling"));
        ItemStack log = new ItemStack(RegistriesUtils.getItem(mod, mane + "_log"), 16);
        ItemStack addtion = new ItemStack(RegistriesUtils.getItem(mod, add), 4);
        TREE_GROWTH_SIMULATOR_RECIPES.recipeBuilder(mane)
                .inputFluids(new FluidStack(Fluids.WATER, 4000))
                .notConsumable(sapling)
                .circuitMeta(1)
