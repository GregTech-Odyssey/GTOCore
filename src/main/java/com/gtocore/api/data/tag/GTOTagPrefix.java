...
public final class GTOTagPrefix extends TagPrefix {
    ...
    public static final TagPrefix FIBER_TOW = new GTOTagPrefix("carbon_fibres").idPattern("%s_carbon_fibres").defaultTagPath("carbon_fibres/%s").unformattedTagPath("carbon_fibres").materialAmount(GTValues.M).materialIconType(new MaterialIconType("carbon_fibres")).unificationEnabled(true).generateItem(true).generationCondition(mat -> mat.hasFlag(GTOMaterialFlags.GENERATE_FIBER));
